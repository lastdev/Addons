...
local function Init()
	boundingBox = CreateFrame("Frame", nil, parent)
	...
	mask:SetTexture(Image.Blank, "CLAMPTOWHITE", "CLAMPTOWHITE","NEAREST")
	mask:SetAllPoints()
	local logo = boundingBox:CreateTexture(nil, "ARTWORK")
	logo:SetTexture(Image.TomCat512)
	logo:SetPoint("RIGHT", -22, 0)
	logo:SetSize(60, 60)
