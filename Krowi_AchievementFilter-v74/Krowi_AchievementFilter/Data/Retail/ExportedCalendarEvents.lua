...
local function N(ids, cId, ...)
    for _, id in next, ids do
        calendarEvents[id] = event:New(id, ids, categories[cId], eventType.Calendar, ...);
    end
end
...
tasks = {
    {N, {141}, 917, 236705, a.L["Feast of Winter Veil"]},
    {N, {181}, 911, 237000, a.L["Noblegarden"]},
    {N, {201}, 912, 134508, a.L["Children's Week"]},
    {N, {324}, 915, 236552, a.L["Hallow's End"]},
    {N, {327}, 885, 236704, a.L["Lunar Festival"]},
    {N, {341}, 913, 135268, a.L["Midsummer Fire Festival"]},
    {N, {372}, 914, 236701, a.L["Brewfest"]},
    {N, {374, 479}, 925, 134481, a.L["Darkmoon Faire"]},
    {N, {398}, 919, 133168, a.L["Pirates' Day"]},
    {N, {404}, 916, 250626, a.L["Pilgrim's Bounty"]},
    {N, {409}, 920, 237272, a.L["Day of the Dead"]},
    {N, {423}, 910, 236709, a.L["Love is in the Air"]},
    {N, {514}, 1173, 133783, a.L["WoW's 10th Anniversary"]},
    {N, {1262}, 1173, 133783, a.L["WoW's 18th Anniversary"]},
    {N, {1395}, 1453, 1100022, a.L["Kalimdor Cup"]},
    {N, {1396, 1398, 1399}, 1452, 4419345, a.L["Secrets of Azeroth"]},
    {N, {1397}, 1173, 133783, a.L["WoW's 19th Anniversary"]},
    {N, {1400}, 1531, 1100022, a.L["Eastern Kingdoms Cup"]},
    {N, {1407}, 1535, 1100022, a.L["Outland Cup"]},
    {N, {1425, 1458, 1459, 1460}, 1538, 4630413, a.L["Turbulent Timeways"]},
    {N, {1429}, 1559, 1100022, a.L["Northrend Cup"]},
    {N, {1430}, 1560, 1100022, a.L["Pandaria Cup"]},
    {N, {1431}, 1561, 1100022, a.L["Broken Isles Cup"]},
    {N, {1462}, 1563, 1061040, a.L["Hearthstone's 10th Anniversary"]},
    {N, {1500}, 1173, 133783, a.L["WoW's 20th Anniversary"]},
    {N, {1501}, 1173, 133783, a.L["WoW's 21st Anniversary"]},
    {N, {1514, 1515, 1516, 1525}, 1578, 5754532, a.L["WoW Remix: Mists of Pandaria"]},
};
...
function exportedCalendarEvents.InjectDynamicOptions()
    ...
    KrowiAF_RegisterEventOptions("Calendar", {374, 479}, a.L["Darkmoon Faire"], a.L["Other"], 2);
    ...
    KrowiAF_RegisterDeSelectAllEventOptions("Calendar", {374, 479, 514, 1262, 1395, 1396, 1398, 1399, 1397, 1400, 1407, 1425, 1458, 1459, 1460, 1429, 1430, 1431, 1462, 1500, 1501, 1514, 1515, 1516, 1525}, a.L["Other"]);
end