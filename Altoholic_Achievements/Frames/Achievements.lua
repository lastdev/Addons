...
local sortedAchievements = {
	...
	[CAT_QUESTS_LEGION] = "10763,10698,10059,10790,10617,11124,11340,11157,11126,11189,11127,11128,11129,11130,11131,11132",
	...
	[CAT_EXPLORATION_LEGION] = "11190,10665,10666,10667,10668,10669,11256,11258,11257,11259,11260,11261,11262,11264,11263,11265",
...
--	[CAT_EXPLORATION_CATA] = fully sorted
	...
	[CAT_EXPLORATION_LEGION] = "10627,11175,11066",
...
local function _SetCategory(frame, categoryID)
	-- for debug only
	-- print(categoryID)
...
addon:RegisterClassExtensions("AltoAchievements", {
