...
L:SetGeneralLocalization({
	name =	"Pulls de Hondonada Frondacuero"
})
...
L:SetGeneralLocalization({
	name =	"Pulls de Uldaman: Legado de Tyr"
})
...
L:SetMiscLocalization({
	VexRP		= "¡Ah! ¡Vamos allá!... Ejem. Hace mucho tiempo, los miembros del Vuelo Azul sobrecargaron por accidente a un elemental Arcano, lo que creó un poderoso ensamblaje llamado Vexamus que empezó a sembrar el caos."
})
...
L:SetMiscLocalization({
	TreeRP	= "Perfecto, estamos a punto de... ¡Ichistrasz! ¡Hay demasiada magia vital! ¿Qué estás haciendo?"
})
...
L:SetGeneralLocalization({
	name =	"Pulls de Estanques de Vida Rubí"
})
