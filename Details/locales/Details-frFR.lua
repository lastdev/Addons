...
L["STRING_ANCHOR_TOPLEFT"] = "En haut gauche"
...
L["STRING_OPTIONS_MPLUS_AUTO_CLOSE_TIME_DESC"] = "Délai avant la fermeture automatique du panneau de fin de M+."
...
L["STRING_OPTIONS_MPLUS_TIME_INCOMBAT_DESC"] = "Le segment global pour la course Mythique+ utilisera les « dégâts totaux / temps de combat total » pour calculer le DPS."
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME"] = "Durée du donjon"
L["STRING_OPTIONS_MPLUS_TIME_RUNTIME_DESC"] = "Le segment global pour la course Mythique + calculera le DPS en utilisant « dégâts totaux / temps de course »."
