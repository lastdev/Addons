...
function SMARTBUFF_InitItemList()  
  ...
  SMARTBUFF_MiscItem1           = GetItemInfo(162636);  --"Celebration Package"
  ...
  SMARTBUFF_MiscItem18          = GetItemInfo(174906); --"Lightning-Forged Augment Rune"
...
--  SMARTBUFF_SOTSPIRITEDCRANE= GetSpellInfo(154436); --"Stance of the Spirited Crane"
  ...
  SMARTBUFF_BMiscItem1      = GetSpellInfo(277952); --"WoW's 14th Anniversary"
  ...
  SMARTBUFF_BMiscItem18     = GetSpellInfo(270058); --"Battle-Scarred Augmentation"
...
--    {SMARTBUFF_HEARTSBANEHEXWURST, 60, SMARTBUFF_CONST_FOOD},
  ...
  SMARTBUFF_SCROLL = {
    ...
    {SMARTBUFF_MiscItem18, 60, SMARTBUFF_CONST_SCROLL, nil, SMARTBUFF_BMiscItem18},
