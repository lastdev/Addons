...
function SMARTBUFF_InitSpellList()
  ...
  if (SMARTBUFF_PLAYERCLASS == "PRIEST") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_PWF, 60, SMARTBUFF_CONST_GROUP, {14}, "HPET;WPET;DKPET"},
  ...
  if (SMARTBUFF_PLAYERCLASS == "ROGUE") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_DEADLYPOISON, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainRoguePoisonsLethal},
      {SMARTBUFF_WOUNDPOISON, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainRoguePoisonsLethal},
      {SMARTBUFF_LEECHINGPOISON, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainRoguePoisonsNonLethal},
      {SMARTBUFF_PARALYTICPOISON, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainRoguePoisonsNonLethal},
      {SMARTBUFF_MINDPOISON, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainRoguePoisonsNonLethal},
      {SMARTBUFF_CRIPPLINGPOISON, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainRoguePoisonsNonLethal}
    };
  end
