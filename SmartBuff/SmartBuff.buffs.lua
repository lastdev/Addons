...
function SMARTBUFF_InitItemList()  
  ...
  SMARTBUFF_FLASKLEGION1        = GetItemInfo(127847); --"Flask of the Whispered Pact"
  SMARTBUFF_FLASKLEGION2        = GetItemInfo(127848); --"Flask of the Seventh Demon"
  SMARTBUFF_FLASKLEGION3        = GetItemInfo(127849); --"Flask of the Countless Armies"
  SMARTBUFF_FLASKLEGION4        = GetItemInfo(127850); --"Flask of Ten Thousand Scars"  
...
function SMARTBUFF_InitSpellIDs()
  ...
  SMARTBUFF_BMiscItem17     = GetSpellInfo(141652); --"Mana Divining Stone"
  ...
  S.LinkFlaskLegion         = { SMARTBUFF_FLASKLEGION1, SMARTBUFF_FLASKLEGION2, SMARTBUFF_FLASKLEGION3, SMARTBUFF_FLASKLEGION4 };
...
function SMARTBUFF_InitSpellList()
  ...
  -- Scrolls
  SMARTBUFF_SCROLL = {
    {SMARTBUFF_MiscItem17, -1, SMARTBUFF_CONST_SCROLL, nil, SMARTBUFF_BMiscItem17},
  ...
  SMARTBUFF_POTION = {
    ...
    {SMARTBUFF_FLASKLEGION1, 60, SMARTBUFF_CONST_POTION, nil, SMARTBUFF_FLASKLEGION1},
    {SMARTBUFF_FLASKLEGION2, 60, SMARTBUFF_CONST_POTION, nil, SMARTBUFF_FLASKLEGION2},
    {SMARTBUFF_FLASKLEGION3, 60, SMARTBUFF_CONST_POTION, nil, SMARTBUFF_FLASKLEGION3},
    {SMARTBUFF_FLASKLEGION4, 60, SMARTBUFF_CONST_POTION, nil, SMARTBUFF_FLASKLEGION4},
