...
L["WQGF_FRAME_FOUND_GROUPS"] = "Найдено %d  групп. Кликните по кнопке для подтверждения."
...
L["WQGF_FRAME_NO_GROUPS"] = "Ни одной группы не найдено, нажмите кнопку для создания новой группы"
