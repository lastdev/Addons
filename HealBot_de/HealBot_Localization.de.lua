...
-- Class
    ...
    HEALBOT_MAINASSIST                      = "Main Assistent";
    HEALBOT_STOP                            = "Stop";
    HEALBOT_TELL                            = "Sagen";
...
HEALBOT_ABOUT_CREDITD                  = "Acirac, Kubik, Von, Aldetal, snaomi, Brezza, CT, Moonlight Han Xing, Snaomi"  -- Anyone taking on translations (if required), feel free to add yourself here.
