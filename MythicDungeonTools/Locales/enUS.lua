...
L["Lakesis"] = "Lakesis"
L["Language"] = "Language"
L["LargePresetWarning"] = "You are trying to share a very large route (transmission time: %.1fs)%sIt is recommended to use the export function and share large routes through external websites instead.%sAre you sure you want to share this route?%s"
