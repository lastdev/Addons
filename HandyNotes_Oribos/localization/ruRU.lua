...
L["config_fmaster_waypoint_desc"] = "Автоматически устанавливает путевую точку для распорядителя полетов, когда вы входите в Кольцо Перенаправления."
...
L["config_onlymytrainers_desc"] = "Действует только на учителей и торговцев основных профессий.  |cFFFF0000ПРИМЕЧАНИЕ: Действует только при изучении двух основных профессий.|r"
...
L["dev_config_force_nodes"] = "Принудительные значки"
