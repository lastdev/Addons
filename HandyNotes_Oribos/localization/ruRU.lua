...
L["config_easy_waypoints_desc"] = "Активирует упрощенное создание путевой точки. Позволяет установить маршрутную точку, щелкнув правой кнопкой мыши, и получить доступ к дополнительным параметрам, нажав CTRL+ПКМ."
L["config_fmaster_waypoint"] = "Путевая точка распорядителя полетов"
L["config_fmaster_waypoint_desc"] = "Автоматически устанавливает путевую точку для распорядителя полетов, если Вы входите в Кольцо Перенаправления."
...
L["config_zonegateway"] = "Зональные шлюзы"
L["config_zonegateway_desc"] = "Показать расположение шлюза зоны."
