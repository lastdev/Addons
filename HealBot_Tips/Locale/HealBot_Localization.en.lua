...
function HealBot_Lang_Options_enALL()
    HEALBOT_OPTIONS_HELP_TITLES={
                        ...
                        -- Skins Frames Text Extra tab
                                 ["TEXTEXTRA"]="Extra Text.",
                                 ["HEALBARSEXTRAINHEALOPTIONS"]=HEALBOT_OPTIONS_INCHEAL,
                                 ["HEALBARSEXTRAOVERHEALOPTIONS"]=HEALBOT_WORD_OVERHEALS,
                                 ["HEALBARSEXTRAAGGROOPTIONS"]=HEALBOT_OPTIONS_TAB_AGGRO,
                                 ["HEALBARSCOLCUSTOMTEXTAGGRO"]="Aggro Text Custom Col"..HEALBOT_enWORD_COLOUR_SUFFIX,
    ...
    HEALBOT_OPTIONS_HELP_TEXT={
                        ...
                        -- Skins Frames Text Health tab
                               ["TEXTHEALTH"]="Show the Skins Frames Text Name tab.",
                        ...
                        -- Skins Frames Text Extra tab
                               ["TEXTEXTRA"]="Show the Skins Frames Text Extra tab.",
                               ["HEALBARSEXTRAINHEALOPTIONS"]="Extra incoming heal text options.",
                               ["HEALBARSEXTRAOVERHEALOPTIONS"]="Extra overheal text options.",
                               ["HEALBARSEXTRAAGGROOPTIONS"]="Extra aggro text options.",
                               ["HEALBARSCOLCUSTOMTEXTAGGRO"]="Set the custom aggro text col"..HEALBOT_enWORD_COLOUR_SUFFIX,
                               ...
                               ["HEALBARSAGGROPCTTXT"]="Display the aggro percentage a player has next to the health text.\n--\n".._G["YELLOW_FONT_COLOR_CODE"].."Note: Monitoring aggro must be On, check the Bars>Aggro tab.",
