...
function HealBot_Lang_Options_enALL()
    ...
    HEALBOT_OPTIONS_HELP_TITLES={
                        ...
                        -- General tab
                                 ...
                                 ["ULTRAPERF"]=HEALBOT_OPTIONS_ULTRAPERF,
    ...
    HEALBOT_OPTIONS_HELP_TEXT={
                        ...
                        -- General tab
                               ...
                               ["ULTRAPERF"]="Double everything.\nRun Twice as many Timers, Queues and Checks per frame.\n--\n".._G["GREEN_FONT_COLOR_CODE"].."Note: This can be fine tuned using the HealBot Performance plugin.",
