...
function HealBot_Lang_Options_enALL()
    ...
    HEALBOT_OPTIONS_HELP_TEXT={
                        ...
                        -- General tab
                               ...
                               ["PERFMODE"]="Set the performance mode.\nCombinded with your FPS, sets how many Timers, Queues and Checks run per frame.\n--\n".._G["YELLOW_FONT_COLOR_CODE"].."Note: Chill mode queues health events rather than processing immediately.\n".._G["GREEN_FONT_COLOR_CODE"].."Note: The performance level can be fine tuned using the HealBot Performance plugin.\n".._G["GREEN_FONT_COLOR_CODE"].."Note: Use of various queues can be turned On/Off using the HealBot Performance plugin.",
