...
L:SetMiscLocalization({
	Pull				= "Твоя судьба - только смерть!"
})
...
L:SetMiscLocalization({
	Pull				= "Я вижу слабость в твоей душе!"
})
...
L:SetMiscLocalization({
	Pull				= "Идите, маленькие. Умрите от моей руки!"
})
...
L:SetMiscLocalization({
	Pull				= "Новые игрушки? Как неотразимо!"
})
...
L:SetMiscLocalization({
	Pull				= "Да... подойдите ближе, малыши!"
})
