...
MRT_L.Options["EP_CTRT_compatible"] = "EQdkp / MLdkp 1.1 (CT RaidTracker相容)" -- Needs review
...
MRT_L.Options["ITP_IgnoreGems"] = "忽略珠寶" -- Needs review
...
MRT_L.Options["TP_LogWotLKRaids"] = "追蹤巫妖王之怒團隊" -- Needs review
...
MRT_L.GUI["Difficulty N or H"] = "難度('N' 或 'H')" -- Needs review
...
MRT_L.GUI["Itemlink"] = "物品鏈結 或 物品代碼 或 物品名稱" -- Needs review
