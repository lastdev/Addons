...
MRT_L.Core["GuildAttendanceAnnounceText"] = "DKP 목록에 추가할 캐릭터 이름을 귓말로 말해주세요." -- Needs review
...
MRT_L.Options["AP_GuildAttendanceUseCustomText"] = "사용자 정의 공격대 참가자 확인 메세지 사용" -- Needs review
...
MRT_L.Options["EP_BBCode_wowhead"] = "Wowhead 링크가 추가된 BBCode 형식의 텍스트" -- Needs review
...
MRT_L.Options["EP_CTRT_IgnorePerBossAttendance"] = "보스당 참가자 기록 빼기" -- Needs review
MRT_L.Options["EP_CTRT_RLIAttendanceFix"] = [=[EQdkp-Plus Raid-Log-Import 0.5.6.x
에 맞게\n참가자 기록 조정 켜기]=] -- Needs review
...
MRT_L.Options["EP_HTML"] = "Wowhead 링크가 추가된 CSS 기반 HTML" -- Needs review
...
MRT_L.Options["ITP_IgnoreEnchantingMats"] = "마력 추출 아이템 기록 안함" -- Needs review
MRT_L.Options["ITP_IgnoreGems"] = "보석 기록 안함" -- Needs review
MRT_L.Options["ITP_Title"] = "아이템 추적"
MRT_L.Options["ITP_TitleText"] = "MRT - 아이템 추적 옵션"
MRT_L.Options["ITP_UseEPGP_GP_Values"] = "EPGP GP 값 사용" -- Needs review
MRT_L.Options["MP_AutoPrunning"] = "오래된 레이드 자동 삭제" -- Needs review
...
MRT_L.Options["TP_LogWotLKRaids"] = "리분 공격대 던전 자동 인식" -- Needs review
...
<<TRIGGER>> - 사용자 정의 트리거 명령어]=] -- Needs review
...
사용중인 DKP 시스템이 보스당 참가자를 기록하는 방식일 경우에만 사용하세요.]=] -- Needs review
MRT_L.Options["TT_MP_SlashCmd"] = [=[앞에 슬래시는 빼고 명령어만 입력하세요.
이 값의 변경은 재기록 후에 하는 것이 좋습니다.]=] -- Needs review
...
MRT_L.GUI["Button_ResumeLastRaid"] = "지난 레이드 재개" -- Needs review
...
MRT_L.GUI["Resuming last raid failed"] = "오류: 지난 레이드 재개에 실패했습니다" -- Needs review
MRT_L.GUI["Resuming last raid successful"] = "지난 레이드를 재개했습니다." -- Needs review
...
이런 경우 보스 이벤트를 추가해 주세요.]=] -- Needs review
MRT_L.GUI["Value"] = "가격"
