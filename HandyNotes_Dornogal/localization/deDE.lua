local L = LibStub("AceLocale-3.0"):NewLocale("HandyNotes_Dornogal", "deDE", false, true)
...
L["config_plugin_desc"] = "Zeigt die Positionen von NPCs und anderer POIs in Dornogal auf der Weltkarte und Minimap an."
