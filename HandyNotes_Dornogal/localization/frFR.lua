local L = LibStub("AceLocale-3.0"):NewLocale("HandyNotes_Dornogal", "frFR", false, true)
...
L["config_plugin_desc"] = "Affiche les emplacements des PnJs et des endroits importants à Dornogal sur la carte du monde et la mini-carte."
