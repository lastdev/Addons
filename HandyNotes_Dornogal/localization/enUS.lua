...
local L = AceLocale:NewLocale("HandyNotes_Dornogal", "enUS", true, true)
...
L["config_plugin_desc"] = "Displays the NPC and POI locations in Dornogal on the world map and minimap."
