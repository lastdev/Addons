...
elseif GAME_LOCALE == "koKR" then
	...
	["Best Friend"] = "가장 친한 친구", -- Needs review
	...
	Buddy = "동료", -- Needs review
	["Cenarion Circle"] = "세나리온 의회",
	["Cenarion Expedition"] = "세나리온 원정대",
	["Chee Chee"] = "치 치", -- Needs review
	["Darkmoon Faire"] = "다크문 유랑단",
	["Darkspear Trolls"] = "검은창 트롤",
	Darnassus = "다르나서스",
	-- ["Dominance Offensive"] = "",
	["Dragonmaw Clan"] = "용아귀 부족",
	Ella = "엘라", -- Needs review
	Everlook = "눈망루 마을",
	Exalted = "확고한 동맹",
	Exodar = "엑소다르",
	["Explorers' League"] = "탐험가 연맹",
	["Farmer Fung"] = "농부 펑", -- Needs review
	["Fish Fellreed"] = "피시 펠리드", -- Needs review
	["Forest Hozen"] = "숲 호젠", -- Needs review
	["Frenzyheart Tribe"] = "광란심장 일족",
	Friend = "친구", -- Needs review
	Friendly = "약간 우호적",
	["Frostwolf Clan"] = "서리늑대 부족",
	Gadgetzan = "가젯잔",
	["Gelkis Clan Centaur"] = "겔키스 부족 켄타로우스",
	Gilneas = "길니아스",
	["Gina Mudclaw"] = "지나 머드클로", -- Needs review
	Gnomeregan = "놈리건",
	["Gnomeregan Exiles"] = "놈리건",
	["Golden Lotus"] = "황금 연꽃", -- Needs review
	["Good Friend"] = "좋은 친구", -- Needs review
	["Guardians of Hyjal"] = "하이잘의 수호자",
	Guild = "길드",
	["Haohan Mudclaw"] = "하오한 머드클로", -- Needs review
	["Hellscream's Reach"] = "헬스크림 세력단",
	Honored = "우호적",
	["Honor Hold"] = "명예의 요새",
	Horde = "호드",
	["Horde Expedition"] = "호드 원정대",
	["Huojin Pandaren"] = "후오진 판다렌", -- Needs review
	["Hydraxian Waterlords"] = "히드락시안 물의 군주",
	Ironforge = "아이언포지",
	["Jogu the Drunk"] = "주정뱅이 조구", -- Needs review
	...
	["Nat Pagle"] = "내트 페이글", -- Needs review
	Netherwing = "황천의 용군단",
	Neutral = "중립적",
	-- Nomi = "",
	["Ogri'la"] = "오그릴라",
	["Old Hillpaw"] = "늙은 힐포우", -- Needs review
	-- ["Operation: Shieldwall"] = "",
	["Order of the Cloud Serpent"] = "운룡단", -- Needs review
	Orgrimmar = "오그리마",
	["Pearlfin Jinyu"] = "진주지느러미 진위", -- Needs review
	Ramkahen = "람카헨",
	-- ["Rank 1"] = "",
	-- ["Rank 2"] = "",
	-- ["Rank 3"] = "",
	...
	Ravenholdt = "라벤홀트",
	Revered = "매우 우호적",
	["Shado-Pan"] = "음영파", -- Needs review
	-- ["Shado-Pan Assault"] = "",
	["Shang Xi's Academy"] = "샹 시 도장", -- Needs review
	...
	Stormwind = "스톰윈드",
	Stranger = "이방인", -- Needs review
	-- ["Sunreaver Onslaught"] = "",
	Syndicate = "비밀결사대",
	["The Aldor"] = "알도르 사제회",
	["The Anglers"] = "강태공 연합", -- Needs review
	["The Ashen Verdict"] = "잿빛 선고단",
	["The August Celestials"] = "위대한 천신회", -- Needs review
	["The Black Prince"] = "검은 왕자", -- Needs review
	-- ["The Brewmasters"] = "",
	["The Consortium"] = "무역연합",
	...
	["The Kalu'ak"] = "칼루아크",
	["The Klaxxi"] = "클락시", -- Needs review
	["The League of Arathor"] = "아라소르 연맹",
	["The Lorewalkers"] = "전승지기", -- Needs review
	["The Mag'har"] = "마그하르",
	["The Oracles"] = "점쟁이 조합",
	Therazane = "테라제인",
	...
	["The Sunreavers"] = "선리버",
	["The Taunka"] = "타운카",
	["The Tillers"] = "농사꾼 연합", -- Needs review
	...
	["Tina Mudclaw"] = "티나 머드클로", -- Needs review
	Tranquillien = "트랜퀼리엔",
	["Tushui Pandaren"] = "투슈이 판다렌", -- Needs review
	Undercity = "언더시티",
