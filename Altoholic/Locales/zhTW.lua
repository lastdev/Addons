...
L["Information saved in DataStore has been completely deleted !"] = "保存在數據庫存儲的資料已被完全刪除！" -- Needs review
L["Inscription"] = "銘文學"
...
L["Realm"] = "伺服器"
L["Realm links successfully deleted"] = "伺服器連接成功刪除" -- Needs review
...
L["Reset"] = "重置"
L["Reset all data"] = "重置所有數據" -- Needs review
L["Reset connected realms"] = "重新連接伺服器" -- Needs review
L["Reset connected realms ?"] = "要重新連接伺服器?" -- Needs review
L["Resistance"] = "抗性"
L["Rested"] = "充份休息"
...
L["Show counters for connected realms"] = "顯示連接的伺服器" -- Needs review
...
L["Valor"] = "勇氣" -- Needs review
L["Valor / Week"] = "勇氣每週上限" -- Needs review
