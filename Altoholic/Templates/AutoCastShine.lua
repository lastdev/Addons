...
local function _ShineStart(frame, r, g, b)
...
local function _ShineStop(frame)
...
local function _Shine_OnUpdate(frame, elapsed)
...
addon:RegisterClassExtensions("AltoAutoCastShine", {
	ShineStart = _ShineStart,
	ShineStop = _ShineStop,
	Shine_OnUpdate = _Shine_OnUpdate,
})
