...
L["already_running"] = "BankStack: Упорядочивание уже запущено."
L["ARMOR"] = "Доспехи"
...
L["BINDING_NAME_BANKSTACK"] = "Упорядочить в банк"
L["BINDING_NAME_COMPRESS"] = "Сжать сумки"
L["complete"] = "BankStack: Завершено."
L["confused"] = "BankStack: Беспорядок. Остановка."
...
L["options"] = "BankStack настройки:"
L["perfect"] = "BankStack: Уже уложено."
L["PROJECTILE"] = "Боеприпасы"
L["QUEST"] = "Задания"
L["QUIVER"] = "Амуниция"
L["REAGENT"] = "Реагенты"
L["RECIPE"] = "Рецепты"
L["to_move"] = "BankStack: Необходимо %d перемещений."
