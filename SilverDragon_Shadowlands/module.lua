...
function module:OnInitialize()
	core:RegisterMobData("Shadowlands", {
		...
		[171327] = {name="Reekmonger",locations={[1533]={30365517},},notes="Kill enemies in the Temple of Courage to summon",quest=61101,},
		...
		[179755] = {name="Consumption",locations={[1961]={},},notes="Starts as an elite, eats {npc:179344} until it becomes a rare and then a rare-elite. Loot gets better as it gets stronger, so wait.",quest=64243,variant="rare",hidden=true,},
		...
		[179768] = {name="Consumption",locations={[1961]={51154165},},loot={187245,187246,187247,187402},notes="Starts as an elite, eats {npc:179344} until it becomes a rare and then a rare-elite. Loot gets better as it gets stronger, so wait.",quest=64243,variant="rare-elite",},
		[179769] = {name="Consumption",locations={[1961]={},},notes="Starts as an elite, eats {npc:179344} until it becomes a rare and then a rare-elite. Loot gets better as it gets stronger, so wait.",quest=64243,variant="normal",hidden=true,},
		...
		[179985] = {name="Stygian Stonecrusher",locations={[1961]={46507950},},loot={184790,{186479,mount=nil,covenant=Enum.CovenantType.Venthyr,},{187283,quest=64530,},187386,{187428,quest=64553,}},quest=64313,},
		...
		[180160] = {name="Reliwik the Defiant",locations={[1961]={56256615},},loot={{186652,mount=1509,},187388},quest=64455,},
		[180162] = {name="Ve'rayn",locations={[1961]={14008000},},loot={{187264,quest=64513,},187369,187404},quest=64457,},
		[180246] = {name="Carriage Crusher",locations={[1961]={58201775},},loot={187370,187391,187399},quest=64258,vignette=4857,},
	})
end
