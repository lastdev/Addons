...
local holidayEventPets = {
	...
	["Darkmoon Eye"] = {
		...
		creatureId = 67332,
		sourceText = L[
			"This bag is rewarded for completing the pet battle daily offered by Jeremy Feasel at the Darkmoon Faire."
		],
	...
	["Green Helper Box"] = {
		...
		holidayTexture = CONSTANTS.HOLIDAY_TEXTURES.WINTERS_VEIL,
		questId = {8768},
		coords = {zoneOverride = L["Greatfather Winter's Tree"], {m = 87, x = 33.5, y = 66}, {m = 86, x = 49.3, y = 78.4}},
		christmasOnly = true
	},
	["Grumpling"] = {
		cat = CONSTANTS.ITEM_CATEGORIES.HOLIDAY,
	...
	["Syd the Squid"] = {
		...
		creatureId = 85527,
		sourceText = L[
			"This bag is rewarded for completing the pet battle daily offered by Christoph VonFeasel at the Darkmoon Faire."
		],
		holidayTexture = CONSTANTS.HOLIDAY_TEXTURES.DARKMOON_FAIRE,
		questId = 36471,
