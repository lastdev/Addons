--- Implement the /fr (/fixraid) console command.
...
function M:OnEnable()
  A.console:RegisterSlashCommand({"fixraid", "fr"}, function(args) M:Command(args) end)
end
...
function M:Command(args)
  ...
  if sortMode then
    ...
    A.console:Printf(L["phrase.print.badArgument"], H(args), H("/fr help"))
    return
  end
