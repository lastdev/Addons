...
L["button.fixRaid.desc"] = "Der Button auf dem Schlachtzug-Reiter und das Minikarten-Symbol funktionieren auch, um Gruppen festzulegen."
L["button.fixRaid.paused.text"] = "Im Kampf..."
L["button.fixRaid.text"] = "Gruppen festlegen"
L["button.fixRaid.working.text"] = "Umordnung..."
...
L["gui.fixRaid.help.cancel"] = "Die Umordnung der Spieler stoppen."
L["gui.fixRaid.help.choose"] = "Wählt eine(n) zufällige(n) Spieler oder Option aus."
-- L["gui.fixRaid.help.clear1"] = ""
-- L["gui.fixRaid.help.clear2"] = ""
L["gui.fixRaid.help.config"] = "Das gleiche wie %s>Interface>AddOns>%s."
L["gui.fixRaid.help.list"] = "Listet Spieler, die einem bestimmten Kriterium entsprechen, im Schlachtzug-Chat auf."
L["gui.fixRaid.help.listself"] = "Listet Spieler, die einem bestimmtem Kriterium entsprechen, zu dir selbst auf." -- Needs review
L["gui.fixRaid.help.nosort"] = "Nur Tanks und Plündermeister festlegen, keine Sortierung."
-- L["gui.fixRaid.help.note.clearSkip"] = ""
L["gui.fixRaid.help.note.core.1"] = "Verschiebt alle Gildenmitglieder von %s, die unterhalb des Rangs %s (Rang %s) sind, auf die Bank (das heißt Gruppe 8)."
L["gui.fixRaid.help.note.core.2"] = "Du kannst den Rang in den Einstellungen anpassen."
L["gui.fixRaid.help.note.defaultMode"] = "Die Standardsortiermethode ist momentan %s. Dies kann in den Einstellungen geändert werden."
L["gui.fixRaid.help.note.meter.1"] = "Die Sortiermethode \"gemachte(r) Gesamtschaden/-heilung\" wird nur funktionieren, wenn %s läuft."
L["gui.fixRaid.help.note.meter.2"] = "Diese Sortiermethode kann nützlich sein, um schnelle Entscheidungen zu machen, wer eine Notheilung oder einen Battle-Rezz in einer Zufallsgruppe wert ist."
L["gui.fixRaid.help.note.sameAsCommand"] = "Ist das gleiche wie der %s Befehl."
L["gui.fixRaid.help.note.sameAsLeftClicking"] = "Ist das gleiche wie ein Linksklick auf das Minikarten-Symbol oder den %s Button im Schlachtzug-Reiter."
L["gui.fixRaid.help.skip1"] = "Spieler, die du in der Gruppe 1 platziert hast, werden ausgeschlossen."
L["gui.fixRaid.help.skip2"] = "Spieler, die du in der Gruppe 1 oder 2 platziert hast, werden ausgeschlossen"
L["gui.fixRaid.help.sort"] = "Ordnet Spieler nach der Standardsortiermethode um."
L["gui.fixRaid.help.split"] = "Der Schlachtzug wird in zwei Seiten, basierend auf dem/der gemachten Gesamtschaden/-Heilung, aufgeteilt."
L["gui.fixRaid.intro"] = "Der %s (oder %s) Befehl erlaubt dir, das Addon ohne Verwendung des GUIs zu steuern. Du kannst diesen Befehl in einem Makro verwenden oder du gibst ihn einfach in den Chat ein." -- Needs review
...
L["tooltip.right.fixRaid"] = "Spieler umordnen"
