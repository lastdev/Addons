...
XPERL_RAID_TOOLTIP_ANKH		= "Ankh attivo da: %s"
XPERL_RAID_TOOLTIP_SOULSTONE	= "Pietranima attiva da: %s"

XPERL_RAID_TOOLTIP_REMAINING	= " rimanenti"

XPERL_RAID_DROPDOWN_SHOWPET	= "Visualizza Famigli"
XPERL_RAID_DROPDOWN_SHOWOWNER	= "Visualizza Proprietari"

XPERL_RAID_DROPDOWN_MAINTANKS	= "Guardiani Principali"
XPERL_RAID_DROPDOWN_SETMT	= "Imposta GP #%d"
