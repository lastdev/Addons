...
AL["MAP_MENU_SHOW_DEAD_RARE_NPCS"] = "Show dead rare NPC icons on map"
...
AL["MAP_MENU_SHOW_NOT_TRACKEABLE_CONTAINERS"] = "Show not trackeable container icons on map"
AL["MAP_MENU_SHOW_OPEN_CONTAINERS"] = "Show opened container icons on map"
