...
if AL then
	...
	AL["DISPLAY_MAP_ICONS"] = "Attiva/Disattiva le icone sulla mappa del mondo"
	AL["DISPLAY_MAP_ICONS_DESC"] = "Se disabilitato, le icone dei PNG, contenitori o eventi non verranno mostrati sulla mappa del mondo"
	...
	AL["MAP_MENU_DISABLE_LAST_SEEN_FILTER"] = "Mostra PNG rari come vivi, anche quando in realtà sono apparsi molto tempo prima"
	AL["MAP_MENU_SHOW_ALL"] = "Mostra icone sulla mappa"
