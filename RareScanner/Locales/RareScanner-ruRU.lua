...
if AL then
	...
	AL["CMD_HELP2"] = "- введите \"/rarescanner show\", чтобы увидеть все значки на карте мира"
	AL["CMD_HELP3"] = "- введите \"/rarescanner hide\", чтобы скрыть все значки на карте мира"
	AL["CMD_HELP4"] = "- введите \"/rarescanner toggle\", чтобы показать / скрыть все значки на карте мира"
	AL["CMD_HELP5"] = "- введите \"/rarescanner toggle rares\" или \"/rarescanner tr\", чтобы показать / скрыть значки НИПов на карте мира"
	AL["CMD_HELP6"] = "- введите \"/rarescanner toggle events\" или \"/rarescanner te\", чтобы показать / скрыть значки событий на карте мира "
	AL["CMD_HELP7"] = "- введите \"/rarescanner toggle treasures\" или \"/rarescanner tt\", чтобы показать / скрыть значки сокровищ на карте мира "
