...
if AL then
	...
	AL["COLLECTION_FILTERS"] = "수집품별 필터링"
	AL["COLLECTION_FILTERS_APPEARENCE"] = "형상"
	AL["COLLECTION_FILTERS_APPEARENCE_DESC"] = "활성화되면 누락된 NPC/상자에 대해 현재 캐릭터가 누락되었다는 알림이 표시됩니다. 이 캐릭터로 형상 변환 할 수 없는 외모에는 적용되지 않습니다."
	AL["COLLECTION_FILTERS_APPLY"] = "필터 적용"
	AL["COLLECTION_FILTERS_APPLY_DESC"] = "이 버튼을 누르면 작업이 시작됩니다."
	AL["COLLECTION_FILTERS_GLOBAL_TYPE_DESC"] = "활성화되면 누락된 %s|1을;를 드롭하는 NPC/상자에 대해 경고를 받습니다."
	AL["COLLECTION_FILTERS_MOUNTS"] = "장착"
	AL["COLLECTION_FILTERS_ONLY_MAP_DESC"] = "활성화된 경우 필터링된 상자/NPC에서 계속 알림을 받지만 월드맵에는 표시되지 않습니다. 비활성화하면 필터링된 상자/NPC에서 알림을 전혀 받지 못합니다."
	AL["COLLECTION_FILTERS_PETS"] = "소환수"
	AL["COLLECTION_FILTERS_PROFILE_BACKUP"] = "필터를 적용할 현재 프로필의 사본을 만듭니다."
	AL["COLLECTION_FILTERS_PROFILE_BACKUP_CREATED"] = "현재 이름이 %s 인 프로필을 기반으로 새 프로필을 만들었습니다."
	AL["COLLECTION_FILTERS_PROFILE_BACKUP_DESC"] = "활성화하면 현재 프로필에서 복사한 새 프로필에 필터가 적용됩니다. 결과에 만족하지 않는 경우 현재 프로필로 다시 전환할 수 있는 옵션이 제공됩니다. 누락된 모양으로 개체를 필터링하고 모든 캐릭터 간에 공유되는 '기본' 프로필을 사용하는 경우 이 옵션을 활성화하는 것이 좋습니다."
	AL["COLLECTION_FILTERS_TEXT1"] = "관심 있는 수집품 유형을 선택하고 [%s] 버튼을 누르십시오."
	AL["COLLECTION_FILTERS_TEXT2"] = "이 작업은 전리품이 선택한 유형과 일치하지 않거나 이미 수집한 모든 희귀 NPC 및 상자를 필터링합니다. 중요: 이 작업은 현재 필터를 재정의합니다."
	AL["COLLECTION_FILTERS_TEXT3"] = "필터가 적용되면 애드온 설정에서 패널 [%s] 및 [%s] |1을;를 사용하여 수정할 수 있습니다."
	AL["COLLECTION_FILTERS_TOYS"] = "장난감"
	AL["COLLECTION_FILTERS_TYPES"] = "수집품의 유형"
	AL["COLLECTIONS_AUTO_FILTER_ON_COLLECT"] = "누락된 수집품을 찾을 때 본체 자동 필터링"
	AL["COLLECTIONS_AUTO_FILTER_ON_COLLECT_DESC"] = "활성화되면 누락된 항목이 수집품에 추가되는 즉시 자동 필터링됩니다."
	AL["CONTAINER"] = "상자"
	...
	AL["START_COLLECTIONS_SCAN"] = "이 프로세스는 전체 RareScanner의 데이터베이스에서 누락된 수집품을 찾습니다. 몇 초 동안 게임이 멈출 수 있는 무거운 작업입니다. 계속 하시겠습니까?"
