...
if AL then
	...
	AL["FILTER_NPCS_ONLY_MAP"] = "세계 지도에만 필터 적용"
	AL["FILTER_NPCS_ONLY_MAP_DESC"] = "켜면 여전히 필터링된 NPC로부터 알림을 받지만 세계 지도에는 표시되지 않습니다. 끄면 필터링된 NPC로부터 알림을 전혀 받지 않습니다."
	AL["FILTER_ONLY_ALERTS"] = "시각/음성 알림에만 필터 적용"
