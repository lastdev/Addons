...
if AL then
	...
	AL["CMD_HELP10"] = "Activer/désactiver la numérisation des vignettes de la carte du monde"
	AL["CMD_HELP11"] = "afficher/masquer les icônes des glyphes de dragon sur la carte du monde"
	...
	AL["CMD_HIDE_DRAGON_GLYPHS"] = "Masquage des icônes de glyphes de dragon RareScanner sur la carte du monde"
	...
	AL["CMD_SHOW_DRAGON_GLYPHS"] = "Afficher des icônes de glyphes de dragon RareScanner sur la carte du monde"
	...
	AL["CONTAINER_376579"] = "Coffre de Roseau"
	...
	AL["DISPLAY_MINIMAP_BUTTON"] = "Alterner l'affichage du bouton de la mini-carte"
	...
	AL["DISPLAY_WORLDMAP_BUTTON"] = "Alterner l'affichage du bouton de la carte du monde"
	...
	AL["ENABLE_SCAN_ON_PET_BATTLE"] = "Alterner la numérisation pendant la bataille de mascottes"
	...
	AL["EXPLORER_RESCANN"] = "Renumériser"
	AL["EXPLORER_RESCANN_DESC"] = "Force une nouvelle analyse manuelle pour les objets de collection manquants"
	AL["EXPLORER_SCAN_CLASS_REQUIRED"] = "Nouvelle version de la base de données détectée, une analyse de la classe actuelle est requise."
	AL["EXPLORER_SCAN_MANUAL"] = "Lancement d'une numérisation manuelle pour la classe en cours."
	AL["EXPLORER_SCAN_NOT_DONE"] = "Vous ne pouvez pas utiliser ce filtre car vous n'avez pas encore effectué d'analyse avec l'explorateur de RareScanner. Voulez-vous le faire maintenant ?"
	AL["EXPLORER_SCAN_REQUIRED"] = "Nouvelle version de la base de données détectée, une nouvelle analyse est requise."
	AL["EXPLORER_START_SCAN"] = "Lancer l'analyse"
	AL["FILTER"] = "Filtres des PNJ"
	AL["FILTER_CONTAINER_LIST"] = "Filtrer la recherche de conteneurs"
	AL["FILTER_CONTAINER_LIST_DESC"] = "Basculer la recherche de ce conteneur. Lorsqu'il est désactivé, vous ne recevrez pas d'alerte lorsque ce conteneur sera trouvé."
	AL["FILTER_CONTAINERS_ONLY_ALERTS_DESC"] = "Lorsque cette option est activée, vous verrez toujours des conteneurs filtrés sur votre carte du monde, mais vous ne recevrez pas d'alertes visuelles/audio. Lorsqu'il est désactivé, vous ne verrez pas les conteneurs filtrés sur votre carte du monde et vous ne recevrez pas non plus d'alertes visuelles/audio."
	AL["FILTER_CONTAINERS_ONLY_MAP_DESC"] = "Lorsque cette option est activée, vous recevrez toujours des alertes des conteneurs filtrés, mais elles n'apparaîtront pas sur votre carte du monde. Lorsqu'il est désactivé, vous ne verrez pas les conteneurs filtrés sur votre carte du monde et vous ne recevrez pas non plus d'alertes visuelles/audio."
	...
	AL["FILTER_EVENT_LIST_DESC"] = "Activer la recherche de cet événement. Lorsqu'il est désactivé, vous ne recevrez pas d'alerte lorsque cet événement sera trouvé."
	AL["FILTER_EVENTS_ONLY_MAP_DESC"] = "Lorsqu'il est activé, vous recevrez toujours des alertes d'événements filtrés, mais ils n'apparaîtront pas sur votre carte du monde. Lorsqu'il est désactivé, vous ne recevrez aucune alerte des événements filtrés."
	...
	AL["FILTER_ONLY_ALERTS"] = "Appliquer des filtres uniquement aux alertes visuelles/audio"
	...
	AL["MAP_TOOLTIP_ADD_WAYPOINT"] = "Ajouter un point de repère à cette position"
	...
	AL["MAP_TOOLTIP_SHOW_OVERLAY"] = "Afficher chaque lieu de spot "
	AL["MAP_TOOLTIPS_LOOT"] = "Afficher le butin"
	AL["MAP_TOOLTIPS_LOOT_DESC"] = "Lorsqu'il est désactivé, vous ne verrez pas le butin dans les info-bulles."
