...
if AL then
	...
	AL["ENABLE_AUTO_WAYPOINTS"] = "Activa auto reemplazar indicadores"
	AL["ENABLE_AUTO_WAYPOINTS_DESC"] = "Cuando se activa, tan pronto como encuentres una entidad, el addon reemplazará tu indicador del juego actual por uno apuntando a las coordenadas de la entidad recién encontrada. Cuando se desactiva los indicadores se añadirán al pulsar el botón principal."
	...
	AL["ENABLE_WAYPOINTS_SUPPORT"] = "Activa soporte de indicadores del juego"
	AL["ENABLE_WAYPOINTS_SUPPORT_DESC"] = "Cuando se activa se añadirán indicadores del juego apuntando a las coordenadas de la entidad recién encontrada. ¡Importante! el juego añade un icono cuadrado encima del icono de la entidad, de modo que no podrás ver el icono rosa."
	...
	AL["INGAME_WAYPOINTS"] = "Indicadores del juego"
	...
	AL["TOMTOM_WAYPOINTS"] = "Indicadores de Tomtom"
