...
--~     },
    ...
    [165653] = {  -- "spells/banish_chest_yellow.m2"
        ...
        BaseScale = 0.02, BaseFacing = 0,
        BaseOfsX = -0.375, BaseOfsY = -0.135,
        BaseStepX = 3450, BaseStepY = 3160,
        IsSkewed = true, HorizontalSlope = -4,
