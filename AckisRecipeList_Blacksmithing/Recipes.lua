...
function module:InitializeRecipes()
	...
	-- Powerful Steelforged Essence -- 181416
	recipe = AddRecipe(181416, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 700, 702, 705)
	recipe:SetRecipeItem(122550, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(122538, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(90894, 91030)

	-- Powerful Truesteel Essence -- 181417
	recipe = AddRecipe(181417, V.WOD, Q.COMMON)
	recipe:SetSkillLevels(1, 1, 700, 702, 705)
	recipe:SetRecipeItem(122552, "BIND_ON_PICKUP")
	recipe:SetCraftedItem(122539, "BIND_ON_EQUIP")
	recipe:SetItemFilterType("BLACKSMITHING_ITEM_ENHANCEMENT")
	recipe:AddVendor(90894, 91030)
