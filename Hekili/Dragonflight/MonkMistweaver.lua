...
spec:RegisterTalents( {
    ...
    chi_burst                     = { 80709, 123986, 1 }, -- Hurls a torrent of Chi energy up to 40 yds forward, dealing 476 Nature damage to all enemies, and 987 healing to the Monk and all allies in its path. Healing reduced beyond 6 targets.
    ...
    chi_wave                      = { 80709, 115098, 1 }, -- A wave of Chi energy flows through friends and foes, dealing 147 Nature damage or 438 healing. Bounces up to 7 times to targets within 25 yards.
    ...
    eye_of_the_tiger              = { 80700, 196607, 1 }, -- Tiger Palm also applies Eye of the Tiger, dealing 291 Nature damage to the enemy and 265 healing to the Monk over 8 sec. Limit 1 target.
    ...
    summon_jade_serpent_statue    = { 80713, 115313, 1 }, -- Summons a Jade Serpent Statue at the target location. When you channel Soothing Mist, the statue will also begin to channel Soothing Mist on your target, healing for 2,336 over 7.3 sec.
    summon_white_tiger_statue     = { 80701, 388686, 1 }, -- Summons a White Tiger Statue at the target location for 30 sec, pulsing 258 damage to all enemies every 2 sec for 30 sec.
    ...
    ancient_teachings             = { 80598, 388023, 1 }, -- After casting Essence Font or Faeline Stomp, your Tiger Palm, Blackout Kick, and Rising Sun Kick heal up to 5 injured allies within 30 yds for 135% of the damage done, split evenly among them. Lasts 15 sec.
    ...
    burst_of_life                 = { 80583, 399226, 1 }, -- When Life Cocoon expires, it releases a burst of mist that restores 4,280 health to 3 nearby allies.
    calming_coalescence           = { 80599, 388218, 1 }, -- Each time Soothing Mist heals, the absorb amount of your next Life Cocoon is increased by 3%, stacking up to 50 times.
    celestial_harmony             = { 80582, 343655, 1 }, -- While active, Yu'lon and Chi'Ji heal up to 6 nearby targets with Enveloping Breath when you cast Enveloping Mist, healing for 2,194 over 7 sec, and increasing the healing they receive from you by 10%. When activated, Yu'lon and Chi'Ji apply Chi Cocoons to 5 targets within 40 yds, absorbing 3,577 damage for 10 sec.
    ...
    enveloping_mist               = { 80568, 124682, 1 }, -- Wraps the target in healing mists, healing for 3,884 over 7 sec, and increasing healing received from your other spells by 40%. Applies Renewing Mist for 6 seconds to an ally within 40 yds.
    essence_font                  = { 80597, 191837, 1 }, -- Unleashes a rapid twirl of healing bolts at up to 6 allies within 30 yds, every 0.9 sec for 2.7 sec. Each bolt heals a target for 616, plus an additional 201 over 8 sec. Gust of Mists will heal affected targets twice. Castable while moving. Each bolt has a chance to reduce the cooldown of Thunder Focus Tea by 1 sec.
    faeline_stomp                 = { 80560, 388193, 1 }, -- Strike the ground fiercely to expose a faeline for 30 sec, dealing 459 Nature damage to up to 5 enemies, and restores 966 health to up to 5 allies within 30 yds caught in the faeline. Up to 5 allies caught in the faeline are healed with an Essence Font bolt. Your abilities have a 6% chance of resetting the cooldown of Faeline Stomp while fighting on a faeline.
    focused_thunder               = { 80593, 197895, 1 }, -- Thunder Focus Tea now empowers your next 2 spells.
    font_of_life                  = { 80580, 337209, 1 }, -- Your Essence Font's initial heal is increased by 25% and has a chance to reduce the cooldown of Thunder Focus Tea by 1 sec.
    ...
    invigorating_mists            = { 80559, 274586, 1 }, -- Vivify heals all allies with your Renewing Mist active for 1,075.
    invoke_chiji                  = { 80590, 325197, 1 }, -- Summon an effigy of Chi-Ji for 25 sec that kicks up a Gust of Mist when you Blackout Kick, Rising Sun Kick, or Spinning Crane Kick, healing up to 2 allies for 786, and reducing the cost and cast time of your next Enveloping Mist by 33%, stacking. Chi-Ji's presence makes you immune to movement impairing effects.
    invoke_chiji_the_red_crane    = { 80590, 325197, 1 }, -- Summon an effigy of Chi-Ji for 25 sec that kicks up a Gust of Mist when you Blackout Kick, Rising Sun Kick, or Spinning Crane Kick, healing up to 2 allies for 786, and reducing the cost and cast time of your next Enveloping Mist by 33%, stacking. Chi-Ji's presence makes you immune to movement impairing effects.
    invoke_yulon                  = { 80590, 322118, 1 }, -- Summons an effigy of Yu'lon, the Jade Serpent for 25 sec. Yu'lon will heal injured allies with Soothing Breath, healing the target and up to 2 allies for 1,115 over 4.1 sec. Enveloping Mist costs 50% less mana while Yu'lon is active.
    invoke_yulon_the_jade_serpent = { 80590, 322118, 1 }, -- Summons an effigy of Yu'lon, the Jade Serpent for 25 sec. Yu'lon will heal injured allies with Soothing Breath, healing the target and up to 2 allies for 1,115 over 4.1 sec. Enveloping Mist costs 50% less mana while Yu'lon is active.
    ...
    life_cocoon                   = { 80584, 116849, 1 }, -- Encases the target in a cocoon of Chi energy for 12 sec, absorbing 26,831 damage and increasing all healing over time received by 50%. Applies Renewing Mist and Enveloping Mist to the target.
    ...
    refreshing_jade_wind          = { 80563, 196725, 1 }, -- Summon a whirling tornado around you, causing 2,949 healing over 13.7 sec to up to 6 allies within 10 yards.
    renewing_mist                 = { 80588, 115151, 1 }, -- Surrounds the target with healing mists, restoring 2,283 health over 20 sec. If Renewing Mist heals a target past maximum health, it will travel to another injured ally within 20 yds.
    resplendent_mist              = { 80585, 388020, 2 }, -- Gust of Mists has a 30% chance to do 100% more healing.
    restoral                      = { 80574, 388615, 1 }, -- Heals all party and raid members within 40 yds for 3,457 and clears them of all harmful Poison and Disease effects. Castable while stunned. Healing increased by 100% when not in a raid.
    revival                       = { 80574, 115310, 1 }, -- Heals all party and raid members within 40 yds for 3,457 and clears them of all harmful Magical, Poison, and Disease effects. Healing increased by 100% when not in a raid.
    rising_mist                   = { 80558, 274909, 1 }, -- Rising Sun Kick heals all allies with your Renewing Mist, Enveloping Mist, or Essence Font for 254, and extends those effects by 4 sec, up to 100% of their original duration.
    rising_sun_kick               = { 80690, 107428, 1 }, -- Kick upwards, dealing 3,768 Physical damage. Applies Renewing Mist for 6 seconds to an ally within 40 yds
    ...
    sheiluns_gift                 = { 80586, 399491, 1 }, -- Draws in all nearby clouds of mist, healing the friendly target and up to 2 nearby allies for 1,210 per cloud absorbed. A cloud of mist is generated every 8 sec while in combat.
    soothing_mist                 = { 80691, 115175, 1 }, -- Heals the target for 4,672 over 7.3 sec. While channeling, Enveloping Mist, Zen Pulse, and Vivify may be cast instantly on the target. Each heal has a chance to cause a Gust of Mists on the target.
    ...
    thunder_focus_tea             = { 80600, 116680, 1 }, -- Receive a jolt of energy, empowering your next spell cast: Enveloping Mist: Immediately heals for 3,046 and is instant cast. Renewing Mist: Duration increased by 10 sec. Vivify: No mana cost. Rising Sun Kick: Cooldown reduced by 9 sec. Essence Font: Channels 100% faster.
    ...
    yulons_whisper                = { 80578, 388038, 1 }, -- Activating Thunder Focus Tea causes you to exhale the breath of Yu'lon, healing up to 5 allies within 15 yards for 1,566 over 2 sec.
    zen_pulse                     = { 80566, 124081, 1 }, -- Trigger a Zen Pulse around an ally. Deals 1,645 damage to all enemies within 8 yds of the target. The ally is healed for 1,766 per enemy damaged. Zen Pulse triggers a second time at 80% effectiveness if cast on targets with Enveloping Mist.
} )
...
spec:RegisterPvpTalents( {
    ...
    dome_of_mist         = 680 , -- (202577) Enveloping Mist transforms 120% of its remaining periodic healing into a Dome of Mist when dispelled.  Dome of Mist Absorbs damage. All healing received by the Monk increased by 30%. Lasts 8 sec.
    eminence             = 70  , -- (353584) Transcendence: Transfer can now be cast if you are stunned. Cooldown reduced by 15 sec if you are not.
    fae_accord           = 5565, -- (406888) Faeline Stomp's cooldown is reduced by 10 sec. Enemies struck by Faeline Stomp are snared by 60% for 8 sec.
    ...
    healing_sphere       = 683 , -- (205234) Coalesces a Healing Sphere out of the mists at the target location after 1.5 sec. If allies walk through it, they consume the sphere, healing themselves for 4,780 and dispelling all harmful periodic magic effects. Maximum of 3 Healing Spheres can be active by the Monk at any given time.
    ...
    thunderous_focus_tea = 5402, -- (353936) Thunder Focus Tea can now additionally cause Crackling Jade Lightning's knockback immediately or cause Roll and Chi Torpedo to refund a charge on use and heal you for 2,506.
