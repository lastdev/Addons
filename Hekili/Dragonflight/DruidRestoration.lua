...
spec:RegisterTalents( {
    ...
    protector_of_the_pack    = { 82245, 378986, 1 }, -- Store 5% of your effective healing, up to 17,097. Your next Moonfire consumes all stored healing to increase its damage dealt.
    ...
    sunfire                  = { 82208, 93402 , 1 }, -- A quick beam of solar light burns the enemy for 1,202 Nature damage and then an additional 11,266 Nature damage over 18 sec to the primary target and all enemies within 8 yards.
    ...
    wild_growth              = { 82241, 48438 , 1 }, -- Heals up to 5 injured allies within 30 yards of the target for 8,399 over 7 sec. Healing starts high and declines over the duration. Tree of Life: Affects 2 additional targets.
    ...
    adaptive_swarm           = { 82067, 391888, 1 }, -- Command a swarm that heals 13,498 or deals 12,118 Shadow damage over 12 sec to a target, and increases the effectiveness of your periodic effects on them by 20%. Upon expiration, finds a new target, preferring to alternate between friend and foe up to 3 times.
    ...
    cenarion_ward            = { 82052, 102351, 1 }, -- Protects a friendly target for 30 sec. Any damage taken will consume the ward and heal the target for 27,082 over 8 sec.
    ...
    cultivation              = { 82056, 200390, 1 }, -- When Rejuvenation heals a target below 60% health, it applies Cultivation to the target, healing them for 1,604 over 6 sec.
    ...
    efflorescence            = { 82057, 145205, 1 }, -- Grows a healing blossom at the target location, restoring 1,669 health to three injured allies within 10 yards every 1.7 sec for 30 sec. Limit 1.
    embrace_of_the_dream     = { 82070, 392124, 2 }, -- Wild Growth has a 50% chance to momentarily shift your mind into the Emerald Dream, instantly healing all allies affected by your Rejuvenation or Regrowth for 6,045.
    ...
    grove_tending            = { 82047, 383192, 1 }, -- Swiftmend heals the target for 8,999 over 9 sec.
    ...
    lifebloom                = { 82049, 33763 , 1 }, -- Heals the target for 19,283 over 15 sec. When Lifebloom expires or is dispelled, the target is instantly healed for 11,371. May be active on one target at a time.
    ...
    nourish                  = { 82043, 50464 , 1 }, -- Heals a friendly target for 15,978. Receives 300% bonus from Mastery: Harmony.
    ...
    rake                     = { 82199, 1822  , 1 }, -- Rake the target for 1,452 Bleed damage and an additional 12,548 Bleed damage over 15 sec. While stealthed, Rake will also stun the target for 4 sec and deal 60% increased damage. Awards 1 combo point.
    ...
    rejuvenation             = { 82217, 774   , 1 }, -- Heals the target for 11,343 over 15 sec. Tree of Life: Healing increased by 50% and Mana cost reduced by 30%.
    rip                      = { 82222, 1079  , 1 }, -- Finishing move that causes Bleed damage over time. Lasts longer per combo point. 1 point : 7,949 over 8 sec 2 points: 11,923 over 12 sec 3 points: 15,898 over 16 sec 4 points: 19,872 over 20 sec 5 points: 23,847 over 24 sec
    ...
    spring_blossoms          = { 82061, 207385, 1 }, -- Each target healed by Efflorescence is healed for an additional 1,547 over 6 sec.
    starfire                 = { 91040, 197628, 1 }, -- Call down a burst of energy, causing 8,096 Arcane damage to the target, and 2,762 Arcane damage to all other enemies within 5 yards.
    starsurge                = { 82200, 197626, 1 }, -- Launch a surge of stellar energies at the target, dealing 14,990 Astral damage.
    stonebark                = { 82081, 197061, 1 }, -- Ironbark increases healing from your heal over time effects by 20%.
    swiftmend                = { 82216, 18562 , 1 }, -- Consumes a Regrowth, Wild Growth, or Rejuvenation effect to instantly heal an ally for 24,719. Swiftmend heals the target for 8,999 over 9 sec.
    ...
    tranquility              = { 82054, 740   , 1 }, -- Heals all allies within 45 yards for 21,136 over 6.7 sec. Each heal heals the target for another 492 over 8 sec, stacking. Healing increased by 100% when not in a raid.
    ...
    verdancy                 = { 82060, 392325, 1 }, -- When Lifebloom blooms, up to 3 targets within your Efflorescence are healed for 6,964.
