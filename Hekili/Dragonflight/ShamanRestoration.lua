...
spec:RegisterTalents( {
    ...
    frost_shock                 = { 81074, 196840, 1 }, -- Chills the target with frost, causing 5,947 Frost damage and reducing the target's movement speed by 50% for 6 sec.
    ...
    healing_stream_totem        = { 81100, 5394  , 1 }, -- Summons a totem at your feet for 18 sec that heals an injured party or raid member within 46 yards for 4,107 every 1.6 sec. If you already know Healing Stream Totem, instead gain 1 additional charge of Healing Stream Totem.
    ...
    thunderstorm                = { 81097, 51490 , 1 }, -- Calls down a bolt of lightning, dealing 986 Nature damage to all enemies within 10 yards, reducing their movement speed by 40% for 5 sec, and knocking them away from the Shaman. Usable while stunned.
    ...
    -- Restoration
    acid_rain                   = { 81039, 378443, 1 }, -- Deal 3,204 Nature damage every 1 sec to up to 6 enemies inside of your Healing Rain.
    ...
    ascendance                  = { 81055, 114052, 1 }, -- Transform into a Water Ascendant, duplicating all healing you deal for 15 sec and immediately healing for 63,794. Ascendant healing is distributed evenly among allies within 20 yds.
    chain_heal                  = { 81063, 1064  , 1 }, -- Heals the friendly target for 16,822, then jumps up to 15 yards to heal the 3 most injured nearby allies. Healing is reduced by 30% with each jump.
    chain_lightning             = { 81061, 188443, 1 }, -- Hurls a lightning bolt at the enemy, dealing 13,607 Nature damage and then jumping to additional nearby enemies. Affects 3 total targets.
    ...
    deeply_rooted_elements      = { 81051, 378270, 1 }, -- Casting Riptide has a 7% chance to activate Ascendance for 6.0 sec.  Ascendance Transform into a Water Ascendant, duplicating all healing you deal for 15 sec and immediately healing for 63,794. Ascendant healing is distributed evenly among allies within 20 yds.
    ...
    downpour                    = { 80976, 207778, 1 }, -- A burst of water at the target location heals up to six injured allies within 12 yards for 16,567. Cooldown increased by 5 sec for each target effectively healed.
    ...
    earthen_wall_totem          = { 81046, 198838, 1 }, -- Summons a totem at the target location with 303,440 health for 18 sec. 2,183 damage from each attack against allies within 11.5 yards of the totem is redirected to the totem.
    earthliving_weapon          = { 81049, 382021, 1 }, -- Imbue your weapon with the element of Earth for 60 min. Your Riptide, Healing Wave, Healing Surge, and Chain Heal healing a 20% chance to trigger Earthliving on the target, healing for 6,502 over 12 sec.
    ...
    healing_rain                = { 81040, 73920 , 1 }, -- Blanket the target area in healing rains, restoring 15,398 health to up to 6 allies over 10 sec.
    healing_stream_totem_2      = { 81022, 5394  , 1 }, -- Summons a totem at your feet for 18 sec that heals an injured party or raid member within 46 yards for 4,107 every 1.6 sec. If you already know Healing Stream Totem, instead gain 1 additional charge of Healing Stream Totem.
    healing_tide_totem          = { 81032, 108280, 1 }, -- Summons a totem at your feet for 10 sec, which pulses every 1.6 sec, healing all party or raid members within 46 yards for 3106.4. Healing increased by 100% when not in a raid.
    healing_wave                = { 81026, 77472 , 1 }, -- An efficient wave of healing energy that restores 25,474 of a friendly target’s health.
    ...
    lava_burst                  = { 81062, 51505 , 1 }, -- Hurls molten lava at the target, dealing 17,433 Fire damage. Lava Burst will always critically strike if the target is affected by Flame Shock.
    ...
    overflowing_shores          = { 92677, 383222, 1 }, -- Healing Rain instantly restores 2,966 health to 6 allies within its area, and its radius is increased by 2 yards.
    ...
    primordial_wave             = { 81036, 375982, 1 }, -- Blast your target with a Primordial Wave, dealing 4,383 Shadow damage and apply Flame Shock to an enemy, or heal an ally for 4,733 and apply Riptide to them. Your next Healing Wave will also hit all targets affected by your Riptide for 60% of normal healing.
    ...
    riptide                     = { 81027, 61295 , 1 }, -- Restorative waters wash over a friendly target, healing them for 14,856 and an additional 11,921 over 18 sec.
    ...
    unleash_life                = { 81037, 73685 , 1 }, -- Unleash elemental forces of Life, healing a friendly target for 13,836 and increasing the effect of your next healing spell. Riptide, Healing Wave, or Healing Surge: 35% increased healing. Chain Heal: 15% increased healing and bounces to 1 additional target. Healing Rain or Downpour: 2 additional allies healed. Wellspring: 40% of overhealing done is converted to an absorb effect.
    ...
    wellspring                  = { 81051, 197995, 1 }, -- Creates a surge of water that flows forward, healing friendly targets in a wide arc in front of you for 9,685.a
} )
