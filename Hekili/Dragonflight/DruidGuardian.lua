...
-- Talents
if Hekili.CurrentBuild < 100002 then
    spec:RegisterTalents( {
        ...
        heart_of_the_wild             = { 82231, 319454, 1 }, -- Abilities not associated with your specialization are substantially empowered for 45 sec. Balance: Magical damage increased by 30%, and Starsurge is instant. Feral: Physical damage increased by 30%. Restoration: Healing increased by 30%, and mana costs reduced by 50%.
        ...
        ironfur                       = { 82227, 192081, 1 }, -- Increases armor by 2,084 for 8 sec.
        ...
        maim                          = { 82221, 22570 , 1 }, -- Finishing move that causes Physical damage and stuns the target. Damage and duration increased per combo point: 1 point : 544 damage, 1 sec 2 points: 1,088 damage, 2 sec 3 points: 1,632 damage, 3 sec 4 points: 2,176 damage, 4 sec 5 points: 2,720 damage, 5 sec
        ...
        matted_fur                    = { 82236, 385786, 1 }, -- When you use Barkskin or Survival Instincts, absorb 10,569 damage for 8 sec.
        ...
        protector_of_the_pack         = { 82245, 378986, 1 }, -- Store 10% of your damage, up to 4,060. Your next Regrowth consumes all stored damage to increase its healing.
        renewal                       = { 82232, 108238, 1 }, -- Instantly heals you for 30% of maximum health. Usable in all shapeshift forms.
        rip                           = { 82222, 1079  , 1 }, -- Finishing move that causes Bleed damage over time. Lasts longer per combo point. 1 point : 3,939 over 6 sec 2 points: 5,909 over 9 sec 3 points: 7,879 over 12 sec 4 points: 9,849 over 15 sec 5 points: 11,818 over 18 sec
        ...
        sunfire                       = { 82208, 93402 , 1 }, -- A quick beam of solar light burns the enemy for 860 Nature damage and then an additional 8,091 Nature damage over 13.5 sec.
        ...
        wild_growth                   = { 82241, 48438 , 1 }, -- Heals up to 5 injured allies within 30 yards of the target for 5,062 over 6.0 sec. Healing starts high and declines over the duration.

        -- Guardian
        after_the_wildfire            = { 82140, 371905, 1 }, -- Every 200 Rage you spend causes a burst of restorative energy, healing allies within 8 yds for 3,525.
        ...
        brambles                      = { 82161, 203953, 1 }, -- Sharp brambles protect you, absorbing and reflecting up to 212 damage from each attack. While Barkskin is active, the brambles also deal 117 Nature damage to all nearby enemies every 1 sec.
        ...
        maul                          = { 82127, 6807  , 1 }, -- Maul the target for 3,833 Physical damage.
        ...
        pulverize                     = { 82153, 80313 , 1 }, -- A devastating blow that consumes 2 stacks of your Thrash on the target to deal 4,344 Physical damage and reduce the damage they deal to you by 35% for 7.5 sec.
        rage_of_the_sleeper           = { 82141, 200851, 1 }, -- Unleashes the rage of Ursoc for 10 sec, preventing 25% of all damage you take and reflecting 1,997 Nature damage back at your attackers.
        rake                          = { 82199, 1822  , 1 }, -- Rake the target for 717 Bleed damage and an additional 6,217 Bleed damage over 11.3 sec. Awards 1 combo point.
        ...
        rejuvenation                  = { 82217, 774   , 1 }, -- Heals the target for 6,153 over 10.2 sec.
        ...
        starfire                      = { 91041, 197628, 1 }, -- Call down a burst of energy, causing 3,764 Arcane damage to the target, and 1,284 Arcane damage to all other enemies within 5 yards.
        starsurge                     = { 82200, 197626, 1 }, -- Launch a surge of stellar energies at the target, dealing 6,969 Astral damage.
        ...
        swiftmend                     = { 82216, 18562 , 1 }, -- Consumes a Regrowth, Wild Growth, or Rejuvenation effect to instantly heal an ally for 14,843.
