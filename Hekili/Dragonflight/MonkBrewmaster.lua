...
spec:RegisterTalents( {
    anvil_and_stave              = { 76506, 386937, 2 }, --
...
spec:RegisterAuras( {
    ...
    counterstrike = { -- TODO: Not sure if actually visible.
        id = 383800,
        duration = 10,
        max_stack = 1
    },
...
spec:RegisterPriority( "Brewmaster", 20220918,
-- Notes
[[
