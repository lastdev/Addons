-- $Id: zhCN.lua 24 2017-05-14 14:25:18Z arith $
...
L["Entrance"] = "入口"
L["HandyNotes - Legion Instance World Quests"] = "HandyNotes - 军团再临副本世界任务"
L["Icon Alpha"] = "图示透明度"
L["Icon Scale"] = "图示大小"
L["Icon settings"] = "图示设定"
L["Legion Instance World Quests"] = "军团再临副本世界任务"
L["Portal"] = "传送门"
L["Query from server"] = "从服务器查询名称"
L["QuestID"] = "任务代号"
...
L["Shows the World Quest related rare bosses' locations and quests in Legion instances."] = "显示军团再临副本里的世界任务相关稀有菁英位置与任务的信息。"
