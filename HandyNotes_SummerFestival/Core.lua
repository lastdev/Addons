...
---Updated for Classic/TBC by Venomisto (Novaspark-Arugal).
...
SummerFestival.isClassic = false
SummerFestival.isTBC = false
...
local function CheckEventActive()
	if (SummerFestival.isClassic or SummerFestival.isTBC) then
		--Always enabled in TBC/Classic, there's no C_Calendar and lizzard has been manually changing the dates.
