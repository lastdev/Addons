...
ns.icons = {
    ...
    battle_pet = "Interface\\Addons\\"..ADDON_NAME.."\\artwork\\BattlePet.blp",
    portal = "Interface\\Addons\\"..ADDON_NAME.."\\artwork\\Portal.blp",
    treasure = "Interface\\Addons\\"..ADDON_NAME.."\\artwork\\Treasure.blp",
    ...
    shootbox_blue = {
        icon="Interface\\Addons\\"..ADDON_NAME.."\\artwork\\shootboxes.blp",
