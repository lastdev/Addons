...
--> custom textures
	function ButtonMetaFunctions:InstallCustomTexture (texture, rect, coords, use_split, side_textures, side_textures2)
		...
		if (use_split) then
			...
			button.textureTopLeft:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureTopRight:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureBottomLeft:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureBottomRight:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureLeft:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureRight:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureTop:SetTexture ([[Interface\AddOns\ACU\default_button]])
			button.textureBottom:SetTexture ([[Interface\AddOns\ACU\default_button]])
		
		else
			texture = texture or [[Interface\AddOns\ACU\default_button]]
...
function ACUCreateButton (parent, func, w, h, text, param1, param2, texture, member, name, short_method)
...
function gump:NewButton (parent, container, name, member, w, h, func, param1, param2, texture, text, short_method)
	...
	if (not name) then
		name = "ACUButtonNumber" .. gump.ButtonCounter
	...
	ButtonObject.button = CreateFrame ("button", name, parent, "ACUButtonTemplate")
