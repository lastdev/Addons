local __exports = LibStub:NewLibrary("ovale/simulationcraft/SimulationCraft", 90047)
...
local consumableItems = __definitions.consumableItems
local ovaleIconTags = __definitions.ovaleIconTags
local classInfos = __definitions.classInfos
local __texttools = LibStub:GetLibrary("ovale/simulationcraft/text-tools")
local printRepeat = __texttools.printRepeat
...
local markNode = __generator.markNode
local sweepNode = __generator.sweepNode
local lastSimC = ""
local lastScript = ""
