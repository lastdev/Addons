local __exports = LibStub:NewLibrary("ovale/scripts/ovale_monk", 90113)
if not __exports then return end
__exports.registerMonk = function(scripts)
    do
        local name = "sc_t27_monk_brewmaster"
        local desc = "[9.1] Simulationcraft: T27_Monk_Brewmaster"
        local code = [[
...
# weapons_of_order
        ...
        scripts:registerScript("MONK", "brewmaster", name, desc, code, "script")
    end
    do
        local name = "sc_t27_monk_windwalker"
        local desc = "[9.1] Simulationcraft: T27_Monk_Windwalker"
        local code = [[
...
# wrathstone_item
        ...
        scripts:registerScript("MONK", "windwalker", name, desc, code, "script")
    end
    do
        local name = "sc_t27_monk_windwalker_necrolord"
        local desc = "[9.1] Simulationcraft: T27_Monk_Windwalker_Necrolord"
        local code = [[
...
# wrathstone_item
    ...
    do
        local name = "sc_t27_monk_windwalker_night_fae"
        local desc = "[9.1] Simulationcraft: T27_Monk_Windwalker_Night_Fae"
        local code = [[
...
# wrathstone_item
    ...
    do
        local name = "sc_t27_monk_windwalker_venthyr"
        local desc = "[9.1] Simulationcraft: T27_Monk_Windwalker_Venthyr"
        local code = [[
