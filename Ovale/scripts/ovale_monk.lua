local __exports = LibStub:NewLibrary("ovale/scripts/ovale_monk", 90048)
if not __exports then return end
__exports.registerMonk = function(scripts)
    do
        local name = "sc_t26_monk_brewmaster"
        local desc = "[9.0] Simulationcraft: T26_Monk_Brewmaster"
        local code = [[
...
# weapons_of_order
    ...
    do
        local name = "sc_t26_monk_windwalker"
        local desc = "[9.0] Simulationcraft: T26_Monk_Windwalker"
        local code = [[
...
# whirling_dragon_punch_talent
    ...
    do
        local name = "sc_t26_monk_windwalker_serenity"
        local desc = "[9.0] Simulationcraft: T26_Monk_Windwalker_Serenity"
        local code = [[
