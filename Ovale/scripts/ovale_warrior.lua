local __exports = LibStub:NewLibrary("ovale/scripts/ovale_warrior", 90108)
if not __exports then return end
__exports.registerWarrior = function(scripts)
    do
        local name = "sc_t27_warrior_arms"
        local desc = "[9.1] Simulationcraft: T27_Warrior_Arms"
        local code = [[
...
# whirlwind
    ...
    do
        local name = "sc_t27_warrior_fury"
        local desc = "[9.1] Simulationcraft: T27_Warrior_Fury"
        local code = [[
...
# will_of_the_berserker_runeforge
    ...
    do
        local name = "sc_t27_warrior_protection"
        local desc = "[9.1] Simulationcraft: T27_Warrior_Protection"
        local code = [[
