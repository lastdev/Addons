local __exports = LibStub:NewLibrary("ovale/scripts/ovale_priest", 90112)
if not __exports then return end
__exports.registerPriest = function(scripts)
    do
        local name = "sc_t27_priest_discipline"
        local desc = "[9.1] Simulationcraft: T27_Priest_Discipline"
        local code = [[
...
# unholy_nova
    ...
    do
        local name = "sc_t27_priest_shadow"
        local desc = "[9.1] Simulationcraft: T27_Priest_Shadow"
        local code = [[
...
# wrathful_faerie_debuff
    ...
    do
        local name = "sc_t27_priest_shadow_kyrian"
        local desc = "[9.1] Simulationcraft: T27_Priest_Shadow_Kyrian"
        local code = [[
...
# wrathful_faerie_debuff
    ...
    do
        local name = "sc_t27_priest_shadow_necrolord"
        local desc = "[9.1] Simulationcraft: T27_Priest_Shadow_Necrolord"
        local code = [[
...
# wrathful_faerie_debuff
    ...
    do
        local name = "sc_t27_priest_shadow_venthyr"
        local desc = "[9.1] Simulationcraft: T27_Priest_Shadow_Venthyr"
        local code = [[
