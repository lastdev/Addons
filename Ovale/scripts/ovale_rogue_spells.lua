local __exports = LibStub:NewLibrary("ovale/scripts/ovale_rogue_spells", 90107)
if not __exports then return end
__exports.registerRogueSpells = function(scripts)
    local name = "ovale_rogue_spells"
    local desc = "[9.1] Ovale: Rogue spells"
...
Define(sepsis_stealth_buff 347037)
  ...
  SpellRequire(stealth unusable set=1 enabled=(incombat()))
    ...
    scripts:registerScript("ROGUE", nil, name, desc, code, "include")
end
