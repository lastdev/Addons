local __exports = LibStub:NewLibrary("ovale/scripts/ovale_deathknight_spells", 90108)
if not __exports then return end
__exports.registerDeathKnightSpells = function(scripts)
    local name = "ovale_deathknight_spells"
    local desc = "[9.1] Ovale: Death Knight spells"
    local code = [[Define(abomination_limb 315443)
...
# summon_gargoyle
  SpellInfo(summon_gargoyle totem=1)
    ...
    scripts:registerScript("DEATHKNIGHT", nil, name, desc, code, "include")
end
