local __exports = LibStub:NewLibrary("ovale/scripts/ovale_paladin", 90047)
if not __exports then return end
__exports.registerPaladin = function(scripts)
    do
        local name = "sc_t26_paladin_protection"
        local desc = "[9.0] Simulationcraft: T26_Paladin_Protection"
        local code = [[
...
# word_of_glory
    ...
    do
        local name = "sc_t26_paladin_retribution"
        local desc = "[9.0] Simulationcraft: T26_Paladin_Retribution"
        local code = [[
