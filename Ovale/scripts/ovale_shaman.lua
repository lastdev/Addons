local __exports = LibStub:NewLibrary("ovale/scripts/ovale_shaman", 90047)
if not __exports then return end
__exports.registerShaman = function(scripts)
    do
        local name = "sc_t26_shaman_elemental"
        local desc = "[9.0] Simulationcraft: T26_Shaman_Elemental"
        local code = [[
...
# wind_shear
    ...
    do
        local name = "sc_t26_shaman_elemental_nf"
        local desc = "[9.0] Simulationcraft: T26_Shaman_Elemental_NF"
        local code = [[
...
# wind_shear
    ...
    do
        local name = "sc_t26_shaman_enhancement"
        local desc = "[9.0] Simulationcraft: T26_Shaman_Enhancement"
        local code = [[
...
# windstrike
    ...
    do
        local name = "sc_t26_shaman_enhancement_vdw"
        local desc = "[9.0] Simulationcraft: T26_Shaman_Enhancement_VDW"
        local code = [[
...
# windstrike
    ...
    do
        local name = "sc_t26_shaman_restoration"
        local desc = "[9.0] Simulationcraft: T26_Shaman_Restoration"
        local code = [[
