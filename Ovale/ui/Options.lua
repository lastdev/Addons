local __exports = LibStub:NewLibrary("ovale/ui/Options", 90107)
...
__imports.AceDB = LibStub:GetLibrary("AceDB-3.0", true)
__imports.AceDBOptions = LibStub:GetLibrary("AceDBOptions-3.0", true)
__imports.aceConsole = LibStub:GetLibrary("AceConsole-3.0", true)
__imports.aceEvent = LibStub:GetLibrary("AceEvent-3.0", true)
__imports.__toolstools = LibStub:GetLibrary("ovale/tools/tools")
__imports.printFormat = __imports.__toolstools.printFormat
local AceConfig = __imports.AceConfig
local AceConfigDialog = __imports.AceConfigDialog
local l = __imports.l
local AceDB = __imports.AceDB
local AceDBOptions = __imports.AceDBOptions
local aceConsole = __imports.aceConsole
local aceEvent = __imports.aceEvent
local InterfaceOptionsFrame_OpenToCategory = InterfaceOptionsFrame_OpenToCategory
local ipairs = ipairs
local huge = math.huge
local printFormat = __imports.printFormat
local optionModules = {}
