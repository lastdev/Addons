local __exports = LibStub:NewLibrary("ovale/ui/SpellFlash", 90048)
...
local __lib_button_glow10 = LibStub:GetLibrary("LibButtonGlow-1.0", true)
local HideOverlayGlow = __lib_button_glow10.HideOverlayGlow
local ShowOverlayGlow = __lib_button_glow10.ShowOverlayGlow
local colorMain = {
    r = nil,
    g = nil,
    b = nil
