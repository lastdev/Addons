...
L.AUTO_TIMER_OPTIONS.cdpnp			= "Приоритетный отсчёт времени до восстановления $spell:%s (только индикарторы здоровья)"
...
L.AUTO_TIMER_OPTIONS.nextpnp 		= "Приоритетный отсчёт времени до следующего $spell:%s (только индикарторы здоровья)"
