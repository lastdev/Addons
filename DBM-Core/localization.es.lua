...
L.SCENARIO_COMPLETE_I			= "¡%s ha sido completado! La has completado %d veces en total."
L.SCENARIO_COMPLETE_L			= "¡%s ha sido completado en %s! La última vez tardaste %s y tu récord es %s. La has completado %d veces en total."
L.SCENARIO_COMPLETE_NR			= "¡%s ha sido completado en %s! ¡Es un nuevo récord! (El anterior era %s). La has completado %d veces en total."
...
L.VOICE_MISSING				= "Tenías seleccionado un paquete de voces que no se ha podido encontrar. Se ha restablecido tu selección a 'Ninguno'. Si crees que se trata de un error, asegúrate de que el paquete de voces se haya instalado correctamente y esté activado en la lista de Addons."
...
L.UPDATEREMINDER_DISABLE			= "AVISO: Se ha desactivado " .. L.DBM .. " porque tu versión está demasiado desactualizada. Para prevenir conflictos con las versiones de otros jugadores, no se podrá volver a activar " .. L.DBM .. " hasta que lo actualices."
L.UPDATEREMINDER_DISABLETEST		= "AVISO: Se ha desactivado " .. L.DBM .. " porque tu versión está demasiado desactualizada y este es un reino de prueba/beta. No se podrá volver a activar " .. L.DBM .. " hasta que lo actualices. Esto es para garantizar que no se utilicen modificaciones obsoletas al generar comentarios de prueba."
...
L.UPDATEREMINDER_MAJORPATCH			= "AVISO: Se ha desactivado " .. L.DBM .. " porque tu versión está demasiado desactualizada. Dado que se trata de un parche de contenido importante, y para prevenir conflictos con las versiones de otros jugadores, no se podrá volver a activar " .. L.DBM .. " hasta que lo actualices."
L.VEM								= "AVISO: Estás ejecutando " .. L.DBM .. " y Voice Encounter Mods a la vez. " .. L.DBM .. " no funciona correctamente con esta configuración, y por tanto no se ejecutará."
...
L.OUT_OF_DATE_NAG					= "Tu versión de " .. L.DBM .. " está desactualizada para este encuentro. Se recomienda que actualices " .. L.DBM .. " para no perderte ningún aviso, temporizador o indicador crucial para tu grupo de banda."
...
L.AUTO_SPEC_WARN_OPTIONS.link			= "Mostrar aviso especial cuando estés vinculado a otro jugador por $spell:%s"
