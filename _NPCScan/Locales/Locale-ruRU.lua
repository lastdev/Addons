...
private.L["FOUND_TAMABLE_WRONGZONE_FORMAT"] = "|cffff2020Ложная тревога:|r Найдено приручаемое существо |cff808080“%s”|r в локации %s вместо %s (ID %d); Это определенно питомец охотника."
...
private.L["VIGNETTE_SCAN_DESC"] = "Некоторые редкие существа появляются на миникарте в виде иконок. Эта экспериментальная функция позволяет повторно отслеживать их появление в зоне видимости, вне зависимости от кэша. Вы будете уведомлены в любом случае, даже если существо было исключено из списка отслеживания."
=======
