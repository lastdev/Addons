--[[
	...
	Version: 8.1.6235 (SwimmingSeadragon)
	Revision: $Id: PageOneReturn.lua 6235 2019-03-04 00:20:18Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Util-FixAH/PageOneReturn.lua $", "$Rev: 6235 $")
