...
do
	...
	events.UNIT_SPELLCAST_DELAYED = UnitSpellcastMidway
	events.UNIT_SPELLCAST_CHANNEL_UPDATE = UnitSpellcastMidway
	events.UNIT_SPELLCAST_INTERRUPTIBLE = UnitSpellcastMidway
	events.UNIT_SPELLCAST_NOT_INTERRUPTIBLE = UnitSpellcastMidway

	events.UNIT_LEVEL = UnitConditionChanged
	events.RAID_TARGET_UPDATE = UnitConditionChanged
	events.UNIT_THREAT_SITUATION_UPDATE = UnitConditionChanged
	events.UNIT_FACTION = UnitConditionChanged

	events.PLAYER_CONTROL_LOST = WorldConditionChanged
	events.PLAYER_CONTROL_GAINED = WorldConditionChanged
