--[[
	...
	Revision: $Id: SearcherResale.lua 5331 2012-08-19 02:43:59Z ccox $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherResale.lua $", "$Rev: 5331 $")
