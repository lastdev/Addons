--[[
	...
	Revision: $Id: SearcherResale.lua 5606 2016-06-13 16:33:33Z brykrys $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherResale.lua $", "$Rev: 5606 $")
