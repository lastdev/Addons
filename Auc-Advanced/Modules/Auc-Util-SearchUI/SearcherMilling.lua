--[[
	...
	Revision: $Id: SearcherMilling.lua 5331 2012-08-19 02:43:59Z ccox $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherMilling.lua $", "$Rev: 5331 $")
