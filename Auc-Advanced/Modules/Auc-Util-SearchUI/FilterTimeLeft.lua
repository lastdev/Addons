--[[
	...
	Revision: $Id: FilterTimeLeft.lua 5347 2012-09-06 06:26:15Z Esamynn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/FilterTimeLeft.lua $", "$Rev: 5347 $")
