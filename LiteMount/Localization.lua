...
if locale == "itIT" then
    ...
    L["LM_FLYABLE_AREA"] = "Area volabile"
    L["LM_GROUND"] = "Terra"
    L["LM_GROUP"] = "Gruppo"
    L["LM_GROUPS"] = "Gruppi"
    ...
    L["LM_LIMIT_MOUNTS"] = "Limite di cavalcature"
    ...
    L["LM_MODIFIER_KEY"] = "Tasto modificatore"
    ...
    L["LM_SEX"] = "Sesso"
    L["LM_SHOW_ALL_MOUNTS"] = "Mostra tutte la cavalcaturas"
    L["LM_SMARTMOUNT_ACTION"] = "Cavalcatura prioritario intelligente"
...
if locale == "ruRU" then
    ...
    L["LM_CREATE_GLOBAL_GROUP"] = "Глобал"
    ...
    L["LM_FLAG"] = "тег"
    L["LM_FLAGS"] = "теги"
    L["LM_FLYABLE_AREA"] = "Область полета"
    ...
    L["LM_INCLUDE_MOUNTS"] = "Включите транспорт"
    L["LM_INSTANT_ONLY_MOVING"] = "Призывайте маунтов с мгновенным применением только во время движения."
    L["LM_LIMIT_MOUNTS"] = "Ограничение транспорт"
    ...
    L["LM_MOUNT_ACTION"] = "Случайное транспорт"
    ...
    L["LM_SEX"] = "Пол"
    L["LM_SHOW_ALL_MOUNTS"] = "Показать все транспорт"
    L["LM_SMARTMOUNT_ACTION"] = "Умное приоритетное транспорт"
