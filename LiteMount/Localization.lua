...
if locale == "frFR" then
    ...
    L["LM_PROFILES_EXP"] = "Les profils sont différentes configurations entre lesquelles vous pouvez basculer. Chacun de vos personnages a son propre profil sélectionné. Tous les paramètres, à l'exception des macros Combat et Indisponible, sont enregistrés dans le profil et changent lors du changement de profil."
...
if locale == "itIT" then
    ...
    L["LM_DISABLE_NEW_MOUNTS"] = "Disattiva automaticamente le cavalcature appena aggiunte."
...
if locale == "ruRU" then
    ...
    L["LM_DISABLE_NEW_MOUNTS"] = "Автоматически отключать недавно добавленный транспорт."
