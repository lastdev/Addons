...
if locale == "ruRU" then
    ...
    L["LM_RULES_EXP"] = "Правила для транспорта. Каждое правило имеет до 3 условий и действия. Правила проверяются по порядку, и если все условия подходят, действие применяется."
    ...
    L["LM_SEX"] = "Пол"
    L["LM_SHOW_ALL_MOUNTS"] = "Показать весь транспорт"
