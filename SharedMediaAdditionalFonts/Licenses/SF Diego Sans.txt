...
------------------------------------------------------------------------
SF Diego Sans - Version 1.0 - Features
------------------------------------------------------------------------

 - Includes complete character set (uppercase and alternate letters,
   numbers, punctuation, and accented characters).
 - Included the Euro symbol.
 - Full embedding allowed.
