...
function iSB.UpdateThumbTextures(d, tsz)
	...
	local stt, mct, bs = sty.smallThumbThreshold, sty.thumbMid.tch, sty.thumb
	tsz = tsz or d.Thumb:GetHeight()
	local isSmall, sbot = stt and tsz < stt
	sbot = isSmall and sty.thumbBotS or sty.thumbBot
	confTexture(n[1], sty.thumbTop, bs)
	confTexture(n[2], sty.thumbMid, bs)
	confTexture(n[3], sbot, bs)
	confTexture(h[1], sty.thumbTopH, sty.thumbTop, bs)
	confTexture(h[2], sty.thumbMidH, sty.thumbMid, bs)
	confTexture(h[3], isSmall and sty.thumbBotHS or sty.thumbBotH, sbot, bs)
	confTexture(p[1], sty.thumbTopP, sty.thumbTop, bs)
	confTexture(p[2], sty.thumbMidP, sty.thumbMid, bs)
	confTexture(p[3], isSmall and sty.thumbBotPS or sty.thumbBotP, sbot, bs)
