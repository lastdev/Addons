-- AUTOGENERATED 2024-08-05T21:24:50+00:00
local me=...
...
self:RelNotes(3,10,0,[[
Toc: Update for 11.0.5
Fix: Removed non longer existing functions
]])
self:RelNotes(3,9,2,[[
...
self:RelNotes(3,3,6,[[
Fix: 84x ...rfaceGarrisonCommander\GarrisonCommander-3.3.5 90002.lua
]])
self:RelNotes(3,3,5,[[
Toc: 9.0.2
...
Feature: Popup message should be informative
...
Feature: No longer includes OrderHallCommander
