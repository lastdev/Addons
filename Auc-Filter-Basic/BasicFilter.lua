--[[
	...
	Version: 7.7.6081 (SwimmingSeadragon)
	Revision: $Id: BasicFilter.lua 6081 2018-08-29 01:26:34Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Filter-Basic/BasicFilter.lua $", "$Rev: 6081 $")
