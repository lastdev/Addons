...
local SpeedometerCoverOptions = {
	[1] = { -- default speedometer
...
local DefOptions = SpeedometerCoverOptions[1]
local DefBarOptions = SpeedometerBarOptions[1]
