...
local path = "Interface\\Addons\\TidyPlates_Renaitre\\Textures\\"
--local font = "Interface\\Addons\\TidyPlates_Renaitre\\Fonts\\RobotoCondensed-Bold.ttf"; local fontsize = 10;
...
local ThemeName = "RenaitreRenaitre/|cFFFF4400"
