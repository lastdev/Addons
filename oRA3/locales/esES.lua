...
L["autoLootMethodDesc"] = "Permite a oRA3 ajustar automáticamente el modo de loteo que tu especifiques para cuando entres a un grupo o raid." -- Needs review
L["average"] = "Promedio"
...
L["invitePrintMaxLevel"] = "Todos los jugadores con el nivel máximo serán invitados a la raid en 10 segundos. Por favor, dejad vuestros grupos." -- Needs review
L["invitePrintRank"] = "Todos los jugadores con rango %s o superior serán invitados a la raid en 10 segundos. Por favor, dejad vuestros grupos." -- Needs review
L["invitePrintZone"] = "Todos los jugadores en %s serán invitados a la raid en 10 segundos. Por favor, dejad vuestros grupos." -- Needs review
