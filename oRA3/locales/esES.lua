...
L["Mass promotion"] = "Promocionar a ayudante masivamente"
L["Everyone"] = "Todos"
L["Promote everyone automatically."] = "Promociona a ayudante a todos automáticamente"
L["Guild"] = "Hermandad"
L["Promote all guild members automatically."] = "Promociona a ayudante a todos los miembros de hermandad automáticamente."
L["By guild rank"] = "Por rango de hermandad"
L["Individual promotions"] = "Promocionar a ayudante individualmente"
L["Note that names are case sensitive. To add a player, enter a player name in the box below and hit Enter or click the button that pops up. To remove a player from being promoted automatically, just click his name in the dropdown below."] = "Ten en cuenta que los nombres distinguen mayúsculas. Para añadir un jugador, introduce el nombre del jugador en el recuadro de abajo y presiona Enter o clica el botón que aparece. Para quitar a un jugador que ha sido promocionado a ayudante automáticamente, sólo clica su nombre en la lista desplegable de abajo."
L["Add"] = "Añadir"
L["Remove"] = "Quitar"
