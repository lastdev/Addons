...
L["autoLootMethod"] = "Ajustar automáticamente el modo de distribución del botín cuando entres a un grupo." -- Needs review
L["autoLootMethodDesc"] = "Permite a oRA3 ajustar automáticamente el modo de distribución del botín que tu especifiques cuando entres a un grupo o banda." -- Needs review
L["average"] = "Promedio"
...
L["ensureRepair"] = "Asegurarse que las reparaciones de hermandad están activadas para todos los rangos presentes en la banda" -- Needs review
L["ensureRepairDesc"] = "Si eres el Maestro de la hermandad, cada vez que entres a un grupo de banda y seas el líder o ayudante, con esto te asegurarás que las reparaciones de hermandad están activadas para la duración de la banda (hasta 300g). Una vez dejes el grupo, los ajustes serán restaurados a su estado original |cffff4411siempre que no te caigas durante la banda.|r" -- Needs review
...
L["guildRepairs"] = "Reparaciones de Hermandad" -- Needs review
L["height"] = "Altura"
...
L["remove"] = "Quitar"
L["repairAmount"] = "Límite de Reparaciones" -- Needs review
L["repairAmountDesc"] = "La máxima cantidad de oro por jugador que se permite para reparaciones." -- Needs review
L["repairEnabled"] = "Activadas reparaciones de hermandad de %s para la duración de esta banda." -- Needs review
