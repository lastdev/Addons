...
L["guildRepairs"] = "Гильдейский ремонт"
L["height"] = "Высота"
...
L["remove"] = "Удалить"
L["repairAmount"] = "Лимит починки"
L["repairAmountDesc"] = "Максимальное количество золота на игрока, разрешенное для ремонта."
...
L["showMissingMaxStat"] = "Показывать слабую еду как отсутствующую"
L["showMissingMaxStatDesc"] = "Показывать иконки слабой еды и фласок другим цветом."
