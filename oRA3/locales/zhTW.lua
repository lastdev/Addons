...
L["add"] = "增加"
L["autoLootMethod"] = "加入團隊時自動設定捨取模式"
L["autoLootMethodDesc"] = "當進入隊伍或團隊，讓oRA3自動設定捨取模式，從下面指定。"
L["average"] = "平均"
L["barSettings"] = "計時條設定"
...
L["slashCommands"] = [=[oRA3誇示/指令範圍來幫助你在快節奏的團隊中。假如你不再徘迴在舊的CTRA日子，這裡有一些參考。所有/指令有各種速記也有長的，為了方便，更多描述在某些情況會被取代。
