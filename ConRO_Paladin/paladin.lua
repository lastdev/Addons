...
--Abilities
	...
	local _HammerofWrath, _HammerofWrathRDY																				= ConRO:AbilityReady(Ability.HammerofWrath, timeShift);
...
--Rotations
	...
	if (ConRO_AutoButton:IsVisible() and ((_enemies_in_melee >= 2 and not tChosen[Passive.RighteousVerdict]) or _enemies_in_melee >= 3)) or ConRO_AoEButton:IsVisible() then
