		...
		notes = {
			...
			args = {
				...
				noteChat = { type = "description", name = "Chat command shortcuts are also supported.\n\n"
					..NORMAL_FONT_COLOR_CODE .."/ng" ..HIGHLIGHT_FONT_COLOR_CODE .." - Show this panel\n",
					order = 22, },
			},
		},
	},
...
function HandyNotes_NobleGarden_OnAddonCompartmentClick( ... )
	GameTooltip:Hide()
end
...
local function Slash( options )
	...
	if ( ns.version >= 100000 ) then
		print( ns.colour.prefix ..L["Noblegarden"] ..": " ..ns.colour.highlight
