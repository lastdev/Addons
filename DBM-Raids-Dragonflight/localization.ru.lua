...
L:SetOptionLocalization({
	TankSwapBehavior	= "Установить режим мода при смене танков",
	OnlyIfDanger		= "Показывать предупреждение о таунте только в том случае, если другой танк собирается принять на себя $spell:407547 или $spell:407597",
	MinMaxSoak			= "Показывать предупреждение о таунте после первой комбо-атаки или если другой танк собирается принять на себя $spell:407547 или $spell:407597",
	DoubleSoak			= "Показывать предупреждение о таунте после завершения комбо-атаки или если другой танк собирается принять на себя $spell:407547 или $spell:407597"--По умолчанию
})
