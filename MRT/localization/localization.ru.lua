...
L.ReminderUndoTip = "Удалить только что добавленые ремаиндеры"
...
L.ReminderDisableSavingMplusHistory = "Отключить сохранение истории м+"
L.ReminderDisableSavingMplusHistoryTip = "Используйте эту опцию для того, чтоб не сохранять историю м+ ключей.\nМ+ ключи по прежнему будут записыватся (если включена опция), но история будет доступна только для текущей сессии."
...
L.ReminderHistorySync = "Отправлять в рейд таймлайн (историю) последнего пула"
