...
statPriorityStats["ROGUEAssassination"] = "Haste > Critical Strike > Mastery > Versatility"
...
statPriorityStats["WARLOCKSacrifice"] = "Intellect > Haste > Versatility > Critical Strike > Mastery"
...
statPriorityStats["DEATHKNIGHTBlood"] = "Strength > Haste > Versatility > Critical Strike > Mastery"
	...
	if parent ~= nil and statPriorityFrameCreate(frame, frameText, parent) then
		...
		if parent == PaperDollFrame then
			...
			elseif class == "WARLOCK" then
				if IsSpellKnown(267214) then
					text = statPriorityStats[class .. "Sacrifice"]
				end
			end
