...
A [HandyNotes](http://www.curse.com/addons/wow/handynotes) plugin to show Wrath interesting points on your map. (That means it **requires** [HandyNotes](http://www.curse.com/addons/wow/handynotes), so go install it as well.)
