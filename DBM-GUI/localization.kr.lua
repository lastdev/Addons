...
L.ZeroatWindowEnds					= "타이머 마지막을 0으로 계산"--Not final, still a bit unclear
L.ZeroatWindowStart					= "타이머 시작점을 0으로 계산"--Not final, still a bit unclear
L.VarianceTimerSubZeroBehavior		= "가변적 타이머 0 이하 작동 방식 설정"--Not final, still a bit unclear
L.ZeroGoesNegative					= "0 이하는 마이너스로 타이머 텍스트 표시"--Not final, still a bit unclear
L.ZeroGoesRestart					= "0 이하가 되면 타이머 텍스트 초기화"--Not final, still a bit unclear
