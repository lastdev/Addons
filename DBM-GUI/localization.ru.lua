...
L.SpamBlockNoSpecWarnFlash			= "Не показывать вспышку экрана при специальном объявлении"
...
L.DontPlayPTCountdown		= "Совсем не воспроизводить звук обратного отсчета пулла/перерыва/пользов."
...
L.FilterDispels				= "Не показывать объявления для рассеиваемых заклинаний, если Ваш диспел находится в кулдауне"
L.FilterCrowdControl		= "Не показывать объявления для прерываний, связанных с контролем большого количества мобов, если Ваши контроли находятся на перезарядке"
L.FilterTrashWarnings		= "Не показывать объявления для трэша в подземельях с соратниками, а также обычных и тривиальных (превышенных по уровню) подземельях"
...
L.SpamSpecRoleDispel				= "Не показывать оповещения о 'рассеивании' (без текста и звука вообще)"
L.SpamSpecRoleInterrupt				= "Не показывать 'прерываемые' оповещения (без текста и звука вообще)"
L.SpamSpecRoleDefensive				= "Не показывать 'защитные' оповещения (без текста и звука вообще)"
L.SpamSpecRoleTaunt					= "Не показывать 'провокационные' оповещения (для танков -> 'таунт') (без текста и звука вообще)"
L.SpamSpecRoleSoak					= "Не показывать 'поглощающие' оповещения (без текста и звука вообще)"
L.SpamSpecRoleStack					= "Не показывать 'high stack' оповещения (без текста и звука вообще)"
L.SpamSpecRoleSwitch				= "Не показывать оповещения о 'смене цели' &amp; 'аддов' (без текста и звука вообще)"
