...
L.Area_ColorBytype			= "Цветные полосы по типу справочника"
-- Panel: Color by Type
...
L.AreaTitle_BarSetupVariance		= "Variance Bar Options"--Later (позже)
L.EnableHugeBar 			= "Включить увеличенный индикатор (Полоса 2)"
L.EnableVarianceBar 				= "Enable variance bars"--Later (позже)
L.VarianceTimerTextBehavior			= "Set variance timer text behavior"--Later (позже)
L.ZeroatWindowEnds					= "Timer text hits zero at end of CD window"--Not final, still a bit unclear (Не окончательно, все еще немного неясно)
L.ZeroatWindowStart					= "Timer text hits zero at start of CD window"--Not final, still a bit unclear (Не окончательно, все еще немного неясно)
L.VarianceTimerSubZeroBehavior		= "Set variance timer sub zero behavior"--Not final, still a bit unclear (Не окончательно, все еще немного неясно)
L.ZeroGoesNegative					= "Timer text counts negative after zero"--Not final, still a bit unclear (Не окончательно, все еще немного неясно)
L.ZeroGoesRestart					= "Timer text restarts after zero"--Not final, still a bit unclear (Не окончательно, все еще немного неясно)
