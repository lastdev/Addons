...
function HealBot_Share_ShowLinkFrame()
    if not hbLinkFrame then
        ...
        hbLinkFrameObjects["CloseBtn"] = CreateFrame("Button", "HealBot_Link_Frame_CloseBtn", hbLinkFrame, "OptionsButtonTemplate")
        ...
        hbLinkFrameObjects["YesBtn"] = CreateFrame("Button", "HealBot_Link_Frame_YesBtn", hbLinkFrame, "OptionsButtonTemplate")
        ...
        hbLinkFrameObjects["NoBtn"] = CreateFrame("Button", "HealBot_Link_Frame_NoBtn", hbLinkFrame, "OptionsButtonTemplate")
...
function HealBot_Share_ShowPostFrame(g,h,f,tTxt)
    if not hbPostLinkFrame then
        ...
        hbPostLinkFrameObjects["PostBtn"] = CreateFrame("Button", "HealBot_Post_Frame_PostBtn", hbPostLinkFrame, "OptionsButtonTemplate")
        ...
        hbPostLinkFrameObjects["CloseBtn"] = CreateFrame("Button", "HealBot_Post_Frame_CloseBtn", hbPostLinkFrame, "OptionsButtonTemplate")
