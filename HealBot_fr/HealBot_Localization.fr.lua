-- French version (by Kubik of Vol'Jin) 2014-08-25 / V. 5.4.8.3
-- à = \195\160
-- â = \195\162
-- ç = \195\167
-- è = \195\168
...
HEALBOT_CUSTOM_DEBUFF_CATS = {
        ...
        [HEALBOT_DEBUFF_BURNING_BILE]          = 2,  --Bile brulante
        [HEALBOT_DEBUFF_CHILLED_BONE]          = 11, --Transi jusqu'aux os
        [HEALBOT_DEBUFF_COMBUSTION]            = 3,  --Combustion
        [HEALBOT_DEBUFF_CONFLAGRATION]         = 3,  --Deflagration
        [HEALBOT_DEBUFF_CONSUMING_FLAMES]      = 4,  --Flammes consumantes
        [HEALBOT_DEBUFF_CONSUMPTION]           = 3,  --Consomption
        [HEALBOT_DEBUFF_CORROSION]             = 3,  --Corrosion
        [HEALBOT_DEBUFF_DARK_BARRAGE]          = 2,  --Barrage noir
        [HEALBOT_DEBUFF_DEFILE]                = 9,  --Profanation
        [HEALBOT_DEBUFF_DELIRIOUS_SLASH]       = 4,  --Entaille délirante
        [HEALBOT_DEBUFF_DOOMFIRE]              = 4,  --Feu funeste
        [HEALBOT_DEBUFF_ENCAPSULATE]           = 4,  --Enfermer
        [HEALBOT_DEBUFF_ESSENCE_BLOOD_QUEEN]   = 4,  --Essence de la reine de sang
        [HEALBOT_DEBUFF_EXPLOSIVE_CINDERS]     = 2,  --Braises explosives
        [HEALBOT_DEBUFF_EXPOSE_WEAKNESS]       = 9,  --Perce faille
        [HEALBOT_DEBUFF_FATAL_ATTRACTION]      = 7,  --Liaison fatale
        [HEALBOT_DEBUFF_FEL_RAGE]              = 5,  --Gangrerage
        [HEALBOT_DEBUFF_FEL_RAGE2]             = 5,
        [HEALBOT_DEBUFF_FERAL_POUNCE]          = 2,  --Bond farouche
        [HEALBOT_DEBUFF_FIERY_COMBUSTION]      = 3,  --Combustion ardente
        [HEALBOT_DEBUFF_FIRE_BLOOM]            = 4,  --Fleur de feu
        [HEALBOT_DEBUFF_FIRE_BOMB]             = 2,  --Bombe incendiaire
        [HEALBOT_DEBUFF_FLAME_SEAR]            = 6,  --Incandescence des Flammes
        [HEALBOT_DEBUFF_FLASH_FREEZE]          = 5,  --Gel instantané
        [HEALBOT_DEBUFF_FROST_BEACON]          = 5,  --Guide de givre
        [HEALBOT_DEBUFF_FROST_BLAST]           = 11,  --Trait de givre
        [HEALBOT_DEBUFF_FROST_BREATH]          = 11,  --Souffle de givre
        [HEALBOT_DEBUFF_FROST_TOMB]            = 11,  --Tombeau de givre
        [HEALBOT_DEBUFF_GAS_SPORE]             = 11,  --Spore gazeuse
        [HEALBOT_DEBUFF_GASEOUS_BLOAT]         = 2,  --Ballonnement gazeux
        [HEALBOT_DEBUFF_GASTRIC_BLOAT]         = 2,  --Ballonnement gastrique
        [HEALBOT_DEBUFF_GLITTERING_SPARKS]     = 4,  --Etincelles lumineuses
        [HEALBOT_DEBUFF_GRAVITY_BOMB]          = 2,  --Bombe a gravite
        [HEALBOT_DEBUFF_GRAVITY_CORE]          = 8,  --Noyau de gravite
        [HEALBOT_DEBUFF_GRAVITY_CRUSH]         = 2,  --Broiement gravitationnel
        [HEALBOT_DEBUFF_GRIEVOUS_BITE]         = 5,  --Grave morsure    
        [HEALBOT_DEBUFF_GRIEVOUS_THROW]        = 7,  --Lancer effroyable
        [HEALBOT_DEBUFF_GUT_SPRAY]             = 9,  --Projection de tripes
        [HEALBOT_DEBUFF_HARVEST_SOUL]          = 8,  --Moisson d'ames
        [HEALBOT_DEBUFF_ICEBOLT]               = 4,  --Eclair de glace
        [HEALBOT_DEBUFF_ICE_TOMB]              = 11,  --Tombe de glace
        [HEALBOT_DEBUFF_IMPALE]                = 4,  --Empaler
        [HEALBOT_DEBUFF_IMPALED]               = 4,
        [HEALBOT_DEBUFF_IMPALING_SPINE]        = 4,  --Epine de perforation
        [HEALBOT_DEBUFF_INCINERATE_FLESH]      = 6,  --Incinerer la chair
        [HEALBOT_DEBUFF_INFEST]                = 6,  --Infeste
        [HEALBOT_DEBUFF_INSTABILITY]           = 6,  --Instabilite
        [HEALBOT_DEBUFF_IRON_ROOTS]            = 10,  --Racines de fer
        [HEALBOT_DEBUFF_JAGGED_KNIFE]          = 3,  --Couteau dentele
        [HEALBOT_DEBUFF_LEGION_FLAME]          = 4,  --Flamme de la legion
        [HEALBOT_DEBUFF_LIGHTNING_ROD]         = 2,  --Batonnet d'eclair   !!LIGHTING or LIGHTNING ???
        [HEALBOT_DEBUFF_FALLEN_CHAMPION]       = 8,  --Marque du champion dechu
        [HEALBOT_DEBUFF_MISTRESS_KISS]         = 2,  --Baiser de la maitresse
        [HEALBOT_DEBUFF_MUTATED_INFECTION]     = 6,  --Infection mutee
        [HEALBOT_DEBUFF_MUTATED_PLAGUE]        = 9,  --Peste mutee
        [HEALBOT_DEBUFF_MYSTIC_BUFFET]         = 10,  --Rafale mystique
        [HEALBOT_DEBUFF_NAPALM_SHELL]          = 9,  --Obus napalm
        [HEALBOT_DEBUFF_NECROTIC_PLAGUE]       = 9,  --Peste necrotique
        [HEALBOT_DEBUFF_NECROTIC_STRIKE]       = 4,  --Frappe necrotique
        [HEALBOT_DEBUFF_PACT_DARKFALLEN]       = 9,  --Pacte des tenebrants
        [HEALBOT_DEBUFF_PARALYTIC_TOXIN]       = 11,  --Toxine paralysante
        [HEALBOT_DEBUFF_PARASITIC_INFECT]      = 6,  --Infection parasitique
        [HEALBOT_DEBUFF_PARASITIC_SHADOWFIEND] = 9,  --Ombrefiel parasite
        [HEALBOT_DEBUFF_PENETRATING_COLD]      = 4,  --Froid penetrant
        [HEALBOT_DEBUFF_RUNE_OF_BLOOD]         = 10,  --Rune sanglante
        [HEALBOT_DEBUFF_SACRIFICE]             = 11,
        [HEALBOT_DEBUFF_SARA_BLESSING]         = 2,  --Benediction de sara
        [HEALBOT_DEBUFF_SHADOW_PRISON]         = 9,  --Prison de l'ombre
        [HEALBOT_DEBUFF_SLAG_POT]              = 8, --Marmite de scories !!SLAG PIT or SLAG POT ???
        [HEALBOT_DEBUFF_SNOBOLLED]             = 4,  --Frigbolde
        [HEALBOT_DEBUFF_SOUL_CONSUMPTION]      = 3,  --Consomption d'ames
        [HEALBOT_DEBUFF_SPINNING_PAIN_SPIKE]   = 9,  --Pic de douleur tournoyant
        [HEALBOT_DEBUFF_STONE_GRIP]            = 9,  --Poigne de pierre
        [HEALBOT_DEBUFF_SWARMING_SHADOWS]      = 9,  --Ombres grouillantes
        [HEALBOT_DEBUFF_TOUCH_OF_DARKNESS]     = 11,  --Toucher des tenebres
        [HEALBOT_DEBUFF_TOUCH_OF_LIGHT]        = 11,  --Toucher de lumiere
        [HEALBOT_DEBUFF_TOXIC_SPORES]          = 11,  --Spores toxiques
