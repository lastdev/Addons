...
function exportedAchievements.Load(a, t)
    ...
    a[16069] = b:New(16069, 0); -- Dragon Glyphs: Drake Eye's Pond
    ...
    a[16317] = b:New(16317, 10); -- Secret Fishing Spots
    a[16320] = b:New(16320, 10); -- Does Steam Do Fire Damage?
    a[16321] = b:New(16321, 10); -- Cutting Tusk Equipment
    a[16322] = b:New(16322, 10); -- Best in Slot
    ...
    a[16493] = b:New(16493, 5); -- Petty Theft Mammoth
