-- [[ Exported at 2023-03-20 17-58-34 ]] --
...
function exportedCalendarEvents.InjectDynamicOptions()
    ...
    KrowiAF_RegisterEventOptions("Calendar", "Other", addon.L["Other"], 1262, addon.L["WoW's 18th Anniversary"]);
    KrowiAF_RegisterDeSelectAllEventOptions("Calendar", "Other", { 479, 1262 });
end
