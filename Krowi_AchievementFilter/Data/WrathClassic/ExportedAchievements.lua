-- [[ Exported at 2023-06-15 19-16-25 ]] --
...
function exportedAchievements.Load(a, t)
    ...
    a[17340] = b:New(17340); -- Ahead of the Curve: Yogg-Saron
    a[17341] = b:New(17341); -- Cutting Edge: Ulduar
    a[18590] = b:New(18590); -- Defense Protocol Beta: Utgarde Keep
    a[18591] = b:New(18591); -- Defense Protocol Beta: The Nexus
    a[18592] = b:New(18592); -- Defense Protocol Beta: Azjol-Nerub
    a[18593] = b:New(18593); -- Defense Protocol Beta: Ahn'kahet: The Old Kingdom
    a[18594] = b:New(18594); -- Defense Protocol Beta: Drak'Tharon Keep
    a[18595] = b:New(18595); -- Defense Protocol Beta: The Violet Hold
    a[18596] = b:New(18596); -- Defense Protocol Beta: Gundrak
    a[18597] = b:New(18597); -- Defense Protocol Beta: Halls of Stone
    a[18598] = b:New(18598); -- Defense Protocol Beta: Halls of Lightning
    a[18599] = b:New(18599); -- Defense Protocol Beta: The Oculus
    a[18600] = b:New(18600); -- Defense Protocol Beta: Utgarde Pinnacle
    a[18601] = b:New(18601); -- Defense Protocol Beta: The Culling of Stratholme
    a[18614] = b:New(18614, fac.Alliance); -- Defense Protocol Beta: Terminated
    a[18677] = b:New(18677, fac.Alliance); -- Defense Protocol Beta: Trial of the Champion
    a[18678] = b:New(18678, fac.Horde); -- Defense Protocol Beta: Trial of the Champion
