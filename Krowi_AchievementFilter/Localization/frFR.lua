...
L["Assault on Stormheim"] = "Tornheim";
L["Assault on Val'sharah"] = "Val'sharah";
L["Assault on Tiragarde Sound"] = "Rade de Tiragarde";
L["Assault on Drustvar"] = "Drustvar";
L["Assault on Stormsong Valley"] = "Vallée Chantorage";
L["Assault on Nazmir"] = "Nazmir";
L["Assault on Vol'dun"] = "Vol'dun";
L["Assault on Zuldazar"] = "Zuldazar";
L["Necrolord Assault"] = "Nécro-seigneurs";
L["Venthyr Assault"] = "Venthyrs";
L["Kyrian Assault"] = "Kyrians";
L["Night Fae Assault"] = "Faë nocturnes";
L["Not earned by:"] = "Non obtenu par:";
L["Part of a chain"] = "Chaîne";
