--[[
	...
	Version: 7.7.6093 (SwimmingSeadragon)
	Revision: $Id: SlideMain.lua 6093 2018-08-29 01:26:34Z none $
...
LibStub("LibRevision"):Set("$URL: SlideBar/SlideMain.lua $","$Rev: 6093 $","6.0.DEV.", 'auctioneer', 'libs')
