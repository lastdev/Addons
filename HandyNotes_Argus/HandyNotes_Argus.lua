...
nodes["ArgusCore"] = {
	...
	[63902090] = { questId=48809, icon="skull_grey", group="rare_aw", label="Puscilla", search="puscilla", loot={ { 152903, itemTypeMount, 981 } }, note="Entrance to the cave is south east - use the eastern bridge to get there." },
	[53103580] = { questId=48810, icon="skull_grey", group="rare_aw", label="Vrax'thul", search="vrax", loot={ { 152903, itemTypeMount, 981 } }, note=nil },
	...
	[64304820] = { questId=48812, icon="skull_grey", group="rare_aw", label="Varga", search="varga", loot={ { 153190, itemTypeMisc } }, note=nil },
	[62405380] = { questId=48813, icon="skull_grey", group="rare_aw", label="Lieutenant Xakaar", search="xakaar", loot=nil, note=nil },
	[61906430] = { questId=48814, icon="skull_grey", group="rare_aw", label="Wrath-Lord Yarez", search="yarez", loot={ { 153126, itemTypeToy } }, note=nil },
	...
	[73207080] = { questId=48817, icon="skull_grey", group="rare_aw", label="Admiral Rel'var", search="rel", loot={ { 153324, itemTypeTransmog, "Shield" } }, note=nil },
	[75605650] = { questId=48818, icon="skull_grey", group="rare_aw", label="All-Seer Xanarian", search="xana", loot=nil, note=nil },
	[50905530] = { questId=48820, icon="skull_grey", group="rare_aw", label="Worldsplitter Skuul", search="skuul", loot={ { 153312, itemTypeTransmog, "2h Sword" } }, note="May be flying around in circles. Will be near ground sometimes. Not on every round though." },
	[63812199] = { questId=48821, icon="skull_grey", group="rare_aw", label="Houndmaster Kerrax", search="kerrax", loot={ { 152790, itemTypeMount, 955 } }, note=nil },
	[55702190] = { questId=48824, icon="skull_grey", group="rare_aw", label="Void Warden Valsuran", search="valsuran", loot={ { 153319, itemTypeTransmog, "2h Mace" } }, note=nil },
	[61392095] = { questId=48865, icon="skull_grey", group="rare_aw", label="Chief Alchemist Munculus", search="munculus", loot=nil, note=nil },
	[54003800] = { questId=48966, icon="skull_grey", group="rare_aw", label="The Many-Faced Devourer", search="face", loot={ { 153195, itemTypePet, 2136 } }, note=nil },
	...
	[84368118] = { questId=48967, icon="skull_grey", group="rare_aw", label="Squadron Commander Vishax", search="vishax", loot={ { 153253, itemTypeToy } }, note="Use portal at 77.2, 73.2 to get up on the ship" },
	[58001200] = { questId=48968, icon="skull_grey", group="rare_aw", label="Doomcaster Suprax", search="suprax", loot={ { 153194, itemTypeToy } }, note=nil },
	[66981777] = { questId=48970, icon="skull_grey", group="rare_aw", label="Mother Rosula", search="rosula", loot={ { 152903, itemTypeMount, 981 }, { 153252, itemTypePet, 2135 } }, note="Inside cave. Use the eastern bridge. Collect 100 Imp Meat which drop from the imps inside the cave. Use it and place the Disgusting Feast into the green soup at the marked spot." },
	[64948290] = { questId=48971, icon="skull_grey", group="rare_aw", label="Rezira the Seer", search="rezira", loot={ { 153293, itemTypeToy } }, note="Use Observer's Locus Resonator to open a portal to him. Orix the All-Seer (60.2, 45.4) sells it for 500 Intact Demon Eyes." },
	[61703720] = { questId=49183, icon="skull_grey", group="rare_aw", label="Blistermaw", search="blister", loot={ { 152905, itemTypeMount, 979 } }, note=nil },
	[57403290] = { questId=49240, icon="skull_grey", group="rare_aw", label="Mistress Il'thendra", search="thendra", loot={ { 153327, itemTypeTransmog, "Dagger" } }, note=nil },
	...
	[58765894] = { questId=49017, icon="starChestBlue", group="sfll_aw", label="Forgotten Legion Supplies", loot=nil, note="Rocks block the way. Use Lightforged Warframe Jump to crush the boulders." },
	[65973977] = { questId=49018, icon="starChestYellow", group="sfll_aw", label="Ancient Legion War Cache", loot={ { 153308, itemTypeTransmog, "1h Mace" } }, note="Carefully jump down to reach the little cave. Gilder helps a lot. Remove rocks with Lights's Judgment." },
	[52192708] = { questId=49019, icon="starChestYellow", group="sfll_aw", label="Fel-Bound Chest", loot=nil, note="Start a little south east, at 53.7, 30.9. Jump over the rocks to reach the cave. Rocks block the way into the cave. Remove them with Lights's Judgment." },
	[75595267] = { questId=49021, icon="starChestBlank", group="sfll_aw", label="Timeworn Fel Chest", loot=nil, note="Start at All-Seer Xanarian. Run past his building on the left side. Hop down a few rocks to reach the chest surrounded by green ooze." },

}

-- Krokuun
nodes["ArgusSurface"] = {
	[44390734] = { questId=48561, icon="skull_grey", group="rare_kr", label="Khazaduum", search="khaz", loot={ { 153316, itemTypeTransmog, "2h Sword" } }, note="Entrance is south east at 50.3, 17.3" },
	[33007600] = { questId=48562, icon="skull_grey", group="rare_kr", label="Commander Sathrenael", search="sathr", loot=nil, note=nil },
	[44505870] = { questId=48564, icon="skull_grey", group="rare_kr", label="Commander Endaxis", search="endax", loot={ { 153255, itemTypeTransmog, "1h Mace" } }, note=nil },
	[53403090] = { questId=48565, icon="skull_grey", group="rare_kr", label="Sister Subversia", search="subv", loot={ { 153124, itemTypeToy } }, note=nil },
	[58007480] = { questId=48627, icon="skull_grey", group="rare_kr", label="Siegemaster Voraan", search="vora", loot=nil, note=nil },
	[54688126] = { questId=48628, icon="skull_grey", group="rare_kr", label="Talestra the Vile", search="talestra", loot={ { 153329, itemTypeTransmog, "Dagger" } }, note=nil },
	[38145920] = { questId=48563, icon="skull_grey", group="rare_kr", label="Commander Vecaya", search="vecaya", loot={ { 153299, itemTypeTransmog, "1h Sword" } }, note="The path up to her starts east at 42, 57.1" },
	[60802080] = { questId=48629, icon="skull_grey", group="rare_kr", label="Vagath the Betrayed", search="vagat", loot=nil, note=nil },
	[69605750] = { questId=48664, icon="skull_grey", group="rare_kr", label="Tereck the Selector", search="tere", loot={ { 153263, itemTypeTransmog, "1h Axe" } }, note=nil },
	...
	[70503370] = { questId=48667, icon="skull_grey", group="rare_kr", label="Naroua", search="naroua", loot={ { 153190, itemTypeMisc } }, note=nil },
	...
	-- Shoot First, Loot Later
	[51407622] = { questId=48884, icon="starChestBlue", group="sfll_kr", label="Krokul Emergency Cache", loot={ { 153304, itemTypeTransmog, "1h Axe" } }, note="Cave is up on the cliffs. Rocks block the way. Use Lightforged Warframe's jump ability to shatter the rocks." },
	[62783753] = { questId=48885, icon="starChestYellow", group="sfll_kr", label="Legion Tower Chest", loot=nil, note="On the path to Naroua there are boulders blocking the way to this chest. Remove them with Light's Judgement." },
	[48555894] = { questId=48886, icon="starChestYellow", group="sfll_kr", label="Lost Krokul Chest", loot=nil, note="In little cave along the path. Use Light's Judgment to remove the boulders." },
	[75176975] = { questId=49154, icon="starChestPurple", group="sfll_kr", label="Long-Lost Augari Treasure", loot=nil, note="Use Shroud of Arcane Echoes and then open the chest" },
	[55937428] = { questId=49156, icon="starChestPurple", group="sfll_kr", label="Precious Augari Keepsakes", loot=nil, note="Use Shroud of Arcane Echoes and then open the chest" },
}
...
-- Mac'Aree
nodes["ArgusMacAree"] = {
	[52976684] = { questId=48693, icon="skull_grey", group="rare_ma", label="Soultwisted Monstrosity", search="monstro", loot=nil, note=nil },
	[55536016] = { questId=48695, icon="skull_grey", group="rare_ma", label="Wrangler Kravos", search="kravos", loot=nil, note=nil },
	[63806460] = { questId=48704, icon="skull_grey", group="rare_ma", label="Vigilant Kuro", search="kuro", loot=nil, note=nil },
	[38226435] = { questId=48706, icon="skull_grey", group="rare_ma", label="Turek the Lucid", search="turek", loot=nil, note="Down the stairs into the building" },
	[27192995] = { questId=48707, icon="skull_grey", group="rare_ma", label="Captain Faruq", search="faruq", loot=nil, note=nil },
	[35965897] = { questId=48711, icon="skull_grey", group="rare_ma", label="Herald of Chaos", search="herald", loot=nil, note="He's on the 2nd floor." },
	[44204980] = { questId=48712, icon="skull_grey", group="rare_ma", label="Sabuul", search="sabu", loot=nil, note=nil },
	[48504090] = { questId=48713, icon="skull_grey", group="rare_ma", label="Jed'hin Champion Vorusk", search="vorusk", loot={ { 153302, itemTypeTransmog, "1h Sword" } }, note=nil },
	[58003090] = { questId=48716, icon="skull_grey", group="rare_ma", label="Overseer Y'Sorna", search="sorna", loot=nil, note=nil },
	[60982982] = { questId=48717, icon="skull_grey", group="rare_ma", label="Overseer Y'Morna", search="morna", loot={ { 153257, itemTypeTransmog, "1h Mace" } }, note=nil },
	[66742845] = { questId=48719, icon="skull_grey", group="rare_ma", label="Zul'tan the Numerous", search="zul", loot=nil, note="Inside building" },
	[56801450] = { questId=48720, icon="skull_grey", group="rare_ma", label="Commander Xethgar", search="xethgar", loot=nil, note=nil },
	[49870953] = { questId=48721, icon="skull_grey", group="rare_ma", label="Skreeg the Devourer", search="skre", loot=nil, note=nil },
	[43846065] = { questId=48700, icon="skull_grey", group="rare_ma", label="Baruut the Bloodthirsty", search="baru", loot={ { 153193, itemTypeToy } }, note=nil },
	[36302360] = { questId=0, icon="skull_grey", group="rare_ma", label="Vigilant Thanos", search="thanos", loot=nil, note=nil },
	[33704750] = { questId=0, icon="skull_grey", group="rare_ma", label="Venomtail Skyfin", search="venom", loot=nil, note=nil },
	[30304040] = { questId=0, icon="skull_grey", group="rare_ma", label="Ataxon", search="ataxon", loot=nil, note=nil },
	[61405020] = { questId=0, icon="skull_grey", group="rare_ma", label="Instructor Tarahna", search="tarahna", loot=nil, note=nil },
	[49505280] = { questId=0, icon="skull_grey", group="rare_ma", label="Slithon the Last", search="slithon", loot=nil, note=nil },
	[44607160] = { questId=0, icon="skull_grey", group="rare_ma", label="Shadowcaster Voruun", search="voruun", loot=nil, note=nil },
	[38705580] = { questId=0, icon="skull_grey", group="rare_ma", label="Kaara the Pale", search="kaara", loot=nil, note=nil },
	[41301160] = { questId=0, icon="skull_grey", group="rare_ma", label="Feasel the Muffin Thief", search="feasel", loot=nil, note=nil },
	[35203720] = { questId=0, icon="skull_grey", group="rare_ma", label="Umbraliss", search="umbra", loot=nil, note=nil },
	[70404670] = { questId=0, icon="skull_grey", group="rare_ma", label="Sorolis the Ill-Fated", search="sorolis", loot=nil, note=nil },
	[59203770] = { questId=0, icon="skull_grey", group="rare_ma", label="Overseer Y'Beda", search="beda", loot=nil, note=nil },
	...
	-- Shoot First, Loot Later
	[57047684] = { questId=48749, icon="starChestBlank", group="sfll_ma", label="Desperate Eredar's Cache", loot={ { 153267, itemTypeTransmog, "1h Axe" } }, note="Start at 57.1, 74.3 and jump up around that tower to the back side." },
	[40275146] = { questId=48747, icon="starChestBlue", group="sfll_ma", label="Void-Tinged Chest", loot=nil, note="In underground area. Use Lightforged Warframe's jump to remove the blocking boulders." },
	[62132247] = { questId=49151, icon="starChestPurple", group="sfll_ma", label="Secret Augari Chest", loot=nil, note="Use Shroud of Arcane Echoes and then open the chest" },
}
