...
A [HandyNotes](https://www.curseforge.com/wow/addons/handynotes) plugin to show the Battle for Azeroth treasure items on your map. (That means it **requires** [HandyNotes](https://www.curseforge.com/wow/addons/handynotes), so go install it as well.)
