...
HEALBOT_OPTIONS_SKINBARS      = "样式条皮肤设置"
...
HEALBOT_OPTIONS_HEAL_BUTTONS  = "治疗样式条";
...
HEALBOT_OPTIONS_HEADEROPTTEXT  = "标题设置";
...
HEALBOT_OPTION_AGGROPCTBAR              = "高亮血条"
...
HEALBOT_SKIN_HEALTHBARCOL_TEXT          = "血条颜色";
...
HEALBOT_ABOUT_DESC1                    = "一个可定制的治疗、驱散、Buff、变形载具、仇恨面板的插件."
...
HEALBOT_PLAYER_OF_REALM                  = "的"
    ...
    HEALBOT_OPTIONS_LANG_TWTW               = "Taiwanese (twTW - 需要翻译)"
