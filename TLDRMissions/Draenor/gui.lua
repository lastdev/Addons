...
function addon.WODGUIMixin:Init()
    ...
    self:setupRewardCheckbox("Apexis", C_CurrencyInfo.GetBasicCurrencyInfo(823).name)
    self:setupRewardCheckbox("Oil", C_CurrencyInfo.GetBasicCurrencyInfo(1101).name)
    self:setupRewardCheckbox("Seal", C_CurrencyInfo.GetBasicCurrencyInfo(994).name)
