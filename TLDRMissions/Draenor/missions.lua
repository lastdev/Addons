...
function addon:GetAllWODMissionsMatchingFilter(rewardFilter, hard)
    ...
    for _, mission in pairs(missions) do
        ...
        for _, reward in pairs(rewards) do
            ...
            if (rewardFilter == "garrison-resources") and reward.currencyID and (reward.currencyID == 824) then
                include = true
            end
...
function addon:GetWODGoldMissions(hard)
    return addon:GetAllMissionsMatchingFilter("gold", hard)
end

function addon:GetWODFollowerXPMissions(hard)
    return addon:GetAllMissionsMatchingFilter("followerxp", hard)
end

function addon:GetWODFollowerXPItemMissions(hard)
...
function addon:GetWODGarrisonResourcesMissions(hard)
    return addon:GetAllWODMissionsMatchingFilter("garrison-resources", hard)
end

function addon:GetWODPetCharmMissions(hard)
    return addon:GetAllMissionsMatchingFilter("pet-charms", hard)
end

function addon:GetWODAugmentRuneMissions(hard)
    return addon:GetAllMissionsMatchingFilter("augment-runes", hard)
end

function addon:GetWODReputationMissions(hard)
    local missions = C_Garrison.GetAvailableMissions(123)
    local missionLineup = {}
...
function addon:GetWODCraftingCacheMissions(hard)
    local missions = C_Garrison.GetAvailableMissions(123)
    local missionLineup = {}
...
function addon:GetWODRunecarverMissions(hard)
    local missions = C_Garrison.GetAvailableMissions(123)
    local missionLineup = {}
...
function addon:GetWODCampaignMissions(hard)
    local missions = C_Garrison.GetAvailableMissions(123)
    local missionLineup = {}
...
function addon:GetWODGearMissions(hard)
    local missions = C_Garrison.GetAvailableMissions(123)
    local missionLineup = {}
...
function addon:GetWODSanctumFeatureMissions(hard)
    local missions = C_Garrison.GetAvailableMissions(123)
    local missionLineup = {}
