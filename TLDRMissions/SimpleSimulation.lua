...
-- Simulations for WOD Legion and BFA tables

function addon.BaseGUIMixin:GetMissionSuccessChance(leftFollowerID, middleFollowerID, rightFollowerID, missionID)
