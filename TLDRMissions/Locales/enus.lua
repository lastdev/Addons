...
L["FollowerXPSpecialTreatment"] = "Underlevelled followers only (see tooltip)"
L["FollowerXPSpecialTreatmentTooltip"] = "Missions that award Bonus Follower XP, and missions caught with the 'anything else' option will try to fill with only followers below level 60. Select the minimum number of followers in the Drop Down."
...
L["AnythingForXPLabel"] = "Then, any missions not excluded."
...
L["BlockCompletionErrorBagsFull"] = "TLDRMissions: Anima missions will not be completed - your bags are full!"
...
L["BlockCompletionOption4Label"] = "Bags are full"
L["IgnoreDeadFollowers"] = "Skip over followers with zero HP"
L["HelpButtonTooltipNoQuest"] = "You have not collected your Anima quest yet!"
...
L["SendLethalDesc"] = "Send 'Lethal' missions first (these will kill your troops)"
L["ResourcePriceLimit"] = "Resource Price Limit"
L["MinimumTroopsDesc"] = "Set minimum troops to 3 for 'use as many as possible'."
L["CompleteMissionsAlert"] = "Finish Completed Missions"