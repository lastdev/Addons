...
L["HelpButtonTooltipNoQuest"] = "Вы ещё не взяли ваш квест на аниму!"
L["HelpButtonTooltipQuestPendingTurnin"] = "Ваш квест на аниму ожидает сдачи!"
L["HelpButtonTooltipQuestAlreadyFinished"] = "Ваш квест на аниму уже завершён на этой неделе."
L["SkipFullResources"] = "Пропустить при завершении если ресурсы полны"
L["AlertsDesc"] = "Настройка воспроизведения звуков после завершения подсчёта"
L["FileID"] = "ID файла"
L["AlertsFlashTaskbarDesc"] = "Также мигать на панели задач"
L["MissionsSentPartialAlert"] = "Некоторые задания отправлены"
L["ZeroHPAlertsDesc"] = "Мёртвые спутники пропущены"
L["NotEnoughAnimaAlert"] = "Не хватает анимы"
L["MissionsSentNoneAlert"] = "Задания не отправлены"
L["CompleteMissionBlockedAlert"] = "Завершённые задания блокированы\n(Не взят квест на аниму)"
L["SendLethalDesc"] = "Отправить сначала 'смертельные' задания (это убъёт ваши отряды)"
L["ResourcePriceLimit"] = " Ограничение стоимости ресурсов"
L["MinimumTroopsDesc"] = "Установить минимум отрядов в 3 для 'используйте как можно больше'"
L["CompleteMissionsAlert"] = "Задания завершены"