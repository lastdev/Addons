...
function HealBot_Lang_enALL()
    ...
    HEALBOT_OPTIONS_ACTIONICONSGENOPTTEXT2 ="Each character can have different action icon settings per skin.";
    ...
    HEALBOT_OPTIONS_DISABLEHEALBOTSPEC     ="Disable on spec "
