...
function HealBot_Lang_enALL()
    ...
    HEALBOT_PLUGIN_BUFFWATCHBUFFSHOWN       = " exists"
    HEALBOT_PLUGIN_BUFFWATCHBUFFEXPIRE      = " exists and wait on expire"
    HEALBOT_PLUGIN_BUFFWATCHBUFFNOTEXIST    = " does not exist"
    HEALBOT_PLUGIN_AURAWATCHBUFFEXISTS      = "buff exists"
    HEALBOT_PLUGIN_AURAWATCHBUFFEXPIRE      = "buff exists and wait on expire"
