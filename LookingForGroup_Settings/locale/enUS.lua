...
L["cr_realm_scan_desc"] = [=[Scanning your current realm. The right-click minimap icon would also do this.
...
L["Relist"] = true
L["sf_add_desc"] = "Add your filter keywords here. This filter can only be used to filter the chat channel. Due to 8.0 Blizzard's API restrictions, this filter does not filter the LFG group's title, comment and voice chat, but the leader name."
L["sf_dk_desc"] = "Spammers always use a lot of level 55 Death Knights to create LFG groups. This toggle is extremely effective and kills over 80% of LFG spamming in the Chinese Region."
...
L["sf_solo"] = "Spammers always create LFG groups with only one character to advertise. This toggle will remove all groups in LFG with only one character."
L["sf_whisper_desc"] = "A lot of AddOns (like WQGF, WQA) keep spamming in chat to advertise themselves. Also, a lot of Chinese use AddOns packages which keep spamming pages and pages long of spamming messages. Enabling this toggle will fight against these AddOns by notifying spammers to shut down them down."
L["solo_hint"] = "Please input something into the %s edit box before you click %s button."
L["Taskbar Flash"] = true
L["warning_not_working"] = "Warning! Enabling will make LFG not working correctly."
