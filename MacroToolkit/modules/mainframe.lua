...
function MT:CreateMTFrame()
	local mtframe = CreateFrame("Frame", "MacroToolkitFrame", UIParent, "ButtonFrameTemplate,BackdropTemplate")
	...
	local mtselbutton = CreateFrame("CheckButton", "MacroToolkitSelMacroButton", mtframe, "MacroToolkitButtonTemplate,BackdropTemplate")
	mtselbutton:SetID(0)
	mtselbutton:SetFrameStrata("MEDIUM")
	...
	local mttextbg = CreateFrame("Frame", "MacroToolkitTextBg", mtframe, "BackdropTemplate")
	...
	mteditbutton:SetFrameStrata("MEDIUM")
	...
	mterrorbg = CreateFrame("Frame", "MacroToolkitErrorBg", mtframe, "BackdropTemplate")
	...
	mtcancelbutton:SetFrameStrata("MEDIUM")
	...
	mtsavebutton:SetFrameStrata("MEDIUM")
	...
	mtshorten:SetFrameStrata("MEDIUM")
