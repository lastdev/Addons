-------------------------------------------------------------------------------
-- Tidy Plates: Roth 1.0.1 - 7.1 - Nov/18/2016.
-------------------------------------------------------------------------------

local path = "Interface\\Addons\\TidyPlates_Roth\\Media\\"
local fontroboto = "Interface\\Addons\\TidyPlatesHub\\shared\\RobotoCondensed-Bold.ttf"
