...
ns.RegisterPoints(830, { -- Krokuun
    ...
    [48603090] = {quest=47999, label=EREDAR_SUPPLIES},
    ...
    [53157308] = {quest=47997, label=EREDAR_SUPPLIES, vignette=2001},
}, {
    group="junk",
})
...
ns.RegisterPoints(830, { -- Krokuun
    ...
    [60802080] = {quest=48629, npc=125388, criteria=37652, loot={153114}, worldquest=48091}, -- Vagath the Betrayed
