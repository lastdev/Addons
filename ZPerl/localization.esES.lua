...
if (GetLocale() == "esES" or GetLocale() == "esMX") then
	...
	BINDING_NAME_ZPERL_TOGGLERAIDSORT = "Mostrar orden de banda por Clase/Grupo"
	BINDING_NAME_ZPERL_TOGGLERAIDPETS = "Alternar Mascotas de Banda"
	BINDING_NAME_ZPERL_TOGGLEOPTIONS = "Mostrar ventana de opciones"
	BINDING_NAME_ZPERL_TOGGLEBUFFTYPE = "Mostrar Ventajas/Desventajas/Nada"
	BINDING_NAME_ZPERL_TOGGLEBUFFCASTABLE = "Mostrar Disponibles/Curables"
	BINDING_NAME_ZPERL_TEAMSPEAKMONITOR = "Monitor de Teamspeak"
	BINDING_NAME_ZPERL_TOGGLERANGEFINDER = "Alternar Buscador Rango"
