--[[
	...
	Revision: $Id: BeanCounterTidyUp.lua 6236 2019-03-04 00:20:18Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterTidyUp.lua $","$Rev: 6236 $","5.1.DEV.", 'auctioneer', 'libs')
