--[[
	...
	Revision: $Id: BeanCounterMail.lua 5304 2012-07-05 14:16:55Z brykrys $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/BeanCounterMail.lua $","$Rev: 5304 $","5.1.DEV.", 'auctioneer', 'libs')
