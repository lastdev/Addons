--[[
	...
	Revision: $Id: BeanCounterLocale.lua 6110 2018-08-29 01:26:34Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterLocale.lua $","$Rev: 6110 $","5.1.DEV.", 'auctioneer', 'libs')
