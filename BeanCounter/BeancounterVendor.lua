--[[
	...
	Revision: $Id: BeancounterVendor.lua 6236 2019-03-04 00:20:18Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeancounterVendor.lua $","$Rev: 6236 $","5.1.DEV.", 'auctioneer', 'libs')
