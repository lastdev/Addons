...
https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU]=] ] = "|cFFFF0000필터가 없는 COMBAT_LOG_EVENT_UNFILTERED에 대한 지원이 중단되었습니다.|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED는 성능 소모가 극심하여 사용을 자제하는 것이 좋습니다. 자세한 정보 알아보기: https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU"
...
L["Absorbed"] = "흡수함"
L["Action Button Glow"] = "행동 버튼 반짝임"
L["Actions"] = "동작"
L["Active"] = "활성화"
...
L["Ignore Spell Override"] = "상위 주문 교체 무시"
L["Immune"] = "면역"
L["Important"] = "중요"
...
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=] ] = [=[보호중인 프레임을 감지했습니다. 자세한 정보:
https://github.com/WeakAuras/WeakAuras2/wiki/Protected-Frames]=]
...
L["The total quantity a warband character can transfer after paying the transfer cost"] = "이전 비용 지불 후 전투부대 캐릭터가 이전할 수 있는 총 수량"
L["The total quantity after transferring everything to your current character and paying the transfer cost"] = "모든 수량을 현재 캐릭터로 이전하고 이전 비용을 지불한 후 총 수량"
...
L["Warband Transferred Quantity"] = "전투부대 이전 수량"
...
L["Warning: Anchoring in aura '%s' is imposssible, due to an anchoring cycle"] = "경고: 고정 주기로 인해 '%s' 위크오라에 고정이 불가능합니다."
