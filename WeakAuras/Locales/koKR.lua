...
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000필터를 적용하지 않은 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 더이상 사용할 수 없습니다|r 필터가 없는 COMBAT_LOG_EVENT_UNFILTERED 이벤트는 퍼포먼스 소모가 극심해서 사용을 자제할 것을 권장합니다. 자세한 정보: https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events"
