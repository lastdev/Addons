...
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=] ] = "|cFFFF0000El soporte para COMBAT_LOG_EVENT_UNFILTERED sin filtrar está obsoleto.|r Se desaconseja el uso de COMBAT_LOG_EVENT_UNFILTERED sin un filtro, ya que es muy costoso en términos de rendimiento. Encuentra más información en: https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events"
