...
L["Emote"] = "表情動作"
L["Empty"] = "空"
L["Enables (incorrect) round down of seconds, which was the previous default behaviour."] = "啟用（不正確的）秒數捨入，這是以前的預設行為。"
...
L["This aura plays a sound via a condition."] = "這個光環通過條件播放聲音。"
L["This aura plays a sound via an action."] = "這個光環通過動作播放聲音。"
...
L["Y-Offset"] = "垂直位置"
L["Yogg-Saron"] = "尤格薩倫"
L["You have new auras ready to be installed!"] = "你新的光環準備好安裝了！"
