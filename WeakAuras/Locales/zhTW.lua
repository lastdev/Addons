...
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=] ] = [=[|cFFFF0000已捨棄支援未過濾的 COMBAT_LOG_EVENT_UNFILTERED|r 
不建議使用不含過濾器的 COMBAT_LOG_EVENT_UNFILTERED，因為它需要耗費非常高的效能。更多資訊請看 https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=]
