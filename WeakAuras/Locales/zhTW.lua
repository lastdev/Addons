...
https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU]=] ] = "|cFFFF0000支援未過濾的COMBAT_LOG_EVENT_UNFILTERED已被棄用|r COMBAT_LOG_EVENT_UNFILTERED建議不要不使用過濾器，因為它的性能成本非常高。尋找更多資訊：https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU"
...
L["Combat Log"] = "戰鬥紀錄"
L["Communities"] = "社群"
L["Condition Custom Test"] = "條件自定義測試"
L["Conditions"] = "條件"
L["Contains"] = "包含"
