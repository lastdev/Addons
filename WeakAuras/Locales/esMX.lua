...
https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU]=] ] = "|cFFFF0000El soporte para COMBAT_LOG_EVENT_UNFILTERED sin filtrar está en desuso|r. Se desaconseja el uso de COMBAT_LOG_EVENT_UNFILTERED sin un filtro, ya que tiene un alto costo de rendimiento. Encuentra más información aquí: https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU"
