...
https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU]=] ] = "|cFFFF0000未过滤的 COMBAT_LOG_EVENT_UNFILTERED 支持已被弃用|r 不建议使用不带过滤器的 COMBAT_LOG_EVENT_UNFILTERED，因为这会严重影响性能。更多信息：https://github.com/WeakAuras/WeakAuras2/wiki/Deprecated-CLEU"
