...
https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=] ] = [=[|cFFFF0000对未过滤的 COMBAT_LOG_EVENT_UNFILTERED 的支持已弃用|r 
不建议使用不含过滤器的 COMBAT_LOG_EVENT_UNFILTERED，因为它会严重影响性能。查看更多信息：https://github.com/WeakAuras/WeakAuras2/wiki/Custom-Triggers#events]=]
