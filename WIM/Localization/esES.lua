...
local translations = {
    ...
    ["Block"] = "Bloquear",
    ["Filtering"] = "Filtro",
    ["Filtering allows you to control which messages are handled as well as how they are handled by WIM."] = "El filtro le permite controlar qué mensajes se manejan y cómo WIM los maneja.",
