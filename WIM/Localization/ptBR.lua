...
WIM.AddLocale("ptBR", {
    ...
    ["History Viewer"] = "Visualizador de histórico",
    ["Filters"] = "Filtros",
    ...
    ["Color: BNet Messages Received"] = "Color:mMensagens de BNet recibidas",
    ["Use colors suggested by skin."] = "Usar cores sugerido pelo tema.",
    ...
    ["Enable Filtering"] = "Ativar filtrar",
    ["Protected"] = "Protegido",
    ["Action:"] = "Ação:",
    ...
    ["Messages"] = "Mensagens",
    ["Preview history inside message windows."] = "Pre-visualizar histórico dentro das janelas de mensagem",
    ...
    ["Allowing your history logs to grow too large will affect the game's performance, therefore it is reccomended that you use the following options."] = "Permitir que o registro da histórico ao crescer e fiquei muito grande afetará o desempenho do jogo, portanto o recomendável que você use as seguintes opções.",
