...
WIM.AddLocale("frFR", {
  ...
  -- Class Names --
    ...
    ["Manipulate how WIM displays messages."] = "Manipuler la façon dont WIM affiche les messages.",
    ["Preview"] = "Aperçu",
    ...
    ["Auto focus a window when it is shown."] = "Mettre automatiquement le focus sur une fenêtre lorsqu'elle est affichée",
    ...
    ["Unlock from Minimap"] = "Déverrouiller la minicarte",
