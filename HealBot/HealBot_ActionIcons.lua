...
function HealBot_ActionIcons_CombatState()
    -- Future
end

function HealBot_ActionIcons_SoloState()
    -- Future
end

function HealBot_ActionIcons_ConditionChange()
    -- Future
end

function HealBot_ActionIcons_InstanceState()
    -- Future
end

function HealBot_ActionIcons_UpdateNumIcons(frame)
    -- Future
end
