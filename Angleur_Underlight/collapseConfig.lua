...
function AngleurUnderlight_CollapseConfig_OnLoad(self)
    ...
    self.popup.checkboxes.checkbox1.tooltip = T["While " .. colorBlu:WrapTextInColorCode("Angleur ") .. "is " .. colorGrae:WrapTextInColorCode("Sleeping")
    ...
    self.popup.checkboxes.checkbox2.tooltip = T["Keeps the fish form active while submerged inside " .. colorDarkBlu:WrapTextInColorCode("Underwater Delves,") 
