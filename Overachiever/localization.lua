...
L["ACH_CONSUME_91_COMPLETE"] = "Gourmandise déjà prouvée" -- Needs review
L["ACH_CONSUME_91_INCOMPLETE"] = "Je te mets au défi d'en manger 91 d'un coup !" -- Needs review
...
L["CRITTER"] = "Bestiole" -- Needs review
...
L["OPT_LABEL_ACHFOUR"] = "\"%s,\" \"%s,\"|n\"%s,\" \"%s\"" -- Needs review
...
L["SOUND_YAR"] = "Yarrrr"
L["WILDPET"] = "Pet sauvage" -- Needs review
...
L["ACH_CONSUME_91_COMPLETE"] = "Обжорство доказано" -- Needs review
-- L["ACH_CONSUME_91_INCOMPLETE"] = ""
...
L["ACH_FISTFULOFLOVE_INCOMPLETE"] = "Нужно использовать горсть розовых лепестков"
L["ACH_LETITSNOW_COMPLETE"] = "Горсть снежинок уже использовалась"
L["ACH_LETITSNOW_INCOMPLETE"] = "Нужно использовать горсть снежинок"
...
L["SOUND_YAR"] = "Ярррр"
L["WILDPET"] = "Дикий питомец" -- Needs review
...
L["OPT_SATISFIEDTIPS_TIP"] = "Adiciona uma linha na às dicas de tela dos itens que são parte dos critérios da conquista para indicar se você precisa consumí-los."
...
L["CRITTER"] = "Critter" -- Needs review
L["INCOMPLETE"] = "Incompleto"
L["KILL_COMPLETE"] = "Già ucciso"
L["KILL_INCOMPLETE"] = "Da uccidere"
L["MSG_ACHNOTFOUND"] = "Impresa non trovata." -- Needs review
L["MSG_INVALIDID"] = "Input non valido: non esiste un'impresa con quell'ID."
L["MSG_NAMENOTFOUND"] = "Nessuna impresa con nome contenente \"|cffffffff%s|r\" è stata trovata." -- Needs review
L["MSG_NUMFOUNDLIST"] = "%s altre imperse trovate:" -- Needs review
L["MSG_ONEFOUND"] = "1 altra impresa trovata:" -- Needs review
...
L["OPT_ANGLERTIPS_TIP"] = "Se l'impresa è incompleta, aggiungi una linea ai tooltip dei nodi di pesca che fanno parte del suo criterio per indicare se hai bisogno o meno di pescarli." -- Needs review
L["OPT_AUTOTRACKEXPLORE"] = "Autotraccia le imprese di esplorazione mentre viaggi" -- Needs review
L["OPT_AUTOTRACKEXPLORE_COMPLETED"] = "Includi imprese completate." -- Needs review
L["OPT_AUTOTRACKEXPLORE_TIP"] = "QUando entri in una zona, verrà tracciato automaticamente l'impresa di esplorazione associata. Non cambierà se stai tracciando qualcos'altro diverso da un'impresa di esplorazione." -- Needs review
...
L["OPT_CHECKYOURHEADTIPS_TIP"] = "Se l'impresa non è completata, aggiungi una riga nel tooltip del giocatore per indicare se è necessario utilizzare un lanterna poderata Jack-o'-su di loro." -- Needs review
...
L["OPT_LABEL_MAINUI"] = "Principali modifiche dell'interfaccia utente"
...
L["OPT_LETITSNOWTIPS_TIP"] = "Se l'impresa è incompleta, aggiungere una riga nel tooltip del giocatore con la combo razza/classe appropriata per indicare se è necessario utilizzare una manciata di fiocchi di neve su di loro." -- Needs review
