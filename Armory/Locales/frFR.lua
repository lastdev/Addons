...
L["ARMORY_CMD_SET_MAILCHECKVISIT_MENUTEXT"] = "Avertir des courriers non notifiés" -- Needs review
...
L["ARMORY_CMD_SET_SHOWCANLEARN_TOOLTIP"] = "Si activé les infobulles afficheront quels personnages peuvent apprendre la recette." -- Needs review
...
L["ARMORY_CMD_SET_SHOWEQCTOOLTIPS_TOOLTIP"] = "Si activé une infobulle de comparaison apparaît lorsque la touche Alt est maintenue enfoncée alors que l'infobulle d'un objet est affichée." -- Needs review
...
L["ARMORY_CMD_SET_SHOWHASSKILL_TOOLTIP"] = "Si activé les infobulles afficheront quels personnages seront capables d'apprendre la recette." -- Needs review
...
L["ARMORY_CMD_SET_USEENCODING_TOOLTIP"] = "Si activé, les données sont enregistrées dans un format codé utilisant moins de mémoire mais davantage le processeur pour l'enregistrement et la lecture." -- Needs review
