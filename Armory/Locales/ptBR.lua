...
local L = LibStub("AceLocale-3.0"):NewLocale("Armory", "ptBR");
if ( not L ) then 
    return;
end
...
L["ARMORY_RECIPE"] = "Receita" -- Needs review
...
L["ARMORY_TRADE_INSCRIPTION"] = "Inscrição" -- Needs review
...
L["ARMORY_TRANSMUTE"] = "Transmutar" -- Needs review
