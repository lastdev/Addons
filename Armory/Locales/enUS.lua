...
L["ARMORY_CMD_SET_SHOWEQCTOOLTIPS_TOOLTIP"] = "If enabled, comparison toolips will be shown when the Alt key is pressed while an equipment game tooltip is visible."
...
L["ARMORY_CMD_SET_USEENCODING_TOOLTIP"] = "If enabled, data will will stored in a binary encoded format taking up less memory but using more CPU for storage and retrieval."
