...
L["ARMORY_BANK_CONTAINER_NAME"] = "Banca" -- Needs review
...
L["ARMORY_CHECK_MAIL_DISABLED"] = "Il controllo degli oggetti in scadenza è disattivato." -- Needs review
L["ARMORY_CHECK_MAIL_MESSAGE"] = "La cassetta di posta di %1$s (%2$s) contiene l'oggetto '%3$s' che scadrà in %4$s!" -- Needs review
L["ARMORY_CHECK_MAIL_NONE"] = "Nessun oggetto prossimo alla scadenza trovato nella mailbox" -- Needs review
L["ARMORY_CHECK_MAIL_POPUP"] = "Ci sono oggetti della posta che stanno per scadere.Usa '/ar check' per maggiori dettagli" -- Needs review
...
L["ARMORY_CMD_CHECK_TEXT"] = "Controlla l'inventario degli oggetti nella cassetta postale per le scadenze" -- Needs review
L["ARMORY_CMD_CONFIG"] = "config" -- Requires localization
L["ARMORY_CMD_CONFIG_TEXT"] = "Apre il pannello di configurazione" -- Needs review
L["ARMORY_CMD_DELETE"] = "delete" -- Requires localization
L["ARMORY_CMD_DELETE_ALL"] = "all" -- Requires localization
L["ARMORY_CMD_DELETE_ALL_MSG"] = "Il database di Armory è stato cancellato" -- Needs review
...
L["ARMORY_CMD_DOWNLOAD_TEXT"] = "Scarica le ricette dai membri di gilda" -- Needs review
L["ARMORY_CMD_FIND"] = "find" -- Requires localization
L["ARMORY_CMD_FIND_ALL"] = "tutto" -- Needs review
L["ARMORY_CMD_FIND_FOUND"] = "Numero totale di occorrenze: %d" -- Needs review
...
L["ARMORY_CMD_FIND_ITEM"] = "Oggetto" -- Needs review
L["ARMORY_CMD_FIND_MENUTEXT"] = "Ricerca database" -- Needs review
L["ARMORY_CMD_FIND_NOT_FOUND"] = "Non trovato" -- Needs review
L["ARMORY_CMD_FIND_PARAMS_TEXT"] = "[namepart]" -- Needs review
L["ARMORY_CMD_FIND_QUEST"] = "Missione" -- Needs review
L["ARMORY_CMD_FIND_QUEST_REWARD"] = "Ricompensa missione" -- Needs review
...
L["ARMORY_GLYPH"] = "Glyph" -- Requires localization
...
L["ARMORY_RECIPE"] = "Recipe" -- Requires localization
...
L["ARMORY_SHORTDATE_FORMAT"] = "ARMORY_SHORTDATE_FORMAT" -- Requires localization
L["ARMORY_SLASH_ALTERNATIVES"] = "/ar" -- Requires localization
...
L["ARMORY_TRANSMUTE"] = "Transmute" -- Requires localization
