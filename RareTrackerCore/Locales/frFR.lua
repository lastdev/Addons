...
-- L["<%s> Resetting ordering"] = ""
-- L["<%s> Updating daily kill marks."] = ""
-- L["<%s> Your version of the %s addon is outdated. Please update to the most recent version at the earliest convenience."] = ""
