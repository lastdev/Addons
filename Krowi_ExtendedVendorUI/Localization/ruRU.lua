...
L["Wago"] = true
L["Wago Desc"] = "Открыть всплывающее окно с ссылкой на страницу {addonName} {wago}"
L["WoWInterface"] = true
L["WoWInterface Desc"] = "Открыть всплывающее окно с ссылкой на страницу {addonName} {woWInterface}"