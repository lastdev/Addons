...
if ns.locale == "deDE" then
	...
	L["Ship's Locker"] = "Schiffstruhea"
	L["Ghostly Pandaren Fisherman"] = "Geisterhafter Pandarenfischer"
	L["Ghostly Pandaren Craftsman"] = "Geisterhafter Pandarenhandwerker"
	L["Cache of Pilfered Goods"] = "Truhe mit geklauten Waren"
	L["Virmen Treasure Cache"] = "Schatztruhe der Shed-Ling"
...
elseif ns.locale == "esES" or ns.locale == "esMX" then
	...
	L["Ship's Locker"] = "Baúl del barco"
	L["Ghostly Pandaren Fisherman"] = "Pescador pandaren fantasmal"
	L["Ghostly Pandaren Craftsman"] = "Artesano pandaren fantasmal"
	L["Cache of Pilfered Goods"] = "Alijo de bienes trincados"
	L["Virmen Treasure Cache"] = "Alijo del tesoro mur"
...
elseif ns.locale == "frFR" then
	...
	L["Ship's Locker"] = "Placard de bateau"
	L["Ghostly Pandaren Fisherman"] = "Pêcheur pandaren fantomatique"
	L["Ghostly Pandaren Craftsman"] = "Artisan pandaren fantomatique"
	L["Cache of Pilfered Goods"] = "Cache de fournitures chapardées"
	L["Virmen Treasure Cache"] = "Cache au trésor virmène"
...
elseif ns.locale == "itIT" then
	...
	L["Ship's Locker"] = "Baule della Nave"
	L["Ghostly Pandaren Fisherman"] = "Pescatore Spettrale Pandaren"
	L["Ghostly Pandaren Craftsman"] = "Artigiano Spettrale Pandaren"
	L["Cache of Pilfered Goods"] = "Cassa di Beni Rubati"
	L["Virmen Treasure Cache"] = "Scrigno del Tesoro dei Leproratti"
...
elseif ns.locale == "koKR" then
	...
	L["Ship's Locker"] = "배의 보관함"
	L["Ghostly Pandaren Fisherman"] = "유령 판다렌 낚시꾼"
	L["Ghostly Pandaren Craftsman"] = "유령 판다렌 장인"
	L["Cache of Pilfered Goods"] = "도둑맞은 물품이 든 상자"
	L["Virmen Treasure Cache"] = "토깽 보물 상자"
...
elseif ns.locale == "ptBR" or ns.locale == "ptPT" then
	...
	L["Ship's Locker"] = "Armário do Navio"
	L["Ghostly Pandaren Fisherman"] = "Pescador Pandaren Fantasmagórico"
	L["Ghostly Pandaren Craftsman"] = "Artesão Pandaren Fantasmagórico"
	L["Cache of Pilfered Goods"] = "Baú de Mercadorias Pilhadas"
	L["Virmen Treasure Cache"] = "Baú do Tesouro Vermingue"
...
elseif ns.locale == "ruRU" then
	...
	L["Ship's Locker"] = "Корабельный сейф"
	L["Ghostly Pandaren Fisherman"] = "Призрачный пандарен-рыбак"
	L["Ghostly Pandaren Craftsman"] = "Призрачный пандарен-ремесленник"
	L["Cache of Pilfered Goods"] = "Груда украденных товаров"
	L["Virmen Treasure Cache"] = "Сундук с сокровищами гну-синей"
...
elseif ns.locale == "zhCN" then
	...
	L["Treasure"] = "我之蜜糖"
	L["Riches"] = "潘达利亚的财富"
	L["Ship's Locker"] = "船载储物箱"
	L["Ghostly Pandaren Fisherman"] = "幽灵熊猫人渔夫"
	L["Ghostly Pandaren Craftsman"] = "幽灵熊猫人工匠"
	L["Cache of Pilfered Goods"] = "箱被偷的货物"
	L["Virmen Treasure Cache"] = "兔妖宝箱"
...
elseif ns.locale == "zhTW" then
	...
	L["Treasure"] = "我之蜜糖"
	L["Riches"] = "潘達利亞的財富"
	L["Ship's Locker"] = "船載儲物箱"
	L["Ghostly Pandaren Fisherman"] = "幽靈熊貓人漁夫"
	L["Ghostly Pandaren Craftsman"] = "幽靈熊貓人工匠"
	L["Cache of Pilfered Goods"] = "箱被偷的貨物"
	L["Virmen Treasure Cache"] = "兔妖寶箱"
...
local function printPC( message )
	if message then
		DEFAULT_CHAT_FRAME:AddMessage( ns.colour.prefix .."EA Pandaria" ..": " ..ns.colour.plaintext
			..message.. "\124r" )
	end
end
...
function pluginHandler:OnEnter(mapFile, coord)
	...
	elseif not pin.aID then
		...
		if ( pin.aID == 8784 ) or ( pin.aID == 8724 ) then -- Timeless Legends & Pilgrimage
			for i = 1, 4 do
		...
		if pin.aQuest then
			...
			local itemName = pin.item and ( GetItemNameByID( pin.item ) or pin.item ) or " "
...
function pluginHandler:OnEnable()
	...
	HandyNotes:RegisterPluginDB("EA-Pandaria", pluginHandler, ns.options)
	ns.db = LibStub("AceDB-3.0"):New("HandyNotes_EAPandariaDB", defaults, "Default").profile
	pluginHandler:Refresh()
end

function pluginHandler:Refresh()
	self:SendMessage("HandyNotes_NotifyUpdate", "EA-Pandaria")
end
