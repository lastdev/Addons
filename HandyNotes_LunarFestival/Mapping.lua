...
ns.map.barrens = ( ns.version < 60000 ) and 1413 or 10 -- In Classic Cata it's called "The Barrens". Retail it's "Northern Barrens"
ns.map.bloodmyst = ( ns.version < 60000 ) and 1950 or 106
...
ns.map.alterac = ( ns.version < 60000 ) and 1416
ns.map.arathi = ( ns.version < 60000 ) and 1417 or 14
...
ns.map.deadwind = ( ns.version < 60000 ) and 1430 or 42
...
ns.map.ghostlands = ( ns.version < 60000 ) and 1942 or 95
...
ns.map.redridge = ( ns.version < 60000 ) and 1433 or 49
...
ns.map.TheHinter = ( ns.version < 60000 ) and 1425 or 26
...
ns.map.wetlands = ( ns.version < 60000 ) and 1437 or 56
...
ns.map.bladesEdge = ( ns.version < 60000 ) and 1949 or 105
ns.map.hellfire = ( ns.version < 60000 ) and 1944 or 100
ns.map.nagrand = ( ns.version < 60000 ) and 1951 or 107
ns.map.netherstorm = ( ns.version < 60000 ) and 1953 or 109
ns.map.shadowmoon = ( ns.version < 60000 ) and 1948 or 104
ns.map.shattrath = ( ns.version < 60000 ) and 1955 or 111
ns.map.terokkar = ( ns.version < 60000 ) and 1952 or 108
ns.map.zangarmarsh = ( ns.version < 60000 ) and 1946 or 102
ns.map.outland = ( ns.version < 60000 ) and 1945 or 101