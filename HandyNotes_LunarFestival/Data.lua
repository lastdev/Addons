...
ns.points = {}
ns.achievementIQ = {}
ns.addOnName = "LunarFestival" -- For internal use to name globals etc. Should never be localised
ns.eventName = "Lunar Festival" -- The player sees this in labels and titles. This gets localised
...
ns.points[ ns.map.ashenvale ] = { -- Ashenvale
	[35544891] = { elder=true, achievements={ { id=911, index=9, version=50000, }, 
					{ id=911, index=4, versionUnder=50000, }, },
...
ns.points[ ns.map.azshara ] = { -- Azshara
	[64737934] = { elder=true, achievements={ { id=911, index=2, version=50000, },
					{ id=911, index=8, versionUnder=50000, }, }, quests={ { id=8720, qType="Seasonal", }, }, },
...
ns.points[ ns.map.darkshore  ] = { -- Darkshore
	[49541895] = { elder=true, achievements={ { id=911, index=7, version=50000, },
					{ id=911, index=16, versionUnder=50000, }, }, quests={ { id=8721, qType="Seasonal", }, }, },
	[54827242] = { elder=true, noZidormi=true, achievements={ { id=911, index=12, version=50000, },
					{ id=911, index=1, versionUnder=50000, }, }, quests={ { id=8723, qType="Seasonal", }, }, },
...
ns.points[ ns.map.darnassus ] = { -- Darnassus
	[38583028] = { seasonalQuest=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[39203185] = { elderFaction=true, achievements={ { id=915, index=1, version=50000, },
					{ id=915, index=3, versionUnder=50000, }, }, quests={ { id=8718, qType="Seasonal", }, }, },
	[37325047] = { elderFaction=true, achievements={ { id=915, index=1, version=50000, },
					{ id=915, index=3, versionUnder=50000, }, },
					quests={ { id=8718, qType="Seasonal", faction="Horde", 
					tip="Immediately go left and up high - don't delay", }, }, },
	[30402709] = { elderFaction=true, achievements={ { id=915, index=1, version=50000, },
					{ id=915, index=3, versionUnder=50000, }, },
					quests={ { id=8718, qType="Seasonal", faction="Horde", 
...
ns.points[ ns.map.desolace ] = { -- Desolace
	[29626248] = { elderDungeon=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, tip=ns.taraezorPromo, }, },
	...
	[99184999] = { seasonalQuest=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[99614885] = { elderFaction=true, achievements={ { id=914, index=2, version=50000, },
					{ id=914, index=3, versionUnder=50000, }, }, quests={ { id=8678, qType="Seasonal", }, }, },
}

ns.points[ ns.map.durotar ] = { -- Durotar
	[53234361] = { elder=true, achievements={ { id=911, index=1, version=50000, },
					{ id=911, index=9, versionUnder=50000, }, },
	...
	[33357598] = { elder=true, achievements={ { id=911, index=5, version=50000, },
					{ id=911, index=7, versionUnder=50000, }, }, quests={ { id=8680, qType="Seasonal", }, }, },
	[11796435] = { elder=true, achievements={ { id=911, index=3, version=50000, },
					{ id=911, index=17, versionUnder=50000, }, }, quests={ { id=8717, qType="Seasonal", }, }, },
}

ns.points[ ns.map.dustwallow ] = { -- Dustwallow Marsh
	[28529858] = { elder=true, achievements={ { id=911, index=13, version=50000, },
					{ id=911, index=19, versionUnder=50000, }, }, quests={ { id=8682, qType="Seasonal", }, }, },
	[14330306] = { elder=true, achievements={ { id=911, index=4, version=50000, },
					{ id=911, index=21, versionUnder=50000, }, }, quests={ { id=8686, qType="Seasonal", }, }, },
}

ns.points[ ns.map.felwood ] = { -- Felwood
	[38365285] = { elder=true, achievements={ { id=911, index=12, version=50000, },
					{ id=911, index=1, versionUnder=50000, }, }, quests={ { id=8723, qType="Seasonal", }, }, },
	...
	[63676924] = { elder=true, achievements={ { id=6006, index=6, version=50000, },
					{ id=6006, index=6, versionUnder=50000, }, }, quests={ { id=29739, qType="Seasonal", }, }, },
	[88784176] = { elder=true, achievements={ { id=6006, index=7, version=50000, },
					{ id=6006, index=7, versionUnder=50000, }, }, quests={ { id=29740, qType="Seasonal", }, }, },
}

ns.points[ ns.map.feralas ] = { -- Feralas
	[76713790] = { elder=true, achievements={ { id=911, index=10, version=50000, },
					{ id=911, index=20, versionUnder=50000, }, },
					quests={ { id=8679, qType="Seasonal", tip="In the Lariss Pavillion", }, }, },
	[62563107] = { elder=true, achievements={ { id=911, index=11, version=50000, },
					{ id=911, index=15, versionUnder=50000, }, },
	...
	[53368345] = { elder=true, achievements={ { id=911, index=20, version=50000, },
					{ id=911, index=12, versionUnder=50000, }, },
					quests={ { id=8654, qType="Seasonal", }, }, },
	[66339639] = { elder=true, achievements={ { id=911, index=21, version=50000, },
					{ id=911, index=18, versionUnder=50000, }, },
					quests={ { id=8719, qType="Seasonal", }, }, },
}

ns.points[ 68 ] = { -- Maraudon - Foulspore Cavern
	[46788822] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, }, quests={ { id=8635, qType="Seasonal",
...
ns.points[ 67 ] = { -- Maraudon - The Wicked Grotto
	[19345583] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, },
					quests={ { id=8635, qType="Seasonal", tip="This is where you respawn if you were wondering", }, }, },
	[25004335] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, },
					quests={ { id=8635, qType="Seasonal", tip="Instance entrance/exit", }, }, },
	[17005350] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, }, quests={ { id=8635, qType="Seasonal",
...
ns.points[ 281 ] = { -- Maraudon - Zaelar's Grave
	[28083508] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, }, quests={ { id=8635, qType="Seasonal",
					tip="This is where you \"land\" upon entry to the instance. Go straight ahead, jumping down and through the "
						.."cutting", }, }, },
	[33006070] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, },
					quests={ { id=8635, qType="Seasonal", tip="Through here and follow the path", }, }, },
	[45405480] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, }, quests={ { id=8635, qType="Seasonal",
					tip="You now have a choice. Go right. In other words, do not take the (left) ramp upwards", }, }, },
	[40007340] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, }, quests={ { id=8635, qType="Seasonal",
	...
	[51379385] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, },
					quests={ { id=8635, qType="Seasonal", tip="Elder Splitrock is here", }, }, },
	[54708660] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=3, version=50000, },
					{ id=910, index=10, versionUnder=50000, }, }, quests={ { id=8635, qType="Seasonal",
...
ns.points[ ns.map.mulgore ] = { -- Mulgore
	[44582416] = { seasonalQuest=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[48495323] = { elder=true, achievements={ { id=911, index=8, version=50000, },
					{ id=911, index=11, versionUnder=50000, }, }, quests={ { id=8673, qType="Seasonal", }, }, },
	[44942322] = { elderFaction=true, achievements={ { id=914, index=2, version=50000, },
					{ id=914, index=2, versionUnder=50000, }, }, quests={ { id=8678, qType="Seasonal", }, }, },
	...
	[72145427] = { elder=true, achievements={ { id=911, index=4, version=50000, },
					{ id=911, index=21, versionUnder=50000, }, }, quests={ { id=8686, qType="Seasonal", }, }, },
	...
	[87890802] = { elder=true, achievements={ { id=911, index=3, version=50000, },
					{ id=911, index=17, versionUnder=50000, }, }, quests={ { id=8717, qType="Seasonal", }, }, },
}

ns.points[ ns.map.barrens ] = { -- Northern Barrens
	[48525926] = { elder=true, achievements={ { id=911, index=3, version=50000, },
					{ id=911, index=17, versionUnder=50000, }, }, quests={ { id=8717, qType="Seasonal", }, }, },
	[68366996] = { elder=true, achievements={ { id=911, index=5, version=50000, },
					{ id=911, index=7, versionUnder=50000, }, }, quests={ { id=8680, qType="Seasonal", }, }, },
	...
	[07447457] = { seasonalQuest=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[07787368] = { elderFaction=true, achievements={ { id=914, index=2, version=50000, },
					{ id=914, index=3, versionUnder=50000, }, }, quests={ { id=8678, qType="Seasonal", }, }, },
	[80370051] = { elderFaction=true, achievements={ { id=914, index=1, }, },
					quests={ { id=8677, qType="Seasonal", tip="Alliance need to be very quick with this one", }, }, },
	[86654018] = { elder=true, achievements={ { id=911, index=1, version=50000, },
					{ id=911, index=9, versionUnder=50000, }, },
					quests={ { id=8670, qType="Seasonal", tip="Alliance need to be very quick with this one", }, }, },
}
...
ns.points[ ns.map.silithus ] = { -- Silithus
	[30801332] = { elder=true, achievements={ { id=911, index=20, version=50000, },
					{ id=911, index=12, versionUnder=50000, }, },
					quests={ { id=8654, qType="Seasonal", }, }, },
	[53023547] = { elder=true, achievements={ { id=911, index=21, version=50000, },
					{ id=911, index=18, versionUnder=50000, }, },
					quests={ { id=8719, qType="Seasonal", }, }, },
}

ns.points[ 199 ] = { -- Southern Barrens
	[41604745] = { elder=true, achievements={ { id=911, index=4, version=50000, },
					{ id=911, index=21, versionUnder=50000, }, }, quests={ { id=8686, qType="Seasonal", }, }, },
	[24224668] = { elder=true, achievements={ { id=911, index=8, version=50000, },
					{ id=911, index=11, versionUnder=50000, }, }, quests={ { id=8673, qType="Seasonal", }, }, },
	...
	[21602462] = { elderFaction=true, achievements={ { id=914, index=2, version=50000, },
					{ id=914, index=2, versionUnder=50000, }, }, quests={ { id=8678, qType="Seasonal", }, }, },
	...
	[53181344] = { elder=true, achievements={ { id=911, index=3, version=50000, },
					{ id=911, index=17, versionUnder=50000, }, }, quests={ { id=8717, qType="Seasonal", }, }, },
	[68562174] = { elder=true, achievements={ { id=911, index=5, version=50000, },
					{ id=911, index=7, versionUnder=50000, }, }, quests={ { id=8680, qType="Seasonal", }, }, },
...
ns.points[ ns.map.stonetalon ] = { -- Stonetalon Mountains
	[41591896] = { preservation=true, tip="Stonetalon Peak Moonwell",
					quests={ { id=56842, index=5, name="Lunar Preservation", version=80205, qType="One Time", }, }, },
	[72061554] = { elder=true, achievements={ { id=911, index=9, version=50000, },
					{ id=911, index=4, versionUnder=50000, }, }, quests={ { id=8725, qType="Seasonal", }, }, },
...
ns.points[ ns.map.tanaris ] = { -- Tanaris
	[37247906] = { elder=true, achievements={ { id=911, index=15, version=50000, },
					{ id=911, index=13, versionUnder=50000, }, }, quests={ { id=8671, qType="Seasonal", }, }, },
	[51402881] = { elder=true, achievements={ { id=911, index=16, version=50000, },
					{ id=911, index=2, versionUnder=50000, }, }, quests={ { id=8684, qType="Seasonal", }, }, },
	[39222134] = { elderDungeon=true, achievements={ { id=910, index=1, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=8676, qType="Seasonal", tip="Enter Zul'Farrak. Follow the markers", }, }, },
	[17584315] = { elder=true, achievements={ { id=911, index=17, version=50000, },
					{ id=911, index=6, versionUnder=50000, }, }, quests={ { id=8681, qType="Seasonal", }, }, },
	...
	[52170860] = { elder=true, achievements={ { id=911, index=14, version=50000, },
					{ id=911, index=14, versionUnder=50000, }, }, quests={ { id=8724, qType="Seasonal", }, }, },
	[21556299] = { elder=true, achievements={ { id=6006, index=2, version=50000, },
					{ id=6006, index=4, versionUnder=50000, }, }, quests={ { id=29742, qType="Seasonal", }, }, },
}

ns.points[ ns.map.teldrassil ] = { -- Teldrassil
	[27954326] = { seasonalQuest=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[28114367] = { elderFaction=true, achievements={ { id=915, index=1, version=50000, },
					{ id=915, index=3, versionUnder=50000, }, }, quests={ { id=8718, qType="Seasonal", }, }, },
	[56855310] = { elder=true, achievements={ { id=911, index=6, version=50000, },
					{ id=911, index=5, versionUnder=50000, }, }, quests={ { id=8715, qType="Seasonal", }, }, },
	[55108853] = { elderFaction=true, achievements={ { id=915, index=1, version=50000, },
					{ id=915, index=3, versionUnder=50000, }, },
					quests={ { id=8718, qType="Seasonal", faction="Horde",
...
ns.points[ ns.map.thousand ] = { -- Thousand Needles
	[46345101] = { elder=true, achievements={ { id=911, index=13, version=50000, },
					{ id=911, index=19, versionUnder=50000, }, }, quests={ { id=8682, qType="Seasonal", }, }, },
	[77097561] = { elder=true, achievements={ { id=911, index=14, version=50000, },
					{ id=911, index=14, versionUnder=50000, }, }, quests={ { id=8724, qType="Seasonal", }, }, },
	...
	[55869648] = { elderDungeon=true, achievements={ { id=910, index=1, version=50000, },
					{ id=910, index=8, versionUnder=50000, }, },
					quests={ { id=8676, qType="Seasonal", tip="Enter Zul'Farrak. Follow the markers", }, }, },
}
...
ns.points[ ns.map.thunder ] = { -- Thunder Bluff
	[71112823] = { seasonalQuest=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[72982335] = { elderFaction=true, achievements={ { id=914, index=2, version=50000, },
					{ id=914, index=3, versionUnder=50000, }, }, quests={ { id=8678, qType="Seasonal", }, }, },
}

ns.points[ ns.map.ungoro ] = { -- Un'Goro
	[50377617] = { elder=true, achievements={ { id=911, index=17, version=50000, },
					{ id=911, index=6, versionUnder=50000, }, }, quests={ { id=8681, qType="Seasonal", }, }, },
	...
	[95553366] = { elderDungeon=true, achievements={ { id=910, index=1, version=50000, },
					{ id=910, index=8, versionUnder=50000, }, },
					quests={ { id=8676, qType="Seasonal", tip="Enter Zul'Farrak. Follow the markers", }, }, },
}
...
ns.points[ ns.map.winterspring ] = { -- Winterspring
	...
	[53225675] = { elder=true, achievements={ { id=911, index=18, version=50000, },
					{ id=911, index=3, versionUnder=50000, }, }, quests={ { id=8726, qType="Seasonal", }, }, },
	[59964994] = { elder=true, achievements={ { id=911, index=19, version=50000, },
					{ id=911, index=10, versionUnder=50000, }, }, quests={ { id=8672, qType="Seasonal", }, }, },
...
ns.points[ 219 ] = { -- Zul'Farrak
	[34393931] = { elderDungeon=true, achievements={ { id=910, index=1, version=50000, },
					{ id=910, index=8, versionUnder=50000, }, },
					quests={ { id=8676, qType="Seasonal", tip="Follow the map directly, no need for way-markers!", }, }, },
}

ns.points[ ns.map.kalimdor ] = { -- Kalimdor
	[29007600] = { metaLarge=true, achievements={ { id=911, showAllCriteria=true, }, }, alwaysShow=true, },
...
ns.points[ ns.map.badlands ] = { -- Badlands
	[06957986] = { elder=true, achievements={ { id=912, index=10, version=50000, },
					{ id=912, index=16, versionUnder=50000, }, }, quests={ { id=8683, qType="Seasonal", }, }, },
}

ns.points[ 242 ] = { -- Blackrock Depths - Detention Block
	[38007650] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="1) This way", }, }, },
	[49007200] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="2) This way", }, }, },
	[51406770] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
...
ns.points[ 34 ] = { -- Blackrock Mountain - Blackrock Caverns
	[53127138] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="2) Continue past the barrier", }, }, },
	[52654551] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="3) Go straight up", }, }, },
	[60142748] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="4) Go up the ramp", }, }, },
}

ns.points[ 35 ] = { -- Blackrock Mountain - Blackrock Depths
	[54848478] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="1) Fly down to here", }, }, },
	[55818208] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="2) Come this way", }, }, },
	[45716843] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="3) This way", }, }, },
	[37714228] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="4) This way", }, }, },
	[39171822] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal",
...
ns.points[ 33 ] = { -- Blackrock Mountain - Blackrock Spire
	[65676078] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="1) Enter through here", }, }, },
	[72524765] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="5) Continue upwards", }, }, },
	[70775311] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="6) Continue upwards", }, }, },
	[63454416] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="7) Shortcut upwards. You can fly up to here!", }, }, },
	[72903983] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, }, quests={ { id=8644, qType="Seasonal",
					tip="8) Continue forward and down the ramp. Portal is to your right", }, }, },
	[80324026] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="9) Enter through here and follow the markers", }, }, },
	[39494029] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="1) Fly down to here", }, }, },
}

ns.points[ 251 ] = { -- Blackrock Spire - Skitterweb Tunnels
	[58904260] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="3) Cross the bridge", }, }, },
	[61934012] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, }, quests={ { id=8644, qType="Seasonal",
					tip="4) Turn in the quest. Reverse to exit", }, }, },
}

ns.points[ 252 ] = { -- Blackrock Spire - Hordemar City
	[39004800] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal",
					tip="1) Begin by following the path down and then left to here. Keep going", }, }, },
	[60404270] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="3) Cross the bridge", }, }, },
}

ns.points[ 253 ] = { -- Blackrock Spire - Hall of Blackhand
	[48004100] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, }, quests={ { id=8644, qType="Seasonal",
...
ns.points[ ns.map.blastedLands ] = { -- Blasted Lands
	[54284950] = { elder=true, achievements={ { id=912, index=2, version=50000, },
					{ id=912, index=12, versionUnder=50000, }, }, quests={ { id=8647, qType="Seasonal", }, }, },
}

ns.points[ ns.map.burningSteppes ] = { -- Burning Steppes
	[10581387] = { elder=true, achievements={ { id=912, index=12, version=50000, },
					{ id=912, index=1, versionUnder=50000, }, }, quests={ { id=8651, qType="Seasonal", }, }, },
	[70114538] = { elder=true, achievements={ { id=912, index=9, version=50000, },
					{ id=912, index=9, versionUnder=50000, }, }, quests={ { id=8636, qType="Seasonal", }, }, },
	[52382393] = { elder=true, achievements={ { id=912, index=10, version=50000, },
					{ id=912, index=16, versionUnder=50000, }, }, quests={ { id=8683, qType="Seasonal", }, }, },
	[20201803] = { elderDungeon=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
	[20201603] = { elderDungeon=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
	[21023744] = { elderDungeon=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
	[21023944] = { elderDungeon=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
}

ns.points[ ns.map.dunMorogh ] = { -- Dun Morogh
	[53904991] = { elder=true, achievements={ { id=912, index=1, version=50000, },
					{ id=912, index=13, versionUnder=50000, }, }, quests={ { id=8653, qType="Seasonal", }, }, },
...
ns.points[ ns.map.easternP ] = { -- Eastern Plaguelands
	[35586882] = { elder=true, achievements={ { id=912, index=15, version=50000, },
					{ id=912, index=15, versionUnder=50000, }, }, quests={ { id=8688, qType="Seasonal", }, }, },
	[75505450] = { elder=true, achievements={ { id=912, index=16, version=50000, },
					{ id=912, index=8, versionUnder=50000, }, }, quests={ { id=8650, qType="Seasonal", }, }, },
	[26531159] = { elderDungeon=true, achievements={ { id=910, index=6, version=50000, },
					{ id=910, index=12, versionUnder=50000, }, },
					quests={ { id=8727, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
	[02575390] = { elder=true, achievements={ { id=912, index=4, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8722, qType="Seasonal", tip="Enter The Weeping Cave", }, }, },
}

ns.points[ ns.map.elwynn ] = { -- Elwynn Forest
	[32135280] = { elderFaction=true, version=50000, achievements={ { id=915, index=3, }, },
					quests={ { id=8646, qType="Seasonal", }, }, },
	[32475305] = { seasonalQuest=true, name="Lunar Festival Harbinger", version=50000,
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[34245056] = { seasonalQuest=true, name="Lunar Festival Harbinger", versionUnder=50000,
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[34565026] = { elderFaction=true, versionUnder=50000, achievements={ { id=915, index=1, }, }, 
					quests={ { id=8646, qType="Seasonal", }, }, },
	[39796367] = { elder=true, achievements={ { id=912, index=3, version=50000, },
					{ id=912, index=7, versionUnder=50000, }, }, quests={ { id=8649, qType="Seasonal", }, }, },
...
ns.points[ ns.map.hillsbrad ] = { -- Hillsbrad Foothills
	...
	[90650679] = { elder=true, achievements={ { id=912, index=17, version=50000, },
					{ id=912, index=14, versionUnder=50000, }, }, quests={ { id=8714, qType="Seasonal", }, }, },
	[05942981] = { elder=true, achievements={ { id=912, index=14, version=50000, },
					{ id=912, index=10, versionUnder=50000, }, }, quests={ { id=8645, qType="Seasonal", }, }, },
...
ns.points[ ns.map.lochModan ] = { -- Loch Modan
	[33334655] = { elder=true, achievements={ { id=912, index=7, version=50000, },
					{ id=912, index=17, versionUnder=50000, }, }, quests={ { id=8642, qType="Seasonal", }, }, },
}

ns.points[ 469 ] = { -- New Tinkertown
	[92376843] = { elder=true, achievements={ { id=912, index=1, version=50000, },
					{ id=912, index=13, versionUnder=50000, }, }, quests={ { id=8653, qType="Seasonal", }, }, },
}

ns.points[ ns.map.northStrangle ] = { -- Northern Stranglethorn
	[71043430] = { elder=true, achievements={ { id=912, index=5, version=50000, },
					{ id=912, index=4, versionUnder=50000, }, },
					quests={ { id=8716, qType="Seasonal", tip="Outside the instance", }, }, },
}

ns.points[ ns.map.searingGorge ] = { -- Searing Gorge
	[21297911] = { elder=true, achievements={ { id=912, index=12, version=50000, },
					{ id=912, index=1, versionUnder=50000, }, }, quests={ { id=8651, qType="Seasonal", }, }, },
	[34898498] = { elderDungeon=true, achievements={ { id=910, index=4, version=50000, },
					{ id=910, index=9, versionUnder=50000, }, },
					quests={ { id=8644, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
	[34898298] = { elderDungeon=true, achievements={ { id=910, index=5, version=50000, },
					{ id=910, index=11, versionUnder=50000, }, },
					quests={ { id=8619, qType="Seasonal", tip="Enter through here and follow the markers", }, }, },
	[80349331] = { elder=true, achievements={ { id=912, index=10, version=50000, },
					{ id=912, index=16, versionUnder=50000, }, }, quests={ { id=8683, qType="Seasonal", }, }, },
}
...
ns.points[ ns.map.silverpine ] = { -- Silverpine Forest
	[44974114] = { elder=true, achievements={ { id=912, index=14, version=50000, },
					{ id=912, index=10, versionUnder=50000, }, }, quests={ { id=8645, qType="Seasonal", }, }, },
...
ns.points[ ns.map.stormwind ] = { -- Stormwind City
	[79199617] = { seasonalQuest=true, name="Lunar Festival Harbinger", versionUnder=50000,
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[79839557] = { elderFaction=true, versionUnder=50000, achievements={ { id=915, index=1, }, }, 
					quests={ { id=8646, qType="Seasonal", }, }, },
}

ns.points[ 224 ] = { -- Stranglethorn Vale
	[63282265] = { elder=true, achievements={ { id=912, index=5, version=50000, },
					{ id=912, index=4, versionUnder=50000, }, },
					quests={ { id=8716, qType="Seasonal", tip="Outside the instance", }, }, },
	[37327920] = { elder=true, achievements={ { id=912, index=6, version=50000, },
					{ id=912, index=3, versionUnder=50000, },}, quests={ { id=8674, qType="Seasonal", }, }, },
	...
	[94001894] = { elder=true, achievements={ { id=912, index=2, version=50000, },
					{ id=912, index=12, versionUnder=50000, }, }, quests={ { id=8647, qType="Seasonal", }, }, },
}

ns.points[ 317 ] = { -- Stratholme
	[73505480] = { elderDungeon=true, achievements={ { id=910, index=6, version=50000, },
					{ id=910, index=12, versionUnder=50000, }, },
					quests={ { id=8727, qType="Seasonal", tip="Lift the portcullis", }, }, },
	[78622176] = { elderDungeon=true, achievements={ {id=910, index=6, version=50000, },
					{ id=910, index=12, versionUnder=50000, }, },
					quests={ { id=8727, qType="Seasonal", tip="Exit the same way you entered", }, }, },
}

ns.points[ ns.map.swampOS ] = { -- Swamp of Sorrows
	[69425487] = { elderDungeon=true, achievements={ {id=910, index=2, version=50000, },
					{ id=910, index=13, versionUnder=50000, }, }, quests={ { id=8713, qType="Seasonal",
...
ns.points[ 210 ] = { -- The Cape of Stranglethorn
	[39967251] = { elder=true, achievements={ {id=912, index=6, version=50000, },
					{ id=912, index=3, versionUnder=50000, }, }, quests={ { id=8674, qType="Seasonal", }, }, },
...
ns.points[ ns.map.TheHinter ] = { -- The Hinterlands
	[50004805] = { elder=true, achievements={ { id=912, index=11, version=50000, },
					{ id=912, index=5, versionUnder=50000, }, }, quests={ { id=8643, qType="Seasonal", }, }, },
	...
	[25530801] = { elder=true, achievements={ { id=912, index=17, version=50000, },
					{ id=912, index=14, versionUnder=50000, }, }, quests={ { id=8714, qType="Seasonal", }, }, },
}

ns.points[ 220 ] = { -- The Temple of Atal'Hakkar
	[63073436] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=2, version=50000, },
					{ id=910, index=13, versionUnder=50000, }, }, quests={ { id=8713, qType="Seasonal", }, }, },
	[50002500] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=2, version=50000, },
					{ id=910, index=13, versionUnder=50000, }, },
...
ns.points[ ns.map.tirisfal ] = { -- Tirisfal Glades
	[61737269] = { seasonalQuest=true, name="Lunar Festival Harbinger", tip="Not in the Undercity. She's above it",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[61865391] = { elder=true, achievements={ { id=912, index=13, version=50000, },
					{ id=912, index=2, versionUnder=50000, }, }, quests={ { id=8652, qType="Seasonal", }, }, },
	[61957317] = { elderFaction=true, achievements={ { id=914, index=3, version=50000, },
					{ id=914, index=2, versionUnder=50000, }, }, quests={ { id=8648, qType="Seasonal", }, }, },
	[61817153] = { elderFaction=true, achievements={ { id=914, index=3, version=50000, },
					{ id=914, index=2, versionUnder=50000, }, }, quests={ { id=8648, qType="Seasonal",
...
ns.points[ ns.map.undercity ] = { -- Undercity
	[65613597] = { seasonalQuest=true, name="Lunar Festival Harbinger", tip="Not in the Undercity. She's above it",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
	[66633821] = { elderFaction=true, achievements={ { id=914, index=3, version=50000, },
					{ id=914, index=2, versionUnder=50000, }, }, quests={ { id=8648, qType="Seasonal",
...
ns.points[ ns.map.westfall ] = { -- Westfall
	[56644709] = { elder=true, achievements={ { id=912, index=8, version=50000, },
					{ id=912, index=6, versionUnder=50000, }, },
					quests={ { id=8675, qType="Seasonal", }, }, },
}

ns.points[ ns.map.westernP ] = { -- Western Plaguelands
	[65303876] = { elder=true, achievements={ { id=912, index=4, version=50000, },
					{ id=912, index=11, versionUnder=50000, }, },
					quests={ { id=8722, qType="Seasonal", tip="Enter The Weeping Cave", }, }, },
	[63513611] = { elder=true, achievements={ { id=912, index=4, version=50000, },
					{ id=912, index=11, versionUnder=50000, }, },
					quests={ { id=8722, qType="Seasonal", tip="Inside The Weeping Cave", }, }, },
	[69187345] = { elder=true, achievements={ { id=912, index=17, version=50000, },
					{ id=912, index=14, versionUnder=50000, }, }, quests={ { id=8714, qType="Seasonal", }, }, },
	[04154023] = { elder=true, achievements={ { id=912, index=13, version=50000, },
					{ id=912, index=2, versionUnder=50000, }, }, quests={ { id=8652, qType="Seasonal", }, }, },
	[96255275] = { elder=true, achievements={ { id=912, index=15, version=50000, },
					{ id=912, index=15, versionUnder=50000, }, }, quests={ { id=8688, qType="Seasonal", }, }, },
}

ns.points[ ns.map.easternK ] = { -- Eastern Kingdoms
	[31007600] = { metaLarge=true, achievements={ { id=912, showAllCriteria=true, }, }, alwaysShow=true, },
	[02501820] = ns.setNewZones,
	[02502250] = ns.setHonorElders,
	[04702530] = ns.setElune,
	[05002100] = ns.setFlavour,
...
ns.points[ 159 ] = { -- Azjol-Nerub - The Guilded Gate
	[54374440] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="1) Enter the gate. You must kill the boss", }, }, },
	[66004350] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="2) Jump down onto the left side stairs", }, }, },
	[70003450] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="3) Go this way", }, }, },
}

ns.points[ 158 ] = { -- Azjol-Nerub - Hadronox's Lair
	[41533715] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="3) Go this way", }, }, },
	[61752850] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="4) Keep going this way!", }, }, },
	[47176569] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="5) Ignore Hadronox. Jump down here", }, }, },
	[49005820] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="6) Now jump down again!", }, }, },
}

ns.points[ 157 ] = { -- Azjol-Nerub - The Brood Pt
	[23005217] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="7) You land here", }, }, },
	[21724319] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="8) Elder is here", }, }, },
	[36854877] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="9) Exit is this way", }, }, },
	[75744913] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="10) No need to kill Anub'arak", }, }, },
	[88527649] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip="11) You're welcome! :)", }, }, },
}

ns.points[ 114 ] = { -- Borean Tundra
	[27512594] = { elderDungeon=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, }, quests={ { id=13021, qType="Seasonal",
					tip="Enter through here and follow the markers.\n\nThe lowest portal is for The Nexus", }, }, },
	[33803436] = { elder=true, achievements={ { id=1396, index=6, version=50000, },
					{ id=1396, index=1, versionUnder=50000, }, }, quests={ { id=13016, qType="Seasonal", }, }, },
	[42934957] = { elder=true, achievements={ { id=1396, index=15, version=50000, },
					{ id=1396, index=5, versionUnder=50000, }, },
					quests={ { id=13029, qType="Seasonal", tip="Actually above the Mightstone Quarry", }, }, },
	[57404372] = { elder=true, achievements={ { id=1396, index=5, version=50000, },
					{ id=1396, index=16, versionUnder=50000, }, }, quests={ { id=13033, qType="Seasonal", }, }, },
	[59096564] = { elder=true, achievements={ { id=1396, index=1, version=50000, },
					{ id=1396, index=6, versionUnder=50000, }, }, quests={ { id=13012, qType="Seasonal", }, }, },
}

ns.points[ 127 ] = { -- Crystalsong Forest
	[92911771] = { elder=true, achievements={ { id=1396, index=13, version=50000, },
					{ id=1396, index=13, versionUnder=50000, }, }, quests={ { id=13028, qType="Seasonal", }, }, },
...
ns.points[ 115 ] = { -- Dragonblight
	[14000484] = { elder=true, achievements={ { id=1396, index=10, version=50000, },
					{ id=1396, index=17, versionUnder=50000, }, },
					quests={ { id=13026, qType="Seasonal", tip=ns.elderBluewolf, }, }, },
	[26134950] = { elderDungeon=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, }, quests={ { id=13022, qType="Seasonal",
					tip="Drop down here, face south and locate the portal and enter", }, }, },
	[26814899] = { elderDungeon=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip=ns.elderNurgenExit, }, }, },
	[29755591] = { elder=true, achievements={ { id=1396, index=3, version=50000, },
					{ id=1396, index=4, versionUnder=50000, }, }, quests={ { id=13014, qType="Seasonal", }, }, },
	[35104835] = { elder=true, achievements={ { id=1396, index=17, version=50000, },
					{ id=1396, index=8, versionUnder=50000, }, }, quests={ { id=13031, qType="Seasonal", }, }, },
	[48777817] = { elder=true, achievements={ { id=1396, index=12, version=50000, },
					{ id=1396, index=14, versionUnder=50000, }, }, quests={ { id=13019, qType="Seasonal", }, }, },
}

ns.points[ 161 ] = { -- Drak'Tharon Keep - Drak'Tharon Overlook
	[36554553] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, }, quests={ { id=13023, qType="Seasonal",
					tip="5) So you did decide to come this way. Awesome! Keep going, it's all linear", }, }, },
	[43271321] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, }, quests={ { id=13023, qType="Seasonal",
					tip="6) Ignore The Prophet. Just keep going", }, }, },
	[38051726] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, }, quests={ { id=13023, qType="Seasonal",
...
ns.points[ 160 ] = { -- Drak'Tharon Keep - The Vestibules of Drak'Tharon
	[50654047] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="1) Go through here", }, }, },
	[60971879] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="2) Through here. No need to whoop Trollie", }, }, },
	[67875507] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="3) Through here. You can bypass Novos too", }, }, },
	[55636125] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="4) Exit here", }, }, },
	[46031310] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="8) You made it! Follow the passage. You know the rest!", }, }, },
	[69077927] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, }, quests={ { id=13023, qType="Seasonal",
...
ns.points[ 116 ] = { -- Grizzly Hills
	[60572768] = { elder=true, achievements={ { id=1396, index=2, version=50000, },
					{ id=1396, index=12, versionUnder=50000, }, }, quests={ { id=13013, qType="Seasonal", }, }, },
	[80533711] = { elder=true, achievements={ { id=1396, index=9, version=50000, },
					{ id=1396, index=18, versionUnder=50000, }, }, quests={ { id=13025, qType="Seasonal", }, }, },
	[64184699] = { elder=true, achievements={ { id=1396, index=16, version=50000, },
					{ id=1396, index=10, versionUnder=50000, }, }, quests={ { id=13030, qType="Seasonal", }, }, },
	[17792703] = { elderDungeon=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="The portal is through here", }, }, },
}

ns.points[ 154 ] = { -- Gundrak
	[58634038] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=11, version=50000, },
					{ id=910, index=6, versionUnder=50000, }, }, quests={ { id=13065, qType="Seasonal",
					tip="1) Jump in the water and exit here", }, }, },
	[58635714] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=11, version=50000, },
					{ id=910, index=6, versionUnder=50000, }, },
					quests={ { id=13065, qType="Seasonal", tip="2) Through this doorway", }, }, },
	[47007325] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=11, version=50000, },
					{ id=910, index=6, versionUnder=50000, }, },
					quests={ { id=13065, qType="Seasonal", tip="3) This way", }, }, },
	[45556119] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=11, version=50000, },
					{ id=910, index=6, versionUnder=50000, }, },
					quests={ { id=13065, qType="Seasonal", tip="4) After Elder Ohanzee, reverse to exit", }, }, },
}

ns.points[ 140 ] = { -- Halls of Stone
	[29176225] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=12, version=50000, },
					{ id=910, index=5, versionUnder=50000, }, },
					quests={ { id=13066, qType="Seasonal", tip="Here he is!", }, }, },
}

ns.points[ 117 ] = { -- Howling Fjord
	[58854834] = { elderDungeon=true, achievements={ { id=910, index=7, version=50000, },
					{ id=910, index=1, versionUnder=50000, }, },
					quests={ { id=13017, qType="Seasonal", tip="Utgarde Keep is this way. It's at the base", }, }, },
	[57254671] = { elderDungeon=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="This is the correct portal. It's up quite high", }, }, },
}

ns.points[ 118 ] = { -- Icecrown
	[10899536] = { elder=true, achievements={ { id=1396, index=7, version=50000, },
					{ id=1396, index=2, versionUnder=50000, }, }, quests={ { id=13018, qType="Seasonal", }, }, },
	[20638522] = { elder=true, achievements={ { id=1396, index=8, version=50000, },
					{ id=1396, index=15, versionUnder=50000, }, }, quests={ { id=13024, qType="Seasonal", }, }, },
	[41499646] = { elder=true, achievements={ { id=1396, index=10, version=50000, },
					{ id=1396, index=17, versionUnder=50000, }, },
					quests={ { id=13026, qType="Seasonal", tip=ns.elderBluewolf, }, }, },
	[90216517] = { elder=true, achievements={ { id=1396, index=4, version=50000, },
					{ id=1396, index=3, versionUnder=50000, }, }, quests={ { id=13015, qType="Seasonal", }, }, },
	[92902422] = { elder=true, achievements={ { id=1396, index=14, version=50000, },
					{ id=1396, index=11, versionUnder=50000, }, }, quests={ { id=13020, qType="Seasonal", }, }, },
}

ns.points[ 119 ] = { -- Sholazar Basin
	[49786362] = { elder=true, achievements={ { id=1396, index=7, version=50000, },
					{ id=1396, index=2, versionUnder=50000, }, }, quests={ { id=13018, qType="Seasonal", }, }, },
	[63804902] = { elder=true, achievements={ { id=1396, index=8, version=50000, },
					{ id=1396, index=15, versionUnder=50000, }, }, quests={ { id=13024, qType="Seasonal", }, }, },
	[93836520] = { elder=true, achievements={ { id=1396, index=10, version=50000, },
					{ id=1396, index=17, versionUnder=50000, }, },
					quests={ { id=13026, qType="Seasonal", tip=ns.elderBluewolf, }, }, },
}

ns.points[ 120 ] = { -- Storm Peaks
	[28897372] = { elder=true, achievements={ { id=1396, index=4, version=50000, },
					{ id=1396, index=3, versionUnder=50000, }, }, quests={ { id=13015, qType="Seasonal", }, }, },
	[41168472] = { elder=true, achievements={ { id=1396, index=13, version=50000, },
					{ id=1396, index=13, versionUnder=50000, }, }, quests={ { id=13028, qType="Seasonal", }, }, },
	[31263761] = { elder=true, achievements={ { id=1396, index=14, version=50000, },
					{ id=1396, index=11, versionUnder=50000, }, }, quests={ { id=13020, qType="Seasonal", }, }, },
	[64595134] = { elder=true, achievements={ { id=1396, index=18, version=50000, },
					{ id=1396, index=7, versionUnder=50000, }, }, quests={ { id=13032, qType="Seasonal",
					tip="BM Hunters doing the Hati quest chain (to get Hati back) will be phased out.\n\nElder Muraco is below "
						.."Camp Tunka'lo", }, }, },
	[39482691] = { elderDungeon=true, achievements={ { id=910, index=12, version=50000, },
					{ id=910, index=5, versionUnder=50000, }, },
					quests={ { id=13066, qType="Seasonal", tip="Enter through here", }, }, },
	[75699264] = { elder=true, achievements={ { id=1396, index=11, version=50000, },
					{ id=1396, index=9, versionUnder=50000, }, }, quests={ { id=13027, qType="Seasonal", }, }, },
	[87776802] = { elderDungeon=true, achievements={ { id=910, index=11, version=50000, },
					{ id=910, index=6, versionUnder=50000, }, }, quests={ { id=13065, qType="Seasonal",
					tip="Use this entrance, not the other one", }, }, },
}

ns.points[ 129 ] = { -- The Nexus
	[38707760] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, },
					quests={ { id=13021, qType="Seasonal", tip="1) This way!", }, }, },
	[50006600] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, },
					quests={ { id=13021, qType="Seasonal", tip="2) This way!", }, }, },
	[61505220] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, },
					quests={ { id=13021, qType="Seasonal", tip="3) This way!", }, }, },
	[61906400] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, },
					quests={ { id=13021, qType="Seasonal", tip="4) This way!", }, }, },
	[54976461] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, },
					quests={ { id=13021, qType="Seasonal", tip="5) He is here", }, }, },
	[52756990] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=8, version=50000, },
					{ id=910, index=3, versionUnder=50000, }, }, quests={ { id=13021, qType="Seasonal",
					tip="6) Come up this way for a shortcut exit!", }, }, },
}

ns.points[ 133 ] = { -- Utgarde Keep - Njorndir Preparation
	[50652851] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=7, version=50000, },
					{ id=910, index=1, versionUnder=50000, }, }, quests={ { id=13017, qType="Seasonal",
					tip="1) Defeat Dragonflayer Forgemasters to remove the flaming wall barriers", }, }, },
	[23047190] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=7, version=50000, },
					{ id=910, index=1, versionUnder=50000, }, },
					quests={ { id=13017, qType="Seasonal", tip="2) Through this way", }, }, },
	[47236936] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=7, version=50000, },
					{ id=910, index=1, versionUnder=50000, }, }, quests={ { id=13017, qType="Seasonal",
					tip="3) And when done, just retrace your steps", }, }, },
}

ns.points[ 136 ] = { -- Utgarde Pinnacle - Lower Pinnacle
	[45858315] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="3) Up the stairs", }, }, },
	[56112473] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="8) Now that you're done, it's easiest to keep going", }, }, },
	[49154425] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="9) Up the ramp", }, }, },
	[48672327] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="Elder is here", }, }, },
}

ns.points[ 137 ] = { -- Utgarde Pinnacle - Upper Pinnacle
	[40033590] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="1) Through this way", }, }, },
	[39906910] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, }, quests={ { id=13067, qType="Seasonal",
					tip="2) Keep going, ignore Svala, she appears to have enough of her own problems", }, }, },
	[64276947] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="4) This way", }, }, },
	[68893930] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, }, quests={ { id=13067, qType="Seasonal",
	...
	[64153634] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="6) The portcullis is now open", }, }, },
	[58633831] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, },
					quests={ { id=13067, qType="Seasonal", tip="7) Jump down", }, }, },
	[44114416] = { elderDungeon=true, noContinent=true, achievements={ { id=910, index=13, version=50000, },
					{ id=910, index=2, versionUnder=50000, }, }, quests={ { id=13067, qType="Seasonal",
					tip="10) Kill Ymiron to open the portcullis. Straight through and exit", }, }, },
}

ns.points[ 123 ] = { -- Wintergrasp
	[50001627] = { elder=true, achievements={ { id=1396, index=10, version=50000, },
					{ id=1396, index=17, versionUnder=50000, }, },
					quests={ { id=13026, qType="Seasonal", tip=ns.elderBluewolf, }, }, },
	[49491452] = { elder=true, achievements={ { id=1396, index=10, version=50000, },
					{ id=1396, index=17, versionUnder=50000, }, }, quests={ { id=13026, qType="Seasonal",
	...
	[49471373] = { elder=true, achievements={ { id=1396, index=10, version=50000, },
					{ id=1396, index=17, versionUnder=50000, }, }, quests={ { id=13026, qType="Seasonal",
	...
	[74149952] = { elderDungeon=true, achievements={ { id=910, index=9, version=50000, },
					{ id=910, index=4, versionUnder=50000, }, },
					quests={ { id=13022, qType="Seasonal", tip=ns.elderNurgenExit, }, }, },
	[89779830] = { elder=true, achievements={ { id=1396, index=17, version=50000, },
					{ id=1396, index=8, versionUnder=50000, }, }, quests={ { id=13031, qType="Seasonal", }, }, },
}

ns.points[ 121 ] = { -- Zul'Drak
	[58915597] = { elder=true, achievements={ { id=1396, index=11, version=50000, },
					{ id=1396, index=9, versionUnder=50000, }, }, quests={ { id=13027, qType="Seasonal", }, }, },
	[28978375] = { elderDungeon=true, achievements={ { id=910, index=10, version=50000, },
					{ id=910, index=7, versionUnder=50000, }, },
					quests={ { id=13023, qType="Seasonal", tip="The portal is through here", }, }, },
	[76112091] = { elderDungeon=true, achievements={ { id=910, index=11, version=50000, },
					{ id=910, index=6, versionUnder=50000, }, }, quests={ { id=13065, qType="Seasonal",
					tip="Use this entrance, not the other one." ..ns.taraezorPromo, }, }, },
	[73899374] = { elder=true, achievements={ { id=1396, index=2, version=50000, },
					{ id=1396, index=12, versionUnder=50000, }, }, quests={ { id=13013, qType="Seasonal", }, }, },
	[09734470] = { elder=true, achievements={ { id=1396, index=13, version=50000, },
					{ id=1396, index=13, versionUnder=50000, }, }, quests={ { id=13028, qType="Seasonal", }, }, },
}

ns.points[ 113 ] = { -- Northrend
	[23008600] = { metaLarge=true, achievements={ { id=1396, showAllCriteria=true, }, }, alwaysShow=true, },
	[02501820] = ns.setNewZones,
	[02502250] = ns.setHonorElders,
	[04702530] = ns.setElune,
	[05002100] = ns.setFlavour,
...
ns.points[ 207 ] = { -- Deepholm
	[49705488] = { elder=true, achievements={ { id=6006, index=1, version=50000, },
					{ id=6006, index=5, versionUnder=50000, }, }, quests={ { id=29735, qType="Seasonal", }, }, },
	[27706918] = { elder=true, achievements={ { id=6006, index=9, version=50000, },
					{ id=6006, index=9, versionUnder=50000, }, }, quests={ { id=29734, qType="Seasonal", }, }, },
}

ns.points[ 198 ] = { -- Mount Hyjal
	[26696205] = { elder=true, achievements={ { id=6006, index=6, version=50000, },
					{ id=6006, index=6, versionUnder=50000, }, }, quests={ { id=29739, qType="Seasonal", }, }, },
	[62542282] = { elder=true, achievements={ { id=6006, index=7, version=50000, },
					{ id=6006, index=7, versionUnder=50000, }, }, quests={ { id=29740, qType="Seasonal", }, }, },
...
ns.points[ 205 ] = { -- Shimmering Expanse in Vashj'ir
	[57258614] = { elder=true, achievements={ { id=6006, index=8, version=50000, },
					{ id=6006, index=2, versionUnder=50000, }, }, quests={ { id=29738, qType="Seasonal", }, }, },
}

ns.points[ 241 ] = { -- Twilight Highlands
	[50917045] = { elder=true, achievements={ { id=6006, index=4, version=50000, },
					{ id=6006, index=8, versionUnder=50000, }, }, quests={ { id=29737, qType="Seasonal", }, }, },
	[51883307] = { elder=true, achievements={ { id=6006, index=5, version=50000, },
					{ id=6006, index=3, versionUnder=50000, }, }, quests={ { id=29736, qType="Seasonal", }, }, },
}

ns.points[ 249 ] = { -- Uldum
	[65521866] = { elder=true, achievements={ { id=6006, index=2, version=50000, },
					{ id=6006, index=4, versionUnder=50000, }, }, quests={ { id=29742, qType="Seasonal", }, }, },
	[31586298] = { elder=true, achievements={ { id=6006, index=3, version=50000, },
					{ id=6006, index=1, versionUnder=50000, }, }, quests={ { id=29741, qType="Seasonal", }, }, },
	[83793788] = { elder=true, noZidormi=true, achievements={ { id=911, index=15, version=50000, },			
					{ id=911, index=13, versionUnder=50000, }, }, quests={ { id=8671, qType="Seasonal", }, }, },
}
...
ns.points[ 501 ] = { -- The Situation in Dalaran
	[47654374] = { seasonalQuest=true, noContinent=true, name="Lunar Festival Harbinger",
					quests={ { id=8867, qType="Seasonal", }, { id=8883, qType="Seasonal", }, }, },
}
...
ns.points[ 1978 ] = { -- Dragon Isles
	[85003000] = { metaLarge=true, achievements={ { id=17321, showAllCriteria=true, }, }, alwaysShow=true, },
	[02501820] = ns.setNewZones,
	[02502250] = ns.setHonorElders,
	[04702530] = ns.setElune,
	[05002100] = ns.setFlavour,
...
ns.points[ 2255 ] = { -- Azj-Kahet
	[66918553] = { elder=true, noAzeroth=true, achievements={ { id=41130, index=7, }, },
					quests={ { id=85935, qType="Seasonal", }, }, },
	[46825721] = { elder=true, noAzeroth=true, achievements={ { id=41130, index=8, }, },
					quests={ { id=85936, qType="Seasonal", }, }, },
}

ns.points[ 2215 ] = { -- Hallowfall
	[25885193] = { elder=true, noAzeroth=true, achievements={ { id=41130, index=5, }, },
					quests={ { id=85933, qType="Seasonal", }, }, },
	[66274628] = { elder=true, noAzeroth=true, achievements={ { id=41130, index=6, }, },
					quests={ { id=85934, qType="Seasonal", }, }, },
}
...
ns.points[ 2214 ] = { -- The Ringing Deeps
	[48906730] = { elder=true, noAzeroth=true, achievements={ { id=41130, index=3, }, },
					quests={ { id=85931, qType="Seasonal", }, }, },
	[67295298] = { elder=true, noAzeroth=true, achievements={ { id=41130, index=4, }, },
					quests={ { id=85932, qType="Seasonal", }, }, },
}
...
--	[61666176] = { elder=true, achievements={ { id=41130, index=4, }, }, quests={ { id=85932, qType="Seasonal", }, }, },
	[32008600] = { metaLarge=true, noCoords=true, achievements={ { id=41130, showAllCriteria=true, }, }, alwaysShow=true, },
	[02501820] = ns.setNewZones,
	[02502250] = ns.setHonorElders,
	[04702530] = ns.setElune,
	[05002100] = ns.setFlavour,
...
ns.textures[21] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryBlue"
ns.textures[22] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryDeepGreen"
ns.textures[23] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryDeepPink"
ns.textures[24] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryDeepRed"
ns.textures[25] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryGreen"
ns.textures[26] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryLightBlue"
ns.textures[27] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryPink"
ns.textures[28] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryPurple"
ns.textures[29] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestryTeal"
ns.textures[30] = "Interface\\AddOns\\HandyNotes_LunarFestival\\CoinOfAncestry"
