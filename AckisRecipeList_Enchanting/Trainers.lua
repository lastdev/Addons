...
function module:InitializeTrainers()
	...
	AddTrainer(11073, "Annora", Z.ULDAMAN, 0, 0, "Neutral")
	...
	AddTrainer(16633, "Sedana", Z.SILVERMOON_CITY, 70, 24, "Horde")
	...
	AddTrainer(28693, "Enchanter Nalthanis", Z.DALARAN, 39.1, 40.5, "Neutral")
	AddTrainer(33583, "Fael Morningsong", Z.ICECROWN, 73, 20.6, "Neutral")
	AddTrainer(33610, 51313, Z.SHATTRATH_CITY, 43.6, 90.4, "Neutral")
