...
function module:InitializeRecipes()
	local function AddRecipe(spell_id, genesis, quality)
		return private.addon:AddRecipe(spell_id, constants.PROFESSION_SPELL_IDS.ENCHANTING, genesis, quality)
	end
	local recipe
	...
	recipe:AddTrainer(1317, 3011, 3345, 3606, 4213, 4616, 5157, 5695, 7949, 11072, 11073, 11074, 16160, 16633, 16725, 18753, 18773, 19251, 19252, 19540, 26906, 26990, 28693, 33583, 33610, 33633, 33676, 47384, 47396, 47400, 47418, 47419, 47420, 47431, 48619, 53410, 57620, 65043, 65127, 85914)
	...
	recipe:SetItemFilterType("ENCHANTING_BRACER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TANK)
	recipe:AddTrainer(1317, 3011, 3345, 3606, 4213, 5157, 5695, 16725, 18773, 26906, 26990, 28693, 33583, 33610, 53410, 65127, 85914)
	...
	recipe:SetItemFilterType("ENCHANTING_MISC")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1317, 3011, 3345, 4213, 5695, 16725, 18773, 26906, 26954, 26980, 28693, 33583, 33610, 33633, 53410, 65127, 85914)
	...
	recipe:SetItemFilterType("ENCHANTING_MISC")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1317, 3011, 3345, 4213, 5695, 33583, 53410, 65127, 85914)
