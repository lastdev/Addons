				...
				statusbars = {
					...
					args = {
						statusbarpositioning = {
							...
							get = function(info) return RaidBuffStatus.db.profile.statusbarpositioning end,
							set = function(info, v)
								RaidBuffStatus.db.profile.statusbarpositioning = v
						...
						healerdrinkingsound = {
							...
							get = function(info) return RaidBuffStatus.db.profile.healerdrinkingsound end,
							set = function(info, v)
								RaidBuffStatus.db.profile.healerdrinkingsound = v
							end,
							order = 5,
						},
						dpsmana = {
				...
				skin = {
					...
					args = {
						...
						dashboardscale = {
							...
							bigStep = 0.1,
							isPercent = true,
							get = function() return RaidBuffStatus.db.profile.dashscale end,
							set = function(info, v)
								local old = RaidBuffStatus.frame:GetScale()
								local top = RaidBuffStatus.frame:GetTop()
								local left = RaidBuffStatus.frame:GetLeft()
								RaidBuffStatus.frame:ClearAllPoints()
								RaidBuffStatus.frame:SetScale(v)
								left = left * old / v
								top = top * old / v
								RaidBuffStatus.frame:SetPoint("TOPLEFT", UIParent, "BOTTOMLEFT", left, top)
								RaidBuffStatus:SaveFramePosition()
								RaidBuffStatus.db.profile.dashscale = v
							end,
						},
						hidebossrtrash = {
							type = 'toggle',
						...
						optionsscale = {
							...
							bigStep = 0.1,
							isPercent = true,
							get = function() return RaidBuffStatus.db.profile.optionsscale end,
							set = function(info, v)
								local old = RaidBuffStatus.optionsframe:GetScale()
								local top = RaidBuffStatus.optionsframe:GetTop()
								local left = RaidBuffStatus.optionsframe:GetLeft()
								RaidBuffStatus.optionsframe:ClearAllPoints()
								RaidBuffStatus.optionsframe:SetScale(v)
								left = left * old / v
								top = top * old / v
								RaidBuffStatus.optionsframe:SetPoint("TOPLEFT", UIParent, "BOTTOMLEFT", left, top)
								RaidBuffStatus.db.profile.optionsscale = v
							end,
						},
					},
				},
				...
				buffbuttonsorting = {
					...
					args = {
						groupsortstyle = {
							...
							get = function(info) return RaidBuffStatus.db.profile.groupsortstyle end,
							set = function(info, v)
								RaidBuffStatus.db.profile.groupsortstyle = v
								RaidBuffStatus:AddBuffButtons()
							end,
						},
						buffsortone = {
...
--							desc = L[""],
							...
							get = function(info) return RaidBuffStatus.db.profile.buffsort[1] end,
							set = function(info, v)
								RaidBuffStatus.db.profile.buffsort[1] = v
								RaidBuffStatus:AddBuffButtons()
							end,
						},
						buffsorttwo = {
...
--							desc = L[""],
							...
							get = function(info) return RaidBuffStatus.db.profile.buffsort[2] end,
							set = function(info, v)
								RaidBuffStatus.db.profile.buffsort[2] = v
								RaidBuffStatus:AddBuffButtons()
							end,
							disabled = function(info)
								return (RaidBuffStatus.db.profile.buffsort[1]):find("defaultorder")
							end,
						},
						buffsortthree = {
							type = 'select',
...
--							desc = L[""],
							...
							get = function(info) return RaidBuffStatus.db.profile.buffsort[3] end,
							set = function(info, v)
								RaidBuffStatus.db.profile.buffsort[3] = v
								RaidBuffStatus:AddBuffButtons()
							end,
							disabled = function(info)
								return (RaidBuffStatus.db.profile.buffsort[1] .. RaidBuffStatus.db.profile.buffsort[2]):find("defaultorder")
							end,
						},
						buffsortfour = {
							type = 'select',
...
--							desc = L[""],
							...
							get = function(info) return RaidBuffStatus.db.profile.buffsort[4] end,
							set = function(info, v)
								RaidBuffStatus.db.profile.buffsort[4] = v
								RaidBuffStatus:AddBuffButtons()
							end,
							disabled = function(info)
								return (RaidBuffStatus.db.profile.buffsort[1] .. RaidBuffStatus.db.profile.buffsort[2] .. RaidBuffStatus.db.profile.buffsort[3]):find("defaultorder")
							end,
						},
						buffsortfive = {
							type = 'select',
...
--							desc = L[""],
							...
							get = function(info) return RaidBuffStatus.db.profile.buffsort[5] end,
							set = function(info, v)
								RaidBuffStatus.db.profile.buffsort[5] = v
								RaidBuffStatus:AddBuffButtons()
							end,
							disabled = function(info)
								return (RaidBuffStatus.db.profile.buffsort[1] .. RaidBuffStatus.db.profile.buffsort[2] .. RaidBuffStatus.db.profile.buffsort[3] .. RaidBuffStatus.db.profile.buffsort[4]):find("defaultorder")
							end,
						},
					},
				},
		...
		tankwarnings = {
			...
			args = {
				...
				bossonly = {
					...
					disabled = function(info) return not RaidBuffStatus.db.profile.tankwarn end,
					order = 2,
				},
				failimmune = {
					type = 'group',
				...
				ninja = {
					...
					args = {
						...
						ninjaraid = {
							...
							end,disabled = function(info) return not RaidBuffStatus.db.profile.tankwarn end,
							disabled = function(info) return not RaidBuffStatus.db.profile.tankwarn end,
							order = 4,
						},
						ninjaparty = {
		...
		ccbreakwarnings = {
			...
			args = {
				...
				cconlyme = {
					...
					disabled = function(info) return not RaidBuffStatus.db.profile.ccwarn end,
					order = 2,
				},
				ccwarntank = {
					type = 'group',
					...
					args = {
						misdirectionself = {
							...
							name = L["Warn to self"],
								...
								disabled = function(info) return not RaidBuffStatus.db.profile.misdirectionwarn end,
								order = 1,
						},
						misdirectionsound = {
							type = 'toggle',
				...
				tankdeath = {
					...
					args = {
						tankdeathself = {
							...
							disabled = function(info) return not RaidBuffStatus.db.profile.deathwarn end,
							order = 1,
						},
						tankdeathsound = {
							type = 'toggle',
		...
		foodannounce = {
			...
			desc = L["Food raid warning announcement options for things like Feasts"],
			order = 14,
			args = {
				feasts = {
					type = 'toggle',
					...
					order = 1,
					get = function(info) return RaidBuffStatus.db.profile.feasts end,
					set = function(info, v)
						RaidBuffStatus.db.profile.feasts = v
					end,
				},
				feastautowhisper = {
					type = 'toggle',
				...
				cauldrons = {
					...
					set = function(info, v)
						RaidBuffStatus.db.profile.cauldrons = v
					end,
				},
				cauldronsautowhisper = {
					...
					order = 4,
					get = function(info) return RaidBuffStatus.db.profile.cauldronautowhisper end,
					set = function(info, v)
						RaidBuffStatus.db.profile.cauldronautowhisper = v
					end,
				},
				refreshmenttable = {
					type = 'toggle',
		...
		autoacceptinvites = {
			...
			args = {
				guildmembers = {
					...
					order = 1,
					get = function(info) return RaidBuffStatus.db.profile.guildmembers end,
					set = function(info, v)
						RaidBuffStatus.db.profile.guildmembers = v
					end,
				},
				friends = {
					type = 'toggle',
					...
					desc = L["Automatically accept invites from these"],
					order = 2,
					get = function(info) return RaidBuffStatus.db.profile.friends end,
					set = function(info, v)
						RaidBuffStatus.db.profile.friends = v
					end,
				},
				bnfriends = {
					type = 'toggle',
					...
					desc = L["Automatically accept invites from these"],
					order = 3,
					get = function(info) return RaidBuffStatus.db.profile.bnfriends end,
					set = function(info, v)
						RaidBuffStatus.db.profile.bnfriends = v
					end,
				},
			},
		},
		autoinviteswhispers = {
			...
			args = {
				guildmembers = {
					...
					order = 1,
					get = function(info) return RaidBuffStatus.db.profile.aiwguildmembers end,
					set = function(info, v)
						RaidBuffStatus.db.profile.aiwguildmembers = v
					end,
				},
				friends = {
					type = 'toggle',
					...
					desc = L["Automatically invite these"],
					order = 2,
					get = function(info) return RaidBuffStatus.db.profile.aiwfriends end,
					set = function(info, v)
						RaidBuffStatus.db.profile.aiwfriends = v
					end,
				},
				bnfriends = {
					type = 'toggle',
					...
					desc = L["Automatically invite these"],
					order = 3,
					get = function(info) return RaidBuffStatus.db.profile.aiwbnfriends end,
					set = function(info, v)
						RaidBuffStatus.db.profile.aiwbnfriends = v
					end,
				},
			},
		},
		versionannounce = {
			...
			args = {
				...
				userannounce = {
					...
					order = 2,
					get = function(info) return RaidBuffStatus.db.profile.userannounce end,
					set = function(info, v)
						RaidBuffStatus.db.profile.userannounce = v
					end,
				},
			},
		},
