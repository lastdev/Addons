...
La.Messages = {
	...
	["Sorry, I am queued for"] = "对不起，我在排地下城队列之中。", -- Needs review
...
La.Options = {
	Alive = "存活",
	["Allow raiders to use flasks and elixirs from last expansion"] = "允许团队玩家使用80级巫妖王之怒合剂和药剂", -- Needs review
	...
	["Old flasks and elixirs"] = "巫妖王之怒合剂和药剂", -- Needs review
	["One big group"] = "一大组",
	["One group down"] = "一组之下",
