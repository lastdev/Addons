...
HousingMapIDToExpansion = {
    ...
    [2406] = "The War Within", -- Undermine (Liberation scenario)
    ...
    [2127] = "The War Within", -- Unknown TWW zone
    ...
    [2026] = "Dragonflight", -- Valdrakken (sub-zone/portal room)
    ...
    [1699] = "Shadowlands", -- Sinfall (Revendreth sub-zone)
    ...
    [1355] = "Shadowlands", -- Nazjatar (Shadowlands version)
    ...
    [1164] = "Battle for Azeroth", -- Zuldazar (sub-zone)
    ...
    [62] = "Battle for Azeroth", -- Darkshore (BfA updated)
    [2070] = "Battle for Azeroth", -- Tirisfal Glades (BfA updated)
    [1527] = "Battle for Azeroth", -- Uldum (BfA assault version)
    [1473] = "Battle for Azeroth", -- Chamber of Heart
    ...
    [619] = "Legion", -- Val'sharah (sub-zone)
    [626] = "Legion", -- Val'sharah (sub-zone)
    [647] = "Legion", -- Val'sharah (sub-zone)
    [695] = "Legion", -- Val'sharah (sub-zone)
    [702] = "Legion", -- Val'sharah (sub-zone)
    [709] = "Legion", -- Val'sharah (sub-zone)
    [717] = "Legion", -- Val'sharah (sub-zone)
    [720] = "Legion", -- Val'sharah (sub-zone)
    [735] = "Legion", -- Val'sharah (sub-zone)
    [739] = "Legion", -- Val'sharah (sub-zone)
    [940] = "Legion", -- Val'sharah (sub-zone)
    ...
    [1530] = "Mists of Pandaria", -- Shrine of Two Moons
    [394] = "Mists of Pandaria", -- Shrine of the Seven Stars

    -- Cataclysm (4.0+)
    [503] = "Classic", -- Brawl'gar Arena (Horde Brawler's Guild, inside Orgrimmar)
    ...
    [249] = "Cataclysm", -- Uldum
    [201] = "Cataclysm", -- Vashj'ir: Kelp'thar Forest
    [205] = "Cataclysm", -- Vashj'ir: Shimmering Expanse
    [204] = "Cataclysm", -- Vashj'ir: Abyssal Depths
    [196] = "Cataclysm", -- Kaja'mine
    [218] = "Cataclysm", -- Ruins of Gilneas City
    ...
    [147] = "Wrath of the Lich King", -- Ulduar
    [200] = "Wrath of the Lich King", -- The Ruby Sanctum
    ...
    [110] = "The Burning Crusade", -- Silvermoon
    [94] = "The Burning Crusade", -- Eversong Woods
    [95] = "The Burning Crusade", -- Ghostlands
    [122] = "The Burning Crusade", -- Isle of Quel'Danas
    [103] = "The Burning Crusade", -- The Exodar
    [97] = "The Burning Crusade", -- Azuremyst Isle
    ...
    [500] = "Classic", -- Bizmo's Brawlpub (inside Deeprun Tram)
    [29] = "Classic", -- Dun Morogh (zone)
    [27] = "Classic", -- Dun Morogh (sub-zone/micro-dungeon)
    [47] = "Classic", -- Duskwood
...
-- Parent map relationships for sub-zones
...
-- Format: [childMapID] = { x = coord, y = coord } (in 0-100 format)
HousingMapEntrances = {
    [503] = { x = 70.51, y = 30.95 }, -- Brawl'gar Arena entrance in Orgrimmar
}
