local vendors = {  
  ...
  [13] = {
    ...
    npcID = 246721,
    faction = 0,
    coords = {x = 56.2, y = 46.0, mapID = 1161},
  },
}
...
local itemEntries = {
  ...
  { vendorId = 4, itemID = "244325", itemName = "Zuldazar Cook's Griddle", goldCost = 0, currencies = {{ currencyID = 1560, amount = 400 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "The Zandalari Menu" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  { vendorId = 4, itemID = "244326", itemName = "Zandalari Wall Shelf", goldCost = 0, currencies = {{ currencyID = 1560, amount = 150 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "Dune Rider" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  { vendorId = 4, itemID = "245263", itemName = "Zocalo Drinks", goldCost = 0, currencies = {{ currencyID = 1560, amount = 150 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires quest "The Source of the Problem" -- VERIFIED: Wowhead [Battle for Azeroth] [Currencies added based on vendor page; Faction name added]
  ...
  -- Pearl Barlow block
  { vendorId = 5, itemID = "245271", itemName = "Old Salt's Fireplace", goldCost = 0, currencies = {{ currencyID = 1560, amount = 800 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "Come Sail Away" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  ...
  { vendorId = 5, itemID = "252653", itemName = "Tiragarde Treasure Chest", goldCost = 0, currencies = {{ currencyID = 1560, amount = 650 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "The Long Con" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  { vendorId = 5, itemID = "252654", itemName = "Proudmoore Green Drape", goldCost = 0, currencies = {{ currencyID = 1560, amount = 300 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "The Pride of Kul Tiras" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  { vendorId = 5, itemID = "252754", itemName = "Seaworthy Boralus Bell", goldCost = 0, currencies = {{ currencyID = 1560, amount = 800 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires quest "My Brother's Keeper" -- VERIFIED: Wowhead [Battle for Azeroth] [Currencies amount added based on vendor page; Faction name added]
  ...
  { vendorId = 6, itemID = "246503", itemName = "Large H.O.M.E. Cog", goldCost = 900000, currencies = {}, itemCosts = {{ itemID = 169610, amount = 2 },}, factionName = "Rustbolt Resistance", reputationLevel = "Honored", renownLevel = 0 }, -- VERIFIED: Wowhead [Battle for Azeroth] [Gold cost corrected from 1000000 to 0; Currencies corrected to itemCosts based on similar items' vendor page]
  { vendorId = 6, itemID = "246598", itemName = "Screw-Sealed Stembarrel", goldCost = 5000000, currencies = {}, itemCosts = {{ itemID = 169610, amount = 1 },}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "Junkyard Apprentice" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on similar items' vendor page]
  { vendorId = 6, itemID = "246601", itemName = "Bolt Chair", goldCost = 0, currencies = {}, itemCosts = {{ itemID = 166846, amount = 10 },}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on similar items' vendor page]
  { vendorId = 6, itemID = "246603", itemName = "Gnomish Cog Stack", goldCost = 19000000, currencies = {}, itemCosts = {{ itemID = 166846, amount = 50 },}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "Junkyard Scavenger" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on similar items' vendor page]
  { vendorId = 6, itemID = "246605", itemName = "Mecha-Storage Mecha-Chest", goldCost = 2000000, currencies = {}, itemCosts = {{ itemID = 168327, amount = 2 },}, factionName = "Rustbolt Resistance", reputationLevel = "Revered", renownLevel = 0 }, -- VERIFIED: Wowhead [Battle for Azeroth] [Gold cost corrected from 1500000 to 0; Currencies corrected to itemCosts based on similar items' vendor page]
  { vendorId = 6, itemID = "246701", itemName = "Gnomish Sprocket Table", goldCost = 14000000, currencies = {}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires quest "The Start of Something Bigger" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on similar items' vendor page]
  { vendorId = 6, itemID = "246703", itemName = "Double-Sprocket Table", goldCost = 19000000, currencies = {}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires quest "Welcome to the Resistance" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on similar items' vendor page]
  ...
  { vendorId = 13, itemID = "258765", itemName = "Hull'n'Home Window", goldCost = 0, currencies = {{ currencyID = 1560, amount = 175 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Horde vendor
  ...
  { vendorId = 13, itemID = "258765", itemName = "Hull'n'Home Window", goldCost = 0, currencies = {{ currencyID = 1560, amount = 175 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Alliance vendor
  ...
  { vendorId = 7, itemID = "239606", itemName = "Forsaken Round Rug", goldCost = 0, currencies = {{ currencyID = 1560, amount = 200 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  ...
  { vendorId = 7, itemID = "241062", itemName = "Lordaeron Rectangular Rug", goldCost = 0, currencies = {{ currencyID = 1560, amount = 200 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires achievement "Ready for War" -- VERIFIED: Wowhead [Battle for Azeroth] [Faction name added based on vendor page]
  ...
  { vendorId = 9, itemID = "252655", itemName = "Copper Tidesage's Sconce", goldCost = 0, currencies = {{ currencyID = 1560, amount = 175 },}, itemCosts = {}, factionName = "", reputationLevel = "", renownLevel = 0 }, -- Requires quest "Storm's Vengeance" -- VERIFIED: Wowhead [Battle for Azeroth] [VendorId corrected from 12 to 9; Faction name added based on vendor page]
