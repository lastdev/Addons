...
elseif locale == "ruRU" then
  La["|cffffff00Click|r to open weekly rewards"] = "|cffffff00ЛКМ|r, чтобы открыть Великое Хранилище"
La["|cffffff00Left-click|r to detach tooltip"] = "|cffffff00ЛКМ|r, чтобы показать информацию в отдельном окне"
La["|cffffff00Middle-click|r to show Blizzard's Raid Information"] = "|cffffff00Нажмите на колёсико мышки|r, чтобы показать информацию о рейдах Blizzard"
