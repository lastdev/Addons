...
L["dialog.blfit.tooltip"] = "Dans votre groupe, si personne n’a de Furie sanguinaire (ou autre sort similaire) alors PGF affichera uniquement les groupes qui ont en une, ou seulement après avoir rejoint le groupe, si il y a toujours une place de DPS ou de soigneur disponible. Fonctionne également si vous êtes seul."
L["dialog.brfit"] = "Résurrection en combat"
L["dialog.brfit.tooltip"] = "Dans votre groupe, si personne n’a de Résurrection en combat alors PGF affichera uniquement les groupes qui ont en une, ou seulement après avoir rejoint le groupe, si il y a toujours une place de disponible. Fonctionne également si vous êtes seul."
...
L["dialog.needsbl.tooltip"] = "N'affiche que les groupes qui n'ont pas encore de classe offrant la Furie sanguinaire (ou autre sort similaire)."
...
L["settings.specIcon.tooltip"] = "Affiche une icône avec la spécialisation de classe de chaque membre dans la liste des groupes prédéfinis."
L["settings.missingRoles.title"] = "Afficher les rôles manquants"
L["settings.missingRoles.tooltip"] = "Affiche l'icône du rôle de chaque emplacement vide dans la liste des groupes prédéfinis."
L["settings.signUpDeclined.title"] = "S'inscrire aux groupes refusés"
L["settings.signUpDeclined.tooltip"] = "Restaure l'ancien comportement avant TWW et permet de s'inscrire à nouveau dans les groupes qui t'ont précédemment refusé."
L["settings.section.mythicplus.title"] = "Mythique +"
L["settings.section.signup.title"] = "Inscription"
L["settings.rioRatingColors.title"] = "Classement en couleurs Raider.IO"
L["settings.rioRatingColors.tooltip"] = "Utilise le schéma de couleurs Raider.IO pour les classements Mythique+ si l'addon Raider.IO est chargé."
L["settings.cancelOldestApp.title"] = "Annuler la plus ancienne candidature"
L["settings.cancelOldestApp.tooltip"] = "Si vous avez le nombre maximum de candidatures en attente, cliquez sur un groupe pour annuler d'abord votre plus ancienne candidature. Cliquez ensuite à nouveau pour postuler."
