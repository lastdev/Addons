...
L["error.syntax"] = "|cffff0000Erreur de syntaxe dans le filtre d’expression|r\n\nVous n’avez pas correctement écrit votre expression de recherche avancée. Exemple : il manque une paranthèse ou vous avez écrit 'tanks=1' au lieu de 'tanks==1'.\n\nMessage d’erreur détaillé :\n|cffaaaaaa%s|r"
...
L["settings.coloredGroupTexts.tooltip"] = "Affiche le groupe en vert si il est récent et en rouge si vous avez été refusé. Si cette instance possède un verrouillage, l’afficher également en rouge."
L["settings.classBar.title"] = "Barre classe en couleur"
L["settings.classBar.tooltip"] = "Affiche une barre de couleur en dessous de la classe pour chaque rôle."
L["settings.classCircle.title"] = "Colorer le cercle des classes"
L["settings.classCircle.tooltip"] = "Affiche un cercle de couleur en arrière-plan pour chaque rôle."
...
L["settings.persistSignUpNote.tooltip"] = "Conserve la « Note au chef de groupe » lors de l’inscription à différents groupes. Par défaut, la note est supprimée lorsqu’un nouveau groupe est sélectionné."
L["settings.signupOnEnter.title"] = "S’inscre avec Entrée"
L["settings.signupOnEnter.tooltip"] = "Active automatiquement la zone de texte « Note au chef de groupe » lors de votre inscription à un nouveau groupe et confirmez votre candidature en appuyant sur Entrée."
L["settings.skipSignUpDialog.title"] = "Ignorer la vérification des rôles"
L["settings.skipSignUpDialog.tooltip"] = "Ignore la sélection du rôle et si possible et s’inscire immédiatement au groupe. Maj + Clic pour afficher la boîte de dialogue de la « Note au chef de groupe »."
L["settings.coloredApplications.title"] = "Colorer les candidatures"
L["settings.coloredApplications.tooltip"] = "Affiche uniquement un fond rouge pour les candidatures en attente si le groupe n’a plus de place pour votre rôle."
