...
L["dialog.dungeon.alert.single.title"] = "Выбрано одно подземелье"
L["dialog.dungeon.alert.single.info"] = "При поиске одного подземелья Вы получите гораздо более релевантные результаты, если введете часть названия подземелья в стандартное поле поиска, например, «Нелтарий» или «Вершина 10». Из-за некоторых ограничений аддоны не могут изменить поле поиска за Вас."
