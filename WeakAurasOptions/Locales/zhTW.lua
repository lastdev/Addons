...
-- WeakAuras/Options
	...
	L["% of Progress"] = "進度%"
	L["%d |4aura:auras; added"] = "%d |4光環; 已新增"
	L["%d |4aura:auras; deleted"] = "%d |4光環; 已刪除"
	L["%d |4aura:auras; modified"] = "%d |4光環; 已更改"
...
|cFF00CC00>= 0|r 無論如何永遠都會觸發]=]
	...
	L["If checked, then this group will not merge with other group when selecting multiple auras."] = "勾選以後，那麼這個群組在選擇多個光環時不會與其他群組合併。"
...
It might not work correctly with your version!]=] ] = "這個光環是用較新版本的WeakAuras建立的。它可能不適用於您的版本！"
	...
	L["This enables the collection of debug logs. This requires custom coded auras that use DebugPrints."] = "這啟用了偵錯紀錄的收集。需要使用 DebugPrints 的自定義編碼光環。"
